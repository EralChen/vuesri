...
|click| __GraphicsLayer.OnClick| view: \__esri.View<br> layer: __esri.GraphicsLayer <br> [event](https://developers.arcgis.com/javascript/latest/api-reference/esri-views-View.html#event-click): __esri.ViewClickEvent <br> [hitTestResult](https://developers.arcgis.com/javascript/latest/api-reference/esri-views-MapView.html#hitTest): __esri.HitTestResult  <br> result: __esri.HitTestResultResults // 最上层的要素 |点击事件|
|pointerMove| __GraphicsLayer.OnPointerMove| view: \__esri.View<br> layer: __esri.GraphicsLayer <br> [event](https://developers.arcgis.com/javascript/latest/api-reference/esri-views-View.html#pointer-move): __esri.ViewPointerMoveEvent <br> [hitTestResult](https://developers.arcgis.com/javascript/latest/api-reference/esri-views-MapView.html#hitTest): __esri.HitTestResult <br> result: __esri.HitTestResultResults // 最上层的要素  |鼠标移动事件|

import{p as u,u as D,a as y}from"./chunk-FwU0PLgH.js";import{oo as I,s5 as v,z as b,jE as E,or as B,Ab as P,jV as k,js as s,jF as O,oD as W,oH as j,jT as G}from"./chunk-xsho5EA6.js";import{u as N}from"./chunk-CqYr7gkC.js";import{u as V}from"./chunk-oDlZouEX.js";const R={...u,defaultOptions:{type:Object,default:()=>({})},url:{type:String,required:!0},serviceMode:{type:String,default:"RESTful"},customParameters:{type:Object,default:()=>({})},sublayers:{type:Array,default:void 0},activeLayer:{type:Object,default:void 0},overwriteCapabilities:{type:Object,default:void 0},subDomains:{type:Array,default:void 0}},Y=I(R),S={load:i=>i},Z=v(S),_=function(i=new b({xmin:-180,ymin:-90,xmax:180,ymax:90,spatialReference:{wkid:4326}})){const a=document.createElement("ows:WGS84BoundingBox"),r=document.createElement("ows:LowerCorner");r.textContent=i.xmin+" "+i.ymin;const M=document.createElement("ows:UpperCorner");return M.textContent=i.xmax+" "+i.ymax,a.appendChild(r),a.appendChild(M),a},$=(i="PM")=>`<Capabilities xmlns="http://www.opengis.net/wmts/1.0" xmlns:gml="http://www.opengis.net/gml" xmlns:ows="http://www.opengis.net/ows/1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.0.0" xsi:schemaLocation="http://www.opengis.net/wmts/1.0 http://schemas.opengis.net/wmts/1.0/wmtsGetCapabilities_response.xsd">
<TileMatrixSet>
...
`,A=(i="PM")=>{const a=new DOMParser().parseFromString($(i),"text/xml").getElementsByTagName("TileMatrixSet")[0],r=new DOMParser().parseFromString(F(i),"text/xml").getElementsByTagName("TileMatrixSetLink")[0];return{TileMatrixSet:a,TileMatrixSetLink:r}},U={PM:A},q=E({name:"VaWmtsLayer",props:R,emits:S,setup(i,{emit:a}){const r=N(),M=r.map,x=B(()=>i.overwriteCapabilities?.replaceTileMatrixSets.reduce((e,l)=>(e[l.find]=U[l.replacement](l.find),e),{})??{}),{interceptorToggle:c}=V({urls:[new RegExp(`${i.url}.*VUESRI=VaWmtsLayer`)],before(e){const l=i.subDomains;l&&(e.url=e.url.replace("{subDomain}",l[Math.floor(Math.random()*l.length)]))},after(e){if(e.url?.includes("request=GetCapabilities")){const l=e.data,m=new DOMParser().parseFromString(l,"application/xml"),H=m.getElementsByTagName("Contents")[0],f=m.getElementsByTagName("Layer");for(let o=0;o<f.length;o++){const n=f[o],T=n.getElementsByTagName("TileMatrixSetLink");for(let h=0;h<T.length;h++){const d=T[h];d.textContent&&x.value[d.textContent]&&d.replaceWith(x.value[d.textContent].TileMatrixSetLink)}const p=n.getElementsByTagName("ows:Identifier")[0];p&&i.activeLayer?.id&&i.overwriteCapabilities?.extend&&i.activeLayer.id===p.textContent&&n.getElementsByTagName("ows:WGS84BoundingBox")[0].replaceWith(_(i.overwriteCapabilities.extend))}const L=H.getElementsByTagName("TileMatrixSet");for(let o=0;o<L.length;o++){const n=L[o],T=n.getElementsByTagName("ows:Identifier")[0];T&&x.value[T.textContent]&&n.replaceWith(x.value[T.textContent].TileMatrixSet)}e.data=m.documentElement.outerHTML}}});c.add();const t=new P({...i.activeLayer?{activeLayer:i.activeLayer}:{},...i.defaultOptions}),g=k({});return t.when(()=>{g.value=t.sublayers.reduce((e,l)=>(e[l.id]=l,e),{})}),s(()=>{t.url=i.url}),s(()=>{t.serviceMode=i.serviceMode}),s(()=>{t.customParameters={...i.customParameters,VUESRI:"VaWmtsLayer"}}),s(()=>{i.sublayers&&(t.sublayers=i.sublayers)}),O(()=>[i.activeLayer?.id,i.activeLayer?.imageFormat],([e,l])=>{e&&t.when().then(()=>{const w=g.value[e];console.warn("sublayers can not find the id: ",e),w&&l&&(w.imageFormat=l),t.activeLayer=w,t.refresh()})},{immediate:!0}),s(()=>{t.title=i.title}),D(t,i),y(M,t,i),W("vaLayer",t),W("vaWmtsLayer",t),a("load",{view:r,layer:t}),{}}});function X(i,a,r,M,x,c){return G(i.$slots,"default")}const C=j(q,[["render",X]]);C.install=i=>{i.component(C.name,C)};export{C as V,Z as a,Y as c,S as e,R as p};

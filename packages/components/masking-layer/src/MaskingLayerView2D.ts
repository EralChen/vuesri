...
//   // properties: {
//   //   tileContexts: new Map(),
//   //   watchHandles: new Handles(),
//   //   needsImageUpdate: false,
//   //   projectedGeometry: {} as __esri.Geometry | __esri.Geometry[] | null,
//   // },
//   constructor () {
...
//     const layer = this.layer as __esri.MaskingLayer
...
//         canvas.width = layer.tileInfo.size[0]
//         canvas.height = layer.tileInfo.size[1]
...
//     const layer = this.layer as __esri.MaskingLayer
//     const tileSize = layer.tileInfo.size[0]
...
//     context.globalAlpha = layer.color[3]
...
export const MaskingLayerView2D = BaseLayerView2D.createSubclass({
  ...
  render: function (renderParameters) {
    console.log('renderParameters', renderParameters)
    this.manageTileImages()

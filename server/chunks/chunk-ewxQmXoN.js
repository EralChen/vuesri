import { b as n$2, n as n$3, m as m$4 } from "./chunk-Tt9yuqqG.js";
import { dC as r$2, nz as t$2, tE as i$1, tF as r$3, aL as o$3, aq as has } from "./chunk-KFNcxJaF.js";
...
class s2 {
  ...
  static createFromValueAndQualifer(r2, a2, l2) {
    let o2 = null;
    const n3 = new s2();
...
class I {
  ...
  static makeSqlInterval(e2, t2, a2) {
    return s2.createFromValueAndQualifer(e2, t2, a2);
  }
  ...
  _evaluateNode(u2, c2, h2, p2) {
    ...
    switch (u2.type) {
      case "interval": {
        ...
        return s2.createFromValueAndQualifer(e2, u2.qualifier, u2.op);
      }
      case "case-expression":
        if ("simple" === u2.format) {

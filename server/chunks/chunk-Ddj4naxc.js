import { d1 as o, iz as u$1, e3 as v, bK as C, bJ as d$1, dS as w$1, ap as M$1, iY as d, bh as V, bo as e, bp as y, iZ as u, ct as o$1, br as c, iv as m, cB as a, cC as f, cD as t, cl as u$2, cm as j$2, cn as m$1, eR as l, cZ as f$1, bj as bt, cq as a$1, cN as r, cv as d$3, bN as b$1 } from "./chunk-KFNcxJaF.js";
import { j as j$1, S as S$1, g, d as d$2 } from "./chunk-xtwM9xwm.js";
import "@popperjs/core";
import "luxon";
import "@esri/arcgis-html-sanitizer";
import "@esri/calcite-components/dist/components/index.js";
var j;
let S = j = class extends o.EventedMixin(u$1(m)) {
  constructor(...e2) {
  ...
  load(e2) {
    ...
    const r2 = null != e2 ? e2.signal : null, s = this._fetchService(this._get("networkLink")?.href ?? "", r2).then((e3) => {
      ...
      this.fullExtent = M$1.fromJSON(r3), this.sourceJSON = e3;
...
e([y()], S.prototype, "description", void 0), e([y({ type: M$1 })], S.prototype, "fullExtent", void 0), e([y()], S.prototype, "id", void 0), e([y({ readOnly: true, value: null })], S.prototype, "networkLink", void 0), e([y({ json: { write: { allowNull: true } } })], S.prototype, "parent", void 0), e([y({ type: V.ofType(S), json: { write: { allowNull: true } } })], S.prototype, "sublayers", void 0), e([y({ value: null, json: { read: { source: "name", reader: (e2) => u(e2) } } })], S.prototype, "title", void 0), e([y({ value: true })], S.prototype, "visible", null), e([o$1("visible", ["visibility"])], S.prototype, "readVisible", null), e([y()], S.prototype, "sourceJSON", void 0), e([y()], S.prototype, "layer", void 0), S = j = e([c("esri.layers.support.KMLSublayer")], S);
const k = S;
const w = ["kml", "xml"];
let F = class extends a(f(t(u$2(j$2(m$1(b$1)))))) {
  constructor(...e2) {
  ...
  load(e2) {
    ...
    return this.addResolvingPromise(this.loadFromPortal({ supportedTypes: ["KML"], supportsData: false }, e2).catch(a$1).then(() => this._fetchService(r2))), Promise.resolve(this);
  }
  destroy() {

import { as as l$1, at as S, au as f$1, av as v } from "./chunk-KFNcxJaF.js";
class s {
  constructor(t = 9, i) {
  ...
  remove(i) {
    ...
    for (M.clear(), X.clear(); e || M.length > 0; ) {
      if (e || (e = M.pop(), s2 = M.data[M.length - 1], h2 = X.pop() ?? 0, a2 = true), e.leaf && (n = S(e.children, i, e.children.length, e.indexHint), -1 !== n))
    ...
    for (let n = i.length - 1; n >= 0; n--) {
      ...
      if (0 === e.children.length)
        if (n > 0) {
          ...
          h2.splice(S(h2, e, h2.length, s2.indexHint), 1);
        } else
          this.clear();
      else
        h(e, this._toBBox);

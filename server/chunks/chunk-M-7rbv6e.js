import { x as x$2, n, t as t$1, s, a as r, r as r$1 } from "./chunk-KyVc0M84.js";
import { D as D$1, an as l, ao as f$3, ap as d$1, aq as g$2, ar as T$2, as as F$1, at as a$1, au as u$2, av as G, aw as N$1, ax as s$1, ay as O$2, az as I$1, aA as p$2, aB as E$1, aC as v$2 } from "./chunk-piwgY2EI.js";
import { n as n$1, m as m$2, a as n$2 } from "./chunk-KfB6QvrM.js";
import { DateTime } from "luxon";
import { aB as f$4, dL as Z, fi as S$2 } from "./chunk-ejFG4zJ0.js";
import { union as b$1, geodesicArea as K, planarArea as W, geodesicLength as M$1, planarLength as F$2, relate as R$1, crosses as m$3, touches as S$3, within as x$3, overlaps as O$3, contains as p$3, intersects as h$2 } from "./chunk-mWJZoVFa.js";
class a {
  constructor() {
...
class x {
  ...
  async _canDoAggregates(e2, t2, s2, i, n2) {
    return null !== this._parent && this._parent._canDoAggregates(e2, t2, s2, i, n2);
  }
  async _getAggregatePagesDataSourceDefinition(e2, i, n2, a2, r$12, l2, u2) {
    if (null === this._parent)
      throw new s(r.NeverReach);
    return this._parent._getAggregatePagesDataSourceDefinition(e2, i, n2, a2, r$12, l2, u2);
  }
  async _getAgregagtePhysicalPage(e2, i, n2) {
    if (null === this._parent)
      throw new s(r.NeverReach);
    return this._parent._getAgregagtePhysicalPage(e2, i, n2);
  }
  async databaseType() {
  ...
  async _getFeature(e2, i, n2) {
    if (this._checkCancelled(n2), void 0 !== this._featureFromCache(i))
      return this._featureFromCache(i);
    if (await this._getFeatures(e2, i, this._maxProcessingRate(), n2), this._checkCancelled(n2), void 0 !== this._featureFromCache(i))
      return this._featureFromCache(i);
    throw new s(r.MissingFeatures);
  }
  async _getFeatureBatch(e2, t$12) {
    this._checkCancelled(t$12);
    const s2 = new t([], e2, false, null), i = [];
    await this._getFeatures(s2, -1, e2.length, t$12), this._checkCancelled(t$12);
    for (const n2 of e2)
      void 0 !== this._featureFromCache(n2) && i.push(this._featureFromCache(n2));
    return i;
  }
  async _getFeatures(e2, t2, s2, i) {
    return "success";
  }
  _getFilteredSet(e2, i, n2, a2, r$12) {
    throw new s(r.NotImplemented);
  }
  async _refineSetBlock(e2, t2, s2) {
    ...
    const i = e2._candidates.length;
    this._refineKnowns(e2, t2);
    let n2 = i - e2._candidates.length;
    if (0 === e2._candidates.length)
      return e2;
    if (n2 >= t2)
      return e2;
    if (await this._refineIfParentKnown(e2, t2 - n2, s2), this._checkCancelled(s2), this._refineKnowns(e2, t2 - n2), n2 = i - e2._candidates.length, n2 < t2 && e2._candidates.length > 0) {
      const i2 = t2 - n2, a2 = this._prepareFetchAndRefineSet(e2._candidates);
      return await this._fetchAndRefineFeatures(a2, a2.length > i2 ? i2 : e2._candidates.length, s2), this._checkCancelled(s2), this._refineKnowns(e2, t2 - n2), e2;
    }
    return e2;
  }
  ...
  _refineKnowns(e2, t2) {
    ...
    for (let a2 = 0; a2 < e2._candidates.length && "GETPAGES" !== e2._candidates[a2]; a2++) {
      ...
      if (h2 === s$1.InFeatureSet)
        true === r2 ? e2._known.includes(u2) || (e2._known.push(u2), s2 += 1) : (e2._known.push(e2._candidates[a2]), s2 += 1), null === i ? i = { start: a2, end: a2 } : i.end === a2 - 1 ? i.end = a2 : (n2.push(i), i = { start: a2, end: a2 });
      else if (h2 === s$1.NotInFeatureSet)
        null === i ? i = { start: a2, end: a2 } : i.end === a2 - 1 ? i.end = a2 : (n2.push(i), i = { start: a2, end: a2 }), s2 += 1;
    ...
    for (let a2 = n2.length - 1; a2 >= 0; a2--)
      e2._candidates.splice(n2[a2].start, n2[a2].end - n2[a2].start + 1);
  }
  _refineIfParentKnown(e2, t$12, s2) {
    const i = new t([], [], e2._ordered, null);
    return i._candidates = e2._candidates.slice(0), this._parent._refineSetBlock(i, t$12, s2);
  }
  ...
  _checkIfNeedToExpandKnownPage(e2, t2) {
    if (null === e2.pagesDefinition)
      return false;
    let s2 = 0;
    for (let i = e2._lastFetchedIndex; i < e2._known.length; i++) {
      if ("GETPAGES" === e2._known[i])
        return true;
      if (void 0 === this._featureCache[e2._known[i]] && (s2 += 1, s2 >= t2))
        break;
    }
    return false;
  }
  _checkIfNeedToExpandCandidatePage(e2, t2) {
    if (null === e2.pagesDefinition)
      return false;
    let s2 = 0;
    for (let i = 0; i < e2._candidates.length; i++) {
      if ("GETPAGES" === e2._candidates[i])
        return true;
      if (s2 += 1, s2 >= t2)
        break;
    }
  ...
  async _expandPagedSet(e2, i, n2, a2, r$12) {
    if (null === this._parent)
      throw new s(r.NotImplemented);
    return this._parent._expandPagedSet(e2, i, n2, a2, r$12);
  }
  async _expandPagedSetFeatureSet(e2, t2, s2, i, n2) {
    if (e2._known.length > 0 && "GETPAGES" === e2._known[e2._known.length - 1] && (i = 1), 0 === i && e2._candidates.length > 0 && "GETPAGES" === e2._candidates[e2._candidates.length - 1] && (i = 2), 0 === i)
      return "finished";
    const a2 = await this._getPage(e2, i, n2);
    return s2 + a2 < t2 ? this._expandPagedSet(e2, t2, s2 + a2, 0, n2) : "success";
  }
  async _getPage(e2, t2, s2) {
    const i = 1 === t2 ? e2._known : e2._candidates;
    if (e2.pagesDefinition.internal.set.length > e2.pagesDefinition.resultOffset || true === e2.pagesDefinition.internal.fullyResolved) {
      i.length = i.length - 1;
      let t3 = 0;
      for (let n2 = 0; n2 < e2.pagesDefinition.resultRecordCount && !(e2.pagesDefinition.resultOffset + n2 >= e2.pagesDefinition.internal.set.length); n2++)
        i[i.length] = e2.pagesDefinition.internal.set[e2.pagesDefinition.resultOffset + n2], t3++;
      e2.pagesDefinition.resultOffset += t3;
      let s3 = false;
      return true === e2.pagesDefinition.internal.fullyResolved && e2.pagesDefinition.internal.set.length <= e2.pagesDefinition.resultOffset && (s3 = true), false === s3 && i.push("GETPAGES"), t3;
    }
  ...
  async calculateStatistic(e2, t2, s2, i) {
    await this._ensureLoaded();
    let n2 = await this._stat(e2, t2, "", null, null, s2, i);
    return false === n2.calculated && (n2 = await this._manualStat(e2, t2, s2, i)), n2.result;
  }
  async _manualStat(e2, t2, s2, i) {
    let n2 = null;
    switch (e2.toLowerCase()) {
      case "count":
        return n2 = await q(this, i), { calculated: true, result: n2 };
      case "distinct":
        return n2 = await S(this, t2, s2, i), { calculated: true, result: n2 };
      case "avg":
      case "mean":
        return n2 = await M(this, t2, i), { calculated: true, result: n2 };
      case "stdev":
        return n2 = await T(this, t2, i), { calculated: true, result: n2 };
      case "variance":
        return n2 = await x$1(this, t2, i), { calculated: true, result: n2 };
      case "sum":
        return n2 = await k(this, t2, i), { calculated: true, result: n2 };
      case "min":
        return n2 = await v(this, t2, i), { calculated: true, result: n2 };
      case "max":
        return n2 = await y(this, t2, i), { calculated: true, result: n2 };
      default:
        return { calculated: true, result: 0 };
    }
  }
  async _stat(e2, t2, s2, i, n2, a2, r2) {
    const l2 = await this._parent._stat(e2, t2, s2, i, n2, a2, r2);
    return false === l2.calculated ? null === n2 && "" === s2 && null === i ? this._manualStat(e2, t2, a2, r2) : { calculated: false } : l2;
  }
  _unionAllGeomSelf(e2) {
    const t2 = this.iterator(this._defaultTracker(e2)), s2 = [];
    return new Promise((e3, i) => {
      this._unionShapeInBatches(s2, t2, e3, i);
    });
  }
  _unionAllGeom(e2) {
    return new Promise((t2, s2) => {
      const i = this.iterator(this._defaultTracker(e2)), n2 = [];
      this._unionShapeInBatches(n2, i, t2, s2);
    });
  }
  _unionShapeInBatches(e2, t2, s2, i) {
    t2.next().then((n2) => {
      try {
        null !== n2 && null !== n2.geometry && e2.push(n2.geometry), e2.length > 30 || null === n2 && e2.length > 1 ? b$1(e2).then((a2) => {
          try {
            null === n2 ? s2(a2) : (e2 = [a2], this._unionShapeInBatches(e2, t2, s2, i));
          } catch (r2) {
            i(r2);
          }
        }, i) : null === n2 ? 1 === e2.length ? s2(e2[0]) : s2(null) : this._unionShapeInBatches(e2, t2, s2, i);
      } catch (a2) {
        i(a2);
      }
    }, i);
  ...
  morphShape(e2, t2, s2 = "unknown", i = null) {
    return x._featuresetFunctions.morphShape.bind(this)(e2, t2, s2, i);
  }
  ...
  buffer(e2, t2, s2, i = true) {
    return x._featuresetFunctions.buffer.bind(this)(e2, t2, s2, i);
  }
  filter(e2, t2 = null) {
  ...
  reduce(e2, t2 = null, s2) {
    return new Promise((i, n2) => {
      this._reduceImpl(this.iterator(this._defaultTracker(s2)), e2, t2, 0, i, n2, 0);
    });
  }
  _reduceImpl(e2, t2, s2, i, n2, a2, r2) {
    try {
      if (++r2 > 1e3)
        return void setTimeout(() => {
          r2 = 0, this._reduceImpl(e2, t2, s2, i, n2, a2, r2);
        });
      e2.next().then((l2) => {
        try {
          if (null === l2)
            ...
            const u2 = t2(s2, l2, i, this);
            S$2(u2) ? u2.then((s3) => {
              this._reduceImpl(e2, t2, s3, i + 1, n2, a2, r2);
            }, a2) : this._reduceImpl(e2, t2, u2, i + 1, n2, a2, r2);
          }
        } catch (u2) {
          a2(u2);
        }
  ...
  sumArea(e2, t2 = false, s2) {
    const i = O$2(e2);
    return this.reduce((e3, s3) => null === s3.geometry ? 0 : t2 ? K(s3.geometry, i).then((t3) => e3 + t3) : W(s3.geometry, i).then((t3) => e3 + t3), 0, s2);
  }
  sumLength(e2, t2 = false, s2) {
    const i = I$1(e2);
    return this.reduce((e3, s3) => null === s3.geometry ? 0 : t2 ? M$1(s3.geometry, i).then((t3) => e3 + t3) : F$2(s3.geometry, i).then((t3) => e3 + t3), 0, s2);
  }
  ...
  async distinct(e2, t2 = 1e3, s2 = null, i) {
    await this.load();
    const n2 = x$2.create(e2, this.getFieldsIndex(), this.dateFieldsTimeZoneDefaultUTC);
    return this._substituteVars(n2, s2), this.calculateStatistic("distinct", n2, t2, this._defaultTracker(i));
  }
  async min(e2, t2 = null, s2) {
    await this.load();
    const i = x$2.create(e2, this.getFieldsIndex(), this.dateFieldsTimeZoneDefaultUTC);
    return this._substituteVars(i, t2), this.calculateStatistic("min", i, -1, this._defaultTracker(s2));
  }
  async max(e2, t2 = null, s2) {
    await this.load();
    const i = x$2.create(e2, this.getFieldsIndex(), this.dateFieldsTimeZoneDefaultUTC);
    return this._substituteVars(i, t2), this.calculateStatistic("max", i, -1, this._defaultTracker(s2));
  }
  async avg(e2, t2 = null, s2) {
    await this.load();
    const i = x$2.create(e2, this.getFieldsIndex(), this.dateFieldsTimeZoneDefaultUTC);
    return this._substituteVars(i, t2), this.calculateStatistic("avg", i, -1, this._defaultTracker(s2));
  }
  async sum(e2, t2 = null, s2) {
    await this.load();
    const i = x$2.create(e2, this.getFieldsIndex(), this.dateFieldsTimeZoneDefaultUTC);
    return this._substituteVars(i, t2), this.calculateStatistic("sum", i, -1, this._defaultTracker(s2));
  }
  async stdev(e2, t2 = null, s2) {
    await this.load();
    const i = x$2.create(e2, this.getFieldsIndex(), this.dateFieldsTimeZoneDefaultUTC);
    return this._substituteVars(i, t2), this.calculateStatistic("stdev", i, -1, this._defaultTracker(s2));
  }
  async variance(e2, t2 = null, s2) {
    await this.load();
    const i = x$2.create(e2, this.getFieldsIndex(), this.dateFieldsTimeZoneDefaultUTC);
    return this._substituteVars(i, t2), this.calculateStatistic("variance", i, -1, this._defaultTracker(s2));
  }
  async count(e2) {
  ...
  forEach(e2, t2) {
    return new Promise((s2, i) => {
      this._forEachImpl(this.iterator(this._defaultTracker(t2)), e2, this, s2, i, 0);
    });
  }
  _forEachImpl(e2, t2, s2, i, n2, a2) {
    try {
      if (++a2 > 1e3)
        return void setTimeout(() => {
          a2 = 0, this._forEachImpl(e2, t2, s2, i, n2, a2);
        }, 0);
      e2.next().then((r2) => {
        try {
          if (null === r2)
            ...
            const l2 = t2(r2);
            null == l2 ? this._forEachImpl(e2, t2, s2, i, n2, a2) : S$2(l2) ? l2.then(() => {
              try {
                this._forEachImpl(e2, t2, s2, i, n2, a2);
              } catch (r3) {
                n2(r3);
              }
            }, n2) : this._forEachImpl(e2, t2, s2, i, n2, a2);
          }
        } catch (l2) {
          n2(l2);
        }
  ...
  convertToJSON(e2) {
    ...
    return this.reduce((e3, s2) => {
      const i = { geometry: s2.geometry?.toJSON(), attributes: {} };
      for (const t3 in s2.attributes)
        i.attributes[t3] = s2.attributes[t3];
      return t2.featureSet.features.push(i), 1;
    }, 0, e2).then(() => t2);
  }
  castToText(e2 = false) {
    return "object, FeatureSet";
  }
  queryAttachments(e2, t2, s2, i, n2) {
    return this._parent.queryAttachments(e2, t2, s2, i, n2);
  }
  serviceUrl() {
  ...
  schema() {
    ...
    for (const t2 of this.fields)
      e2.push(p$2(t2));
    return { objectIdField: this.objectIdField, globalIdField: this.globalIdField, geometryType: void 0 === E$1[this.geometryType] ? "esriGeometryNull" : E$1[this.geometryType], fields: e2 };
  }
  async convertToText(e2, t2) {
    ...
    if ("featureset" === e2) {
      ...
      await this.reduce((t3, s3) => {
        const i = { geometry: s3.geometry ? s3.geometry.toJSON() : null, attributes: s3.attributes };
        return null !== i.geometry && i.geometry.spatialReference && delete i.geometry.spatialReference, e3.push(i), 1;
      }, 0, t2);
  ...
  async castAsJsonAsync(e2 = null, t2 = null) {
    ...
    await this._ensureLoaded();
    const s2 = [];
    await this.reduce((e3, i2) => {
      const n2 = { geometry: i2.geometry ? true === t2?.keepGeometryType ? i2.geometry : i2.geometry.toJSON() : null, attributes: i2.attributes };
      return null !== n2.geometry && n2.geometry.spatialReference && true !== t2?.keepGeometryType && delete n2.geometry.spatialReference, s2.push(n2), 1;
    }, 0, e2);
    const i = this.schema();
    return i.features = s2, i.spatialReference = true === t2?.keepGeometryType ? this.spatialReference : this.spatialReference?.toJSON(), i;
  }
  fieldTimeZone(e2) {
  ...
  async executeSpatialRelationTest(e2) {
    ...
    switch (this._relation) {
      ...
      case "esriSpatialRelTouches":
        return S$3(this._relationGeom, e2.geometry);

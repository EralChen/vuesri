...
import { a as levelToScale } from "./chunk-BSxDNfxQ.js";
...
const _sfc_main = defineComponent({
  ...
  setup() {
    ...
    const defaultOptions = {
      title: "zjLayer",
      urlTemplate: `https://ditu.zjzwfw.gov.cn/services/wmts/emap_lab/default/oss?service=WMTS&request=GetTile&version=1.0.0&layer=TDT_ZJEMAPANNO&style=default&tileMatrixSet=c&format=tiles&height=256&width=256&token=2c92920471b56e640171be7537bd0074&tilecol={col}&tilerow={row}&tilematrix={level}`,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("examples/tdt-basemap/extends/NbBaseLayer.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const NbBaseLayer = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  NbBaseLayer as default
};

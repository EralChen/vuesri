import { aV as e, aX as y$1, v9 as j, a_ as c$c, db as f$1, d8 as y$2, d6 as d$1, b_ as S, td as o, cV as o$1, da as r, aO as s$2, gV as n$2, aQ as U$2, zV as qt, ri as t$1, gD as f$2, aT as s$3, iJ as s$4, zW as a$2, cY as x$1, bJ as c$d, gb as m$6, aC as M, dm as d$2, aB as f$3, cr as q$1, bI as R$2, yr as o$2, jT as i$3, q6 as n$4, cX as y$4, gX as v$1, bQ as V, d1 as n$5, ax as t$2, av as u$5, aw as j$3, ay as m$8, eV as v$2, dC as o$5, j6 as u$6, dT as g$1, at as s$5, zX as y$5, bT as I, bv as S$2, bw as Q$1, bt as f$5, bu as i$5, cd as b$1, jU as o$6, dp as P$1, hX as I$1, dF as U$3, ek as j$4, a$ as b$2 } from "./chunk-ejFG4zJ0.js";
import { U as U$1, y as y$3, s as s$1, R as R$1, r as r$1, b as j$1, d as b, n as n$3, o as o$3, w, S as S$1, D, e as a$3, k as k$1, i as i$4, h as o$4, l as l$4, m as m$7, c as c$e, O as O$1, f as f$4, j as j$2, a as O$2, g, p as c$f } from "./chunk-fPzE2fLD.js";
import "luxon";
...
let n$1 = class n extends f$1 {
  constructor(o2) {
    super(o2), this.directionLines = new d$1({ color: [0, 122, 194], width: 6 }), this.directionPoints = new y$2({ color: [255, 255, 255], size: 6, outline: { color: [0, 122, 194], width: 2 } }), this.pointBarriers = new y$2({ style: "x", size: 10, outline: { color: [255, 0, 0], width: 3 } }), this.polygonBarriers = new S({ color: [255, 170, 0, 0.6], outline: { width: 7.5, color: [255, 0, 0, 0.6] } }), this.polylineBarriers = new d$1({ width: 7.5, color: [255, 85, 0, 0.7] }), this.routeInfo = new d$1({ width: 8, color: [20, 89, 127] }), this.stops = new l$3();
  }
};
e([y$1({ types: j })], n$1.prototype, "directionLines", void 0), e([y$1({ types: j })], n$1.prototype, "directionPoints", void 0), e([y$1({ types: j })], n$1.prototype, "pointBarriers", void 0), e([y$1({ types: j })], n$1.prototype, "polygonBarriers", void 0), e([y$1({ types: j })], n$1.prototype, "polylineBarriers", void 0), e([y$1({ types: j })], n$1.prototype, "routeInfo", void 0), e([y$1({ type: l$3 })], n$1.prototype, "stops", void 0), n$1 = e([c$c("esri.layers.support.RouteSymbols")], n$1);
const c$b = n$1;
let m$5 = class m extends f$1 {
  constructor(t2) {
...
e([y$1({ type: String })], m$5.prototype, "dataType", void 0), e([o(U$1, { ignoreUnknown: false })], m$5.prototype, "name", void 0), e([y$1({ type: [String] })], m$5.prototype, "parameterNames", void 0), e([y$1({ type: String })], m$5.prototype, "restrictionUsageParameterName", void 0), e([o(y$3, { ignoreUnknown: false })], m$5.prototype, "timeNeutralAttributeName", void 0), e([y$1({ type: String })], m$5.prototype, "trafficSupport", void 0), e([o(s$1)], m$5.prototype, "units", void 0), e([o(R$1)], m$5.prototype, "usageType", void 0), m$5 = e([c$c("esri.rest.support.NetworkAttribute")], m$5);
const u$4 = m$5;
...
e([y$1({ type: Number })], p$4.prototype, "buildTime", void 0), e([y$1({ type: String })], p$4.prototype, "name", void 0), e([y$1({ type: [u$4] })], p$4.prototype, "networkAttributes", void 0), e([y$1()], p$4.prototype, "networkSources", void 0), e([y$1({ type: String })], p$4.prototype, "state", void 0), p$4 = e([c$c("esri.rest.support.NetworkDataset")], p$4);
const i$2 = p$4;
let c$a = class c extends f$1 {
  constructor(t2) {
...
async function d(t2, o2, s2) {
  ...
  const n3 = n$2({ f: "json", token: o2 }, s2), { data: l2 } = await U$2(t2, n3), u3 = l2.currentVersion >= 10.4 ? p$3(t2, o2, s2) : v(t2, s2), { defaultTravelMode: f2, supportedTravelModes: c5 } = await u3;
  return l2.defaultTravelMode = f2, l2.supportedTravelModes = c5, m$4.fromJSON(l2);
}
async function v(r2, t2) {
  const i2 = n$2({ f: "json" }, t2), { data: l2 } = await U$2(r2.replace(/\/rest\/.*$/i, "/info"), i2);
  if (!l2?.owningSystemUrl)
    return { supportedTravelModes: [], defaultTravelMode: null };
  const { owningSystemUrl: u3 } = l2, f2 = qt(u3) + "/sharing/rest/portals/self", { data: c5 } = await U$2(f2, i2), d2 = t$1("helperServices.routingUtilities.url", c5);
  if (!d2)
    return { supportedTravelModes: [], defaultTravelMode: null };
  const v2 = f$2(u3), p4 = /\/solve$/i.test(v2.path) ? "Route" : /\/solveclosestfacility$/i.test(v2.path) ? "ClosestFacility" : "ServiceAreas", m4 = n$2({ f: "json", serviceName: p4 }, t2), h = qt(d2) + "/GetTravelModes/execute", g2 = await U$2(h, m4), w2 = [];
  let T = null;
  if (g2?.data?.results?.length) {
    ...
    for (const r3 of e2)
      if ("supportedTravelModes" === r3.paramName) {
        ...
        "defaultTravelMode" === r3.paramName && (T = r3.value);
  }
  return { supportedTravelModes: w2, defaultTravelMode: T };
}
async function p$3(t2, o2, n3) {
  try {
    const r2 = n$2({ f: "json", token: o2 }, n3), i2 = qt(t2) + "/retrieveTravelModes", { data: { supportedTravelModes: l2, defaultTravelMode: u3 } } = await U$2(i2, r2);
    return { supportedTravelModes: l2, defaultTravelMode: u3 };
  } catch (i2) {
    throw new s$2("network-service:retrieveTravelModes", "Could not get to the NAServer's retrieveTravelModes.", { error: i2 });
  }
}
...
e([y$1({ type: Date, json: { read: { source: "arriveTimeUTC" } } })], a$1.prototype, "arriveTime", void 0), e([y$1()], a$1.prototype, "arriveTimeOffset", void 0), e([o$1("arriveTimeOffset", ["arriveTimeUTC", "ETA"])], a$1.prototype, "readArriveTimeOffset", null), e([y$1({ type: x$1 })], a$1.prototype, "geometry", void 0), e([o$1("geometry", ["point"])], a$1.prototype, "readGeometry", null), e([y$1({ type: [i] })], a$1.prototype, "strings", void 0), a$1 = e([c$c("esri.rest.support.DirectionsEvent")], a$1);
const c$6 = a$1;
function c$5(r2) {
  if (null == r2 || "" === r2)
    return null;
  ...
  const p4 = [];
  let n3, i2, c5, a3, m4, l2, u3, f2, d2 = 0, y2 = 0, h = 0;
  if (m4 = r2.match(/((\+|\-)[^\+\-\|]+|\|)/g), m4 || (m4 = []), 0 === parseInt(m4[d2], 32)) {
    d2 = 2;
    const r3 = parseInt(m4[d2], 32);
    d2++, l2 = parseInt(m4[d2], 32), d2++, 1 & r3 && (y2 = m4.indexOf("|") + 1, u3 = parseInt(m4[y2], 32), y2++), 2 & r3 && (h = m4.indexOf("|", y2) + 1, f2 = parseInt(m4[h], 32), h++);
  } else
    l2 = parseInt(m4[d2], 32), d2++;
  for (; d2 < m4.length && "|" !== m4[d2]; ) {
    n3 = parseInt(m4[d2], 32) + e2, d2++, e2 = n3, i2 = parseInt(m4[d2], 32) + t2, d2++, t2 = i2;
    const r3 = [n3 / l2, i2 / l2];
    y2 && (a3 = parseInt(m4[y2], 32) + s2, y2++, s2 = a3, r3.push(a3 / u3)), h && (c5 = parseInt(m4[h], 32) + o2, h++, o2 = c5, r3.push(c5 / f2)), p4.push(r3);
  }
  return { paths: [p4], hasZ: y2 > 0, hasM: h > 0 };
}
let a2 = class extends c$d {
  ...
  readGeometry(r2, e2) {
    const t2 = c$5(e2.compressedGeometry);
    return null != t2 ? m$6.fromJSON(t2) : null;
  }
};
e([y$1({ type: [c$6] })], a2.prototype, "events", void 0), e([o$1("geometry", ["compressedGeometry"])], a2.prototype, "readGeometry", null), e([y$1({ type: [i] })], a2.prototype, "strings", void 0), a2 = e([c$c("esri.rest.support.DirectionsFeature")], a2);
const m$3 = a2;
function m$2(e2, t2) {
  if (0 === e2.length)
...
let u$2 = class u extends d$2 {
  ...
  get mergedGeometry() {
    if (!this.features)
      return null;
    return m$2(this.features.map(({ geometry: e2 }) => e2), this.extent.spatialReference);
  }
  get strings() {
    return this.features.flatMap(({ strings: e2 }) => e2).filter(q$1);
  }
};
e([y$1({ type: M, json: { read: { source: "summary.envelope" } } })], u$2.prototype, "extent", void 0), e([y$1({ nonNullable: true })], u$2.prototype, "features", void 0), e([o$1("features")], u$2.prototype, "readFeatures", null), e([y$1()], u$2.prototype, "geometryType", void 0), e([y$1({ readOnly: true })], u$2.prototype, "mergedGeometry", null), e([y$1()], u$2.prototype, "routeId", void 0), e([y$1()], u$2.prototype, "routeName", void 0), e([y$1({ value: null, readOnly: true })], u$2.prototype, "strings", null), e([y$1({ json: { read: { source: "summary.totalDriveTime" } } })], u$2.prototype, "totalDriveTime", void 0), e([y$1({ json: { read: { source: "summary.totalLength" } } })], u$2.prototype, "totalLength", void 0), e([y$1({ json: { read: { source: "summary.totalTime" } } })], u$2.prototype, "totalTime", void 0), u$2 = e([c$c("esri.rest.support.DirectionsFeatureSet")], u$2);
const c$4 = u$2;
...
e([y$1({ type: d$2, json: { write: true } })], n2.prototype, "directionLines", void 0), e([y$1({ type: d$2, json: { write: true } })], n2.prototype, "directionPoints", void 0), e([y$1({ type: c$4, json: { write: true } })], n2.prototype, "directions", void 0), e([y$1({ type: c$d, json: { write: true } })], n2.prototype, "route", void 0), e([y$1({ type: String, json: { write: true } })], n2.prototype, "routeName", void 0), e([y$1({ type: [c$d], json: { write: true } })], n2.prototype, "stops", void 0), e([y$1({ type: d$2, json: { write: true } })], n2.prototype, "traversedEdges", void 0), e([y$1({ type: d$2, json: { write: true } })], n2.prototype, "traversedJunctions", void 0), e([y$1({ type: d$2, json: { write: true } })], n2.prototype, "traversedTurns", void 0), n2 = e([c$c("esri.rest.support.RouteResult")], n2);
const u$1 = n2;
function u2(r2) {
  return r2 ? d$2.fromJSON(r2).features.filter(q$1) : [];
}
let m$1 = class m2 extends f$1 {
  constructor(r2) {
...
e([y$1({ type: [i$1] })], m$1.prototype, "messages", void 0), e([y$1({ type: [c$d] })], m$1.prototype, "pointBarriers", void 0), e([o$1("pointBarriers", ["barriers"])], m$1.prototype, "readPointBarriers", null), e([y$1({ type: [c$d] })], m$1.prototype, "polylineBarriers", void 0), e([o$1("polylineBarriers")], m$1.prototype, "readPolylineBarriers", null), e([y$1({ type: [c$d] })], m$1.prototype, "polygonBarriers", void 0), e([o$1("polygonBarriers")], m$1.prototype, "readPolygonBarriers", null), e([y$1({ type: [u$1] })], m$1.prototype, "routeResults", void 0), m$1 = e([c$c("esri.rest.support.RouteSolveResult")], m$1);
const y = m$1;
function c$3(e2) {
  return e2 instanceof d$2;
}
async function l$1(f$12, p4, l2) {
  const y2 = [], d$12 = [], g2 = {}, h = {}, R2 = f$2(f$12), { path: v2 } = R2;
  c$3(p4.stops) && u$3(p4.stops.features, d$12, "stops.features", g2), c$3(p4.pointBarriers) && u$3(p4.pointBarriers.features, d$12, "pointBarriers.features", g2), c$3(p4.polylineBarriers) && u$3(p4.polylineBarriers.features, d$12, "polylineBarriers.features", g2), c$3(p4.polygonBarriers) && u$3(p4.polygonBarriers.features, d$12, "polygonBarriers.features", g2);
  ...
  const E = { ...l2, query: { ...R2.query, ...o$3(p4), f: "json" } }, T = v2.endsWith("/solve") ? v2 : `${v2}/solve`, { data: b2 } = await U$2(T, E);
  return m3(b2);
}
function m3(e2) {
  const { barriers: r2, directionLines: t2, directionPoints: s2, directions: o2, messages: a3, polygonBarriers: i2, polylineBarriers: n3, routes: u3, stops: f2, traversedEdges: c5, traversedJunctions: l2, traversedTurns: m4 } = e2, y$12 = (e3) => {
    const r3 = g2.find((r4) => r4.routeName === e3);
    if (null != r3)
      return r3;
    const t3 = { routeId: g2.length + 1, routeName: e3 };
    return g2.push(t3), t3;
  }, d2 = (e3) => {
    const r3 = g2.find((r4) => r4.routeId === e3);
    if (null != r3)
      return r3;
  ...
  u3?.features.forEach((e3, r3) => {
    ...
    g2.push({ routeId: s3, routeName: t3, route: e3 });
  }), o2?.forEach((e3) => {
    const { routeName: r3 } = e3;
    y$12(r3).directions = e3;
  });
  const h = (f2?.features.every((e3) => null == e3.attributes.RouteName) ?? false) && g2.length > 0 ? g2[0].routeName : null;
  ...
  }), c5?.features.forEach((e3) => {
    const r3 = e3.attributes.RouteID, t3 = d2(r3), { geometryType: s3, spatialReference: o3 } = c5;
...
e([y$1({ type: Boolean, json: { write: true } })], l.prototype, "doNotLocateOnRestrictedElements", void 0), e([y$1({ types: n$4, json: { read: y$4, write: true } })], l.prototype, "geometry", void 0), e([o(w)], l.prototype, "geometryType", void 0), e([y$1({ type: String, json: { name: "layerName", write: true } })], l.prototype, "name", void 0), e([o(S$1, { name: "spatialRel" })], l.prototype, "spatialRelationship", void 0), e([y$1({ type: String, json: { write: true } })], l.prototype, "type", void 0), e([y$1({ type: String, json: { write: true } })], l.prototype, "where", void 0), l = e([c$c("esri.rest.support.DataLayer")], l);
const c$2 = l;
var s;
let c$1 = s = class extends d$2 {
  constructor(e2) {
...
let P = N = class extends i$3(f$1) {
  ...
  writeRestrictionAttributes(t2, e2, r2) {
    t2?.length && (e2[r2] = t2.map((t3) => D.toJSON(t3)));
  }
  readStartTime(t2, e2) {
...
e([y$1({ type: [String], json: { name: "accumulateAttributeNames", write: true } })], P.prototype, "accumulateAttributes", void 0), e([o$1("accumulateAttributes")], P.prototype, "readAccumulateAttributes", null), e([r("accumulateAttributes")], P.prototype, "writeAccumulateAttributes", null), e([y$1(t)], P.prototype, "apiKey", void 0), e([y$1({ json: { write: true } })], P.prototype, "attributeParameterValues", void 0), e([y$1({ type: String, json: { write: true } })], P.prototype, "directionsLanguage", void 0), e([o(r$1)], P.prototype, "directionsLengthUnits", void 0), e([o(a$3)], P.prototype, "directionsOutputType", void 0), e([o(k$1)], P.prototype, "directionsStyleName", void 0), e([o(y$3, { name: "directionsTimeAttributeName", ignoreUnknown: false })], P.prototype, "directionsTimeAttribute", void 0), e([y$1({ type: Boolean, json: { write: true } })], P.prototype, "findBestSequence", void 0), e([y$1({ type: Number, json: { write: true } })], P.prototype, "geometryPrecision", void 0), e([y$1({ type: Number, json: { write: true } })], P.prototype, "geometryPrecisionM", void 0), e([y$1({ type: Number, json: { write: true } })], P.prototype, "geometryPrecisionZ", void 0), e([y$1({ type: Boolean, json: { write: true } })], P.prototype, "ignoreInvalidLocations", void 0), e([o(U$1, { name: "impedanceAttributeName", ignoreUnknown: false })], P.prototype, "impedanceAttribute", void 0), e([y$1({ type: Number, json: { write: true } })], P.prototype, "outputGeometryPrecision", void 0), e([o(i$4)], P.prototype, "outputGeometryPrecisionUnits", void 0), e([o(o$4)], P.prototype, "outputLines", void 0), e([y$1({ type: f$3, json: { name: "outSR", write: true } })], P.prototype, "outSpatialReference", void 0), e([y$1({ json: { write: true } })], P.prototype, "overrides", void 0), e([y$1({ json: { name: "barriers", write: true } })], P.prototype, "pointBarriers", void 0), e([r("pointBarriers")], P.prototype, "writePointBarriers", null), e([y$1({ json: { write: true } })], P.prototype, "polygonBarriers", void 0), e([r("polygonBarriers")], P.prototype, "writePolygonBarrier", null), e([y$1({ json: { write: true } })], P.prototype, "polylineBarriers", void 0), e([r("polylineBarriers")], P.prototype, "writePolylineBarrier", null), e([y$1({ type: Boolean, json: { write: true } })], P.prototype, "preserveFirstStop", void 0), e([y$1({ type: Boolean, json: { write: true } })], P.prototype, "preserveLastStop", void 0), e([y$1({ type: Boolean, json: { write: true } })], P.prototype, "preserveObjectID", void 0), e([y$1({ type: [String], json: { name: "restrictionAttributeNames", write: true } })], P.prototype, "restrictionAttributes", void 0), e([o$1("restrictionAttributes")], P.prototype, "readRestrictionAttributes", null), e([r("restrictionAttributes")], P.prototype, "writeRestrictionAttributes", null), e([o(l$4)], P.prototype, "restrictUTurns", void 0), e([y$1({ type: Boolean, json: { write: true } })], P.prototype, "returnBarriers", void 0), e([y$1({ type: Boolean, json: { write: true } })], P.prototype, "returnDirections", void 0), e([y$1({ type: Boolean, json: { write: true } })], P.prototype, "returnPolygonBarriers", void 0), e([y$1({ type: Boolean, json: { write: true } })], P.prototype, "returnPolylineBarriers", void 0), e([y$1({ type: Boolean, json: { write: true } })], P.prototype, "returnRoutes", void 0), e([y$1({ type: Boolean, json: { write: true } })], P.prototype, "returnStops", void 0), e([y$1({ type: Boolean, json: { write: true } })], P.prototype, "returnTraversedEdges", void 0), e([y$1({ type: Boolean, json: { write: true } })], P.prototype, "returnTraversedJunctions", void 0), e([y$1({ type: Boolean, json: { write: true } })], P.prototype, "returnTraversedTurns", void 0), e([y$1({ type: Boolean, json: { write: true } })], P.prototype, "returnZ", void 0), e([y$1({ json: { write: true } })], P.prototype, "startTime", void 0), e([o$1("startTime")], P.prototype, "readStartTime", null), e([r("startTime")], P.prototype, "writeStartTime", null), e([y$1({ type: Boolean, json: { write: true } })], P.prototype, "startTimeIsUTC", void 0), e([y$1({ json: { write: true } })], P.prototype, "stops", void 0), e([o$1("stops")], P.prototype, "readStops", null), e([r("stops")], P.prototype, "writeStops", null), e([y$1({ type: Boolean, json: { write: true } })], P.prototype, "timeWindowsAreUTC", void 0), e([y$1({ type: j$1, json: { write: true } })], P.prototype, "travelMode", void 0), e([y$1({ type: Boolean, json: { write: true } })], P.prototype, "useHierarchy", void 0), e([y$1({ type: Boolean, json: { write: true } })], P.prototype, "useTimeWindows", void 0), P = N = e([c$c("esri.rest.support.RouteParameters")], P);
const O = P;
function J(t2) {
...
function C(t2) {
  return J(t2) ? c$2.fromJSON(t2) : R(t2) ? c4.fromJSON(t2) : L(t2) ? p$1.fromJSON(t2) : U(t2) ? d$2.fromJSON(t2) : null;
}
function k(t2, e2, o2) {
...
function Z(e2, t2, r2) {
  ...
  const { timeAttributeName: n3, distanceAttributeName: a3 } = s2, u3 = i2.find(({ name: e3 }) => e3 === n3), p4 = i2.find(({ name: e3 }) => e3 === a3), c5 = r2.travelMode?.impedanceAttributeName ?? r2.impedanceAttribute ?? t2.impedance, m4 = u3?.units, y2 = p4?.units;
  if (!m4 || !y2)
    throw new s$2("routelayer:unknown-impedance-units", "the units of either the distance or time impedance are unknown");
  const f2 = r2.directionsLanguage ?? t2.directionsLanguage, d2 = r2.accumulateAttributes ?? t2.accumulateAttributeNames ?? [], h = new Set(i2.filter(({ name: e3 }) => e3 === n3 || e3 === a3 || e3 === c5 || null != e3 && d2.includes(e3)).map(({ name: e3 }) => e3)), w2 = (e3) => {
    for (const t3 in e3)
      h.has(t3) || delete e3[t3];
  };
  for (const l2 of e2.pointBarriers)
    null != l2.costs && (l2.addedCost = l2.costs[c5] ?? 0, w2(l2.costs));
  for (const l2 of e2.polygonBarriers)
    null != l2.costs && (l2.scaleFactor = l2.costs[c5] ?? 1, w2(l2.costs));
  for (const l2 of e2.polylineBarriers)
    null != l2.costs && (l2.scaleFactor = l2.costs[c5] ?? 1, w2(l2.costs));
  const { routeInfo: S2 } = e2, { findBestSequence: g2, preserveFirstStop: b2, preserveLastStop: v2, startTimeIsUTC: B, timeWindowsAreUTC: P2 } = r2;
  S2.analysisSettings = new c$f({ accumulateAttributes: d2, directionsLanguage: f2, findBestSequence: g2, preserveFirstStop: b2, preserveLastStop: v2, startTimeIsUTC: B, timeWindowsAreUTC: P2, travelMode: s2 }), S2.totalDuration = X(S2.totalCosts?.[n3] ?? 0, m4), S2.totalDistance = ee(S2.totalCosts?.[a3] ?? 0, y2), S2.totalLateDuration = X(S2.totalViolations?.[n3] ?? 0, m4), S2.totalWaitDuration = X(S2.totalWait?.[n3] ?? 0, m4), null != S2.totalCosts && w2(S2.totalCosts), null != S2.totalViolations && w2(S2.totalViolations), null != S2.totalWait && w2(S2.totalWait);
  for (const l2 of e2.stops)
    null != l2.serviceCosts && (l2.serviceDuration = X(l2.serviceCosts[n3] ?? 0, m4), l2.serviceDistance = ee(l2.serviceCosts[a3] ?? 0, y2), w2(l2.serviceCosts)), null != l2.cumulativeCosts && (l2.cumulativeDuration = X(l2.cumulativeCosts[n3] ?? 0, m4), l2.cumulativeDistance = ee(l2.cumulativeCosts[a3] ?? 0, y2), w2(l2.cumulativeCosts)), null != l2.violations && (l2.lateDuration = X(l2.violations[n3] ?? 0, m4), w2(l2.violations)), null != l2.wait && (l2.waitDuration = X(l2.wait[n3] ?? 0, m4), w2(l2.wait));
}
async function $(e2) {
  const t2 = f$3.WGS84;
  return await I$1(e2.spatialReference, t2), U$3(e2, t2);
}
function X(e2, t2) {
  switch (t2) {
    case "seconds":
...
function ee(e2, t2) {
  return "decimal-degrees" === t2 || "points" === t2 || "unknown" === t2 ? e2 : j$4(e2, t2, "meters");
}
function te(e2) {
...
const re = V.ofType(m$7), oe = V.ofType(c$e), ie = V.ofType(O$1), se = V.ofType(f$4), ne = V.ofType(j$2), le = V.ofType(O$2), ae = "esri.layers.RouteLayer", ue = () => s$3.getLogger(ae);
let pe = class extends n$5(t$2(u$5(j$3(m$8(b$2))))) {
  constructor(e2) {
    super(e2), this._cachedServiceDescription = null, this._featureCollection = null, this._type = "Feature Collection", this.defaultSymbols = new c$b(), this.directionLines = null, this.directionPoints = null, this.featureCollectionType = "route", this.legendEnabled = false, this.maxScale = 0, this.minScale = 0, this.pointBarriers = new ie(), this.polygonBarriers = new se(), this.polylineBarriers = new ne(), this.routeInfo = null, this.spatialReference = f$3.WGS84, this.stops = new le(), this.type = "route";
    const t2 = () => {
  ...
  get fullExtent() {
    const e2 = new M({ xmin: -180, ymin: -90, xmax: 180, ymax: 90, spatialReference: f$3.WGS84 });
  ...
  readPolygonBarriers(e2, t2) {
    return this._getNetworkFeatures(t2, "PolygonBarriers", (e3) => f$4.fromGraphic(e3));
  }
  readPolylineBarriers(e2, t2) {
    return this._getNetworkFeatures(t2, "PolylineBarriers", (e3) => j$2.fromGraphic(e3));
  }
  readRouteInfo(e2, t2) {
    const r2 = this._getNetworkFeatures(t2, "RouteInfo", (e3) => g.fromGraphic(e3));
  ...
  readSpatialReference(e2, t2) {
    ...
    if (!r2?.length)
      return f$3.WGS84;
    const { layerDefinition: o2, featureSet: i2 } = r2[0], s2 = i2.features[0], n3 = s2?.geometry?.spatialReference ?? i2.spatialReference ?? o2.spatialReference ?? o2.extent.spatialReference ?? g$1;
    return f$3.fromJSON(n3);
  }
  readStops(e2, t2) {
    return this._getNetworkFeatures(t2, "Stops", (e3) => O$2.fromGraphic(e3), (e3) => this._setStopSymbol(e3));
  }
  get title() {
  ...
  set url(e2) {
    null != e2 ? this._set("url", y$5(e2, ue())) : this._set("url", s$5.routeServiceUrl);
  }
  load(e2) {
  ...
  async saveAs(e2, t2 = {}) {
    ...
    const r2 = S$2.from(e2).clone();
    r2.extent ??= await $(this.fullExtent), r2.id = null, r2.portal ??= Q$1.getDefault(), r2.title ??= this.title, r2.type = "Feature Collection", r2.typeKeywords = ["Data", "Feature Collection", f$5.MULTI_LAYER, "Route Layer"];
    ...
    return await o2.user?.addItem({ item: r2, folder: s2, data: n3 }), this.portalItem = r2, i$5(i2), i2.portalItem = r2, r2;
  }
  async solve(e2, t2) {
    ...
    if (V.isCollection(r2))
      for (const n3 of r2)
        n3.routeName = null;
    const a3 = e2?.apiKey, u3 = this.url, c5 = await this._getServiceDescription(u3, a3, t2), m4 = e2?.travelMode ?? c5.defaultTravelMode, y2 = e2?.accumulateAttributes ?? [];
    null != m4 && (y2.push(m4.distanceAttributeName), m4.timeAttributeName && y2.push(m4.timeAttributeName));
    const f2 = { accumulateAttributes: y2, directionsOutputType: "featuresets", ignoreInvalidLocations: true, pointBarriers: o2, polylineBarriers: i2, polygonBarriers: s2, preserveFirstStop: true, preserveLastStop: true, returnBarriers: !!o2, returnDirections: true, returnPolygonBarriers: !!s2, returnPolylineBarriers: !!i2, returnRoutes: true, returnStops: true, stops: r2 }, d2 = O.from(e2 ?? {});
    let h;
    d2.set(f2);
    try {
      h = await l$1(u3, d2, t2);
    } catch (S2) {
      throw b$1(S2) ? S2 : new s$2("routelayer:failed-route-request", "the routing request failed", { error: S2 });
    }
    const w2 = this._toRouteLayerSolution(h);
    return this._isOverridden("title") || (this.title = w2.routeInfo.name ?? "Route"), Z(w2, c5, d2), w2;
  }
  update(e2) {
  ...
  _getNetworkFeatures(e2, t2, s2, l2) {
    ...
    if (null == u3)
      return new V();
    const { layerDefinition: p4, popupInfo: c5, featureSet: m4 } = u3, y2 = p4.drawingInfo.renderer, { features: f2 } = m4, d2 = m4.spatialReference ?? p4.spatialReference ?? p4.extent.spatialReference ?? g$1, h = y2 && o$6(y2), w2 = f$3.fromJSON(d2), S2 = f2.map((e3) => {
      ...
      const n3 = s2(i2);
      return n3.symbol ??= h?.getSymbol(i2) ?? this._getNetworkSymbol(t2), n3.popupTemplate ??= c5 && P$1.fromJSON(c5), n3;
    });
  ...
  _toRouteLayerSolution(e2) {
    const t2 = e2.routeResults[0].stops?.map((e3) => O$2.fromJSON(e3.toJSON()));
    ...
    const r2 = new le(t2), o2 = new se(e2.polygonBarriers?.map((e3) => {
      ...
      const t3 = j$2.fromJSON(e3.toJSON());
    ...
    })), n3 = e2.routeResults[0].route?.toJSON(), l2 = g.fromJSON(n3);
  ...
  _writePolygonBarriers() {
    return this._writeNetworkFeatures(this.polygonBarriers, this.defaultSymbols.polygonBarriers, "esriGeometryPolygon", f$4.fields, f$4.popupInfo, "PolygonBarriers", "Polygon Barriers");
  }
  _writePolylineBarriers() {
    return this._writeNetworkFeatures(this.polylineBarriers, this.defaultSymbols.polylineBarriers, "esriGeometryPolyline", j$2.fields, j$2.popupInfo, "PolylineBarriers", "Line Barriers");
  }
  _writeRouteInfo() {
    return this._writeNetworkFeatures(null != this.routeInfo ? new V([this.routeInfo]) : null, this.defaultSymbols.routeInfo, "esriGeometryPolyline", g.fields, g.popupInfo, "RouteInfo", "Route Details");
  }
  _writeStops() {
    const e2 = this._writeNetworkFeatures(this.stops, null, "esriGeometryPoint", O$2.fields, O$2.popupInfo, "Stops", "Stops");
    if (null == e2)
      return null;
...
} } } } } })], pe.prototype, "_type", void 0), e([y$1({ nonNullable: true, type: c$b })], pe.prototype, "defaultSymbols", void 0), e([y$1({ readOnly: true })], pe.prototype, "directionLines", void 0), e([o$1(["web-map", "portal-item"], "directionLines", ["layers", "featureCollection.layers"])], pe.prototype, "readDirectionLines", null), e([y$1({ readOnly: true })], pe.prototype, "directionPoints", void 0), e([o$1(["web-map", "portal-item"], "directionPoints", ["layers", "featureCollection.layers"])], pe.prototype, "readDirectionPoints", null), e([y$1({ readOnly: true, json: { read: false, origins: { "web-map": { write: { ignoreOrigin: true } } } } })], pe.prototype, "featureCollectionType", void 0), e([y$1({ readOnly: true })], pe.prototype, "fullExtent", null), e([y$1({ json: { origins: { "web-map": { name: "featureCollection.showLegend" } }, write: true } })], pe.prototype, "legendEnabled", void 0), e([y$1({ type: ["show", "hide"] })], pe.prototype, "listMode", void 0), e([y$1({ type: Number, nonNullable: true, json: { write: false } })], pe.prototype, "maxScale", void 0), e([o$1(["web-map", "portal-item"], "maxScale", ["layers", "featureCollection.layers"])], pe.prototype, "readMaxScale", null), e([y$1({ type: Number, nonNullable: true, json: { write: false } })], pe.prototype, "minScale", void 0), e([o$1(["web-map", "portal-item"], "minScale", ["layers", "featureCollection.layers"])], pe.prototype, "readMinScale", null), e([y$1({ type: ["ArcGISFeatureLayer"], value: "ArcGISFeatureLayer" })], pe.prototype, "operationalLayerType", void 0), e([y$1({ nonNullable: true, type: V.ofType(O$1) })], pe.prototype, "pointBarriers", void 0), e([o$1(["web-map", "portal-item"], "pointBarriers", ["layers", "featureCollection.layers"])], pe.prototype, "readPointBarriers", null), e([y$1({ nonNullable: true, type: V.ofType(f$4) })], pe.prototype, "polygonBarriers", void 0), e([o$1(["web-map", "portal-item"], "polygonBarriers", ["layers", "featureCollection.layers"])], pe.prototype, "readPolygonBarriers", null), e([y$1({ nonNullable: true, type: V.ofType(j$2) })], pe.prototype, "polylineBarriers", void 0), e([o$1(["web-map", "portal-item"], "polylineBarriers", ["layers", "featureCollection.layers"])], pe.prototype, "readPolylineBarriers", null), e([y$1({ readOnly: true })], pe.prototype, "routeInfo", void 0), e([o$1(["web-map", "portal-item"], "routeInfo", ["layers", "featureCollection.layers"])], pe.prototype, "readRouteInfo", null), e([y$1({ type: f$3 })], pe.prototype, "spatialReference", void 0), e([o$1(["web-map", "portal-item"], "spatialReference", ["layers", "featureCollection.layers"])], pe.prototype, "readSpatialReference", null), e([y$1({ nonNullable: true, type: V.ofType(O$2) })], pe.prototype, "stops", void 0), e([o$1(["web-map", "portal-item"], "stops", ["layers", "featureCollection.layers"])], pe.prototype, "readStops", null), e([y$1()], pe.prototype, "title", null), e([y$1({ readOnly: true, json: { read: false } })], pe.prototype, "type", void 0), e([y$1()], pe.prototype, "url", null), pe = e([c$c(ae)], pe);
const ce = pe;
export {
  ce as default
};

import { aB as f$1, fi as S$1, j2 as n$1, bJ as c$1, dL as Z, dv as y$2, wx as x$2, wy as n$4, ck as b$2, wz as f$4, wA as m$1, dw as We, gI as d$3, aQ as U$1, cX as y$3, iY as s$3, df as t$4, wB as n$5, wC as s$4, jR as n$6, i6 as n$7, lz as d$4, bv as S$3 } from "./chunk-ejFG4zJ0.js";
import { aw as N$1, ax as s$1, K as y, an as l, ao as f$3, ap as d$1, aq as g$2, ar as T$1, as as F$1, aD as Ie, aE as P$1, aF as M, aG as J, N as N$2, aH as t$3, aI as Ee, aJ as ze } from "./chunk-piwgY2EI.js";
import { x as x$1, s as s$2, a as r, n, t as t$2, r as r$1 } from "./chunk-KyVc0M84.js";
import { x, t as t$1, g as g$1, m, a as f$2, y as y$1, L as L$1, w, E as E$1, T as T$2, S as S$2, F as F$2, v, p, D as D$2, I as I$2, d as d$2, b as w$1, f as f$5, c as a$3 } from "./chunk-M-7rbv6e.js";
import { c as c$2, a as n$2, n as n$3 } from "./chunk-KfB6QvrM.js";
import ie from "./chunk-vNVJr286.js";
let e$1 = class e {
  constructor() {
      ...
      case "parameter": {
        ...
        if (r2 instanceof Array) {
          ...
          for (let s2 = 0; s2 < r2.length; s2++)
            "string" == typeof r2[s2] ? e4.push("'" + r2[s2].toString().replaceAll("'", "''") + "'") : f$3(r2[s2]) || d$1(r2[s2]) ? e4.push(w(r2[s2], t2)) : g$2(r2[s2]) ? e4.push(E$1(r2[s2], t2)) : T$1(r2[s2]) ? e4.push(T$2(r2[s2], t2)) : F$1(r2[s2]) ? e4.push(S$2(r2[s2], t2)) : e4.push(r2[s2].toString());
          return e4;
        }
        return r2.toString();
      }
...
class L extends x {
  ...
  _initialiseFeatureSet() {
    null !== this._parent ? (this.geometryType = this._parent.geometryType, this.objectIdField = this._parent.objectIdField, this.globalIdField = this._parent.globalIdField, this.spatialReference = this._parent.spatialReference, this.hasM = this._parent.hasM, this.hasZ = this._parent.hasZ, this.typeIdField = this._parent.typeIdField, this.types = this._parent.types) : (this.spatialReference = new f$1({ wkid: 4326 }), this.objectIdField = "", this.globalIdField = "", this.geometryType = N$1.point, this.typeIdField = "", this.types = null, this.subtypeField = null, this.subtypes = null), this.fields = [];
  ...
  async getIdColumnDictionary(t2, r2, n2, s2) {
    if (n2 < t2._known.length - 1) {
      ...
      if ("GETPAGES" === t2._known[n2 + 1])
        return await Ie(this._parent._expandPagedSet(t2, i, 0, 0, s2)), this.getIdColumnDictionary(t2, r2, n2, s2);
      let a4 = n2 + 1;
      const o = [];
      for (; a4 < t2._known.length && "GETPAGES" !== t2._known[a4]; )
        o.push(t2._known[a4]), a4++;
      n2 += o.length;
      const u = await Ie(this._parent._getFeatureBatch(o, s2));
    ...
    return t2._candidates.length > 0 ? (await Ie(this._refineSetBlock(t2, this._maxProcessingRate(), s2)), this._checkCancelled(s2), this.getIdColumnDictionary(t2, r2, n2, s2)) : r2;
  }
  _isInFeatureSet(e3) {
    return this._parent._isInFeatureSet(e3);
  }
...
let O$1 = class O extends x {
  ...
  _initialiseFeatureSet() {
    ...
    if (null !== this._parent) {
      ...
      this.geometryType = N$1.point, this.typeIdField = "", this.types = null, this.subtypes = null, this.subtypeField = "", this.spatialReference = new f$1({ wkid: 4326 });
    this.fields = [];
    const a4 = new a$1();
  ...
  async _getFilteredSet(e$12, t2, i, s2, l2) {
    if ("" !== e$12)
    ...
    if (false !== this._candosimplegroupby && await this._parent._canDoAggregates(this.phsyicalgroupbyfields, this._decodedStatsfield, "", null, null)) {
      ...
      return this._checkCancelled(l2), o = true === d2.nowhereclause ? new t$1(n2._candidates.slice(0).concat(n2._known.slice(0)), [], true === d2.ordered && n2._ordered, this._clonePageDefinition(n2.pagesDefinition)) : new t$1(n2._candidates.slice(0), n2._known.slice(0), true === d2.ordered && n2._ordered, this._clonePageDefinition(n2.pagesDefinition)), o;
    }
    let c$12 = this._parent;
    if (this._adaptedFields.length > 0 && (c$12 = new L({ parentfeatureset: this._parent, adaptedFields: this._adaptedFields, extraFilter: null })), true === d2.nowhereclause)
      o = new t$1(["GETPAGES"], [], false, { aggregatefeaturesetpagedefinition: true, resultOffset: 0, resultRecordCount: this._maxQuery, internal: { fullyResolved: false, workingItem: null, type: "manual", iterator: null, set: [], subfeatureset: new a$2({ parentfeatureset: c$12, orderbyclause: new e2(this.phsyicalgroupbyfields.join(",") + "," + this._parent.objectIdField + " ASC") }) } });
    else {
      let e$13 = c$12;
      if (null !== i) {
        let t3 = null;
      ...
      o = new t$1(["GETPAGES"], [], false, { aggregatefeaturesetpagedefinition: true, resultOffset: 0, resultRecordCount: this._maxQuery, internal: { fullyResolved: false, workingItem: null, type: "manual", iterator: null, set: [], subfeatureset: new a$2({ parentfeatureset: e$13, orderbyclause: new e2(this.phsyicalgroupbyfields.join(",") + "," + this._parent.objectIdField + " ASC") }) } });
    }
    return o;
  }
  ...
  _nextAggregateItem(e3, i, s2, n2, r2, a4) {
    try {
      Ie(e3.pagesDefinition.internal.iterator.next()).then((t2) => {
        if (null === t2)
          ...
          if (null === e3.pagesDefinition.internal.workingItem)
            e3.pagesDefinition.internal.workingItem = { features: [t2], id: l2 };
          else {
            if (l2 !== e3.pagesDefinition.internal.workingItem.id) {
              const s3 = this._calculateAndAppendAggregateItem(e3.pagesDefinition.internal.workingItem);
              return n2.push(s3), e3.pagesDefinition.internal.workingItem = null, e3.pagesDefinition.internal.set.push(s3.attributes[this.objectIdField]), i -= 1, e3.pagesDefinition.internal.workingItem = { features: [t2], id: l2 }, void r2(s3);
            }
...
class P extends x {
  ...
  _initialiseFeatureSet() {
    ...
    this._layer instanceof ie ? (this.subtypeField = this._layer.subtypeField ?? "", this.subtypes = this._layer.subtypes, this.types = null, this.typeIdField = null) : (this.typeIdField = this._layer.typeIdField ?? "", this.types = this._layer.types, this.subtypeField = this._layer.subtypeField, this.subtypes = this._layer.subtypes);
  }
  _isInFeatureSet() {
    return s$1.InFeatureSet;
  }
  ...
  async _getDistinctPages(e3, t2, i, r$12, s2, l2, o, u, d2) {
    ...
    for (let a4 = 0; a4 < _.features.length; a4++) {
      if (g2) {
        const e4 = _.features[a4].attributes[h];
        null !== e4 ? u.push(new Date(e4)) : u.push(e4);
      } else
        u.push(_.features[a4].attributes[h]);
      if (u.length >= o)
        break;
    }
  ...
  async _stats(e3, t2, i, r$12, s2, l2, o) {
    await this._ensureLoaded();
    const u = this._layer.capabilities && this._layer.capabilities.query && true === this._layer.capabilities.query.supportsSqlExpression, d2 = this._layer.capabilities && this._layer.capabilities.query && true === this._layer.capabilities.query.supportsStatistics, p2 = this._layer.capabilities && this._layer.capabilities.query && true === this._layer.capabilities.query.supportsDistinct;
    if ("count" === e3)
      return p2 ? this._countstat(e3, i, r$12, s2) : { calculated: false };
    if (false === d2 || false === D$2(t2) && false === u || false === t2.isStandardized)
      return "" !== i || null !== s2 ? { calculated: false } : this._manualStat(e3, t2, l2, o);
    if ("distinct" === e3)
      return false === p2 ? "" !== i || null !== s2 ? { calculated: false } : this._manualStat(e3, t2, l2, o) : this._distinctStat(e3, t2, i, r$12, s2, l2, o);
    ...
    let _ = null === s2 ? null === r$12 ? "1=1" : "" : f$2(s2, h);
    ...
    const g2 = new m$1();
    g2.statisticType = w$1(e3), g2.onStatisticField = f$2(t2, h), g2.outStatisticFieldName = "ARCADE_STAT_RESULT", c2.returnGeometry = false;
    ...
    for (let a4 = 0; a4 < S2.length; a4++)
      if ("ARCADE_STAT_RESULT" === S2[a4].name.toUpperCase()) {
        w2 = S2[a4].name, "date" === S2[a4].type && (b3 = true);
        break;
      }
    if (b3) {
  ...
  async _getAggregatePagesDataSourceDefinition(e3, t2, i, r2, s2, a4, n2) {
    await this._ensureLoaded();
    const l2 = await this.databaseType();
    let u = "", d2 = false, p2 = false;
    null !== a4 && this._layer.capabilities && this._layer.capabilities.query && true === this._layer.capabilities.query.supportsOrderBy && (u = a4.constructClause(), p2 = true), this._layer.capabilities && this._layer.capabilities.query && false === this._layer.capabilities.query.supportsPagination && (p2 = false, d2 = true, u = this._layer.objectIdField);
    const h = [];
    for (let o = 0; o < t2.length; o++) {
      const e4 = new m$1();
      e4.onStatisticField = null !== t2[o].workingexpr ? f$2(t2[o].workingexpr, l2) : "", e4.outStatisticFieldName = t2[o].field, e4.statisticType = t2[o].toStatisticsName(), h.push(e4);
    }
    "" === u && (u = e3.join(","));
    ...
    return new t$1([], ["GETPAGES"], p2, { groupbypage: true, spatialRel: this._makeRelationshipEnum(i), relationParam: this._makeRelationshipParam(i), outFields: ["*"], useOIDpagination: d2, generatedOid: n2, resultRecordCount: c2, resultOffset: 0, groupByFieldsForStatistics: e3, outStatistics: h, geometry: null === r2 ? null : r2, where: m2, orderByFields: u, returnGeometry: false, returnIdsOnly: false, internal: { lastMaxId: -1, set: [], lastRetrieved: 0, lastPage: 0, fullyResolved: false } });
  }
  async _getAgregagtePhysicalPage(t2, i, r$12) {
    ...
    if (this._requestStandardised && (d2.sqlFormat = "standard"), d2.where = s2, d2.spatialRelationship = t2.pagesDefinition.spatialRel, d2.relationParameter = t2.pagesDefinition.relationParam, d2.outFields = t2.pagesDefinition.outFields, d2.outStatistics = t2.pagesDefinition.outStatistics, d2.geometry = t2.pagesDefinition.geometry, d2.groupByFieldsForStatistics = t2.pagesDefinition.groupByFieldsForStatistics, d2.num = t2.pagesDefinition.resultRecordCount, d2.start = t2.pagesDefinition.internal.lastPage, d2.returnGeometry = t2.pagesDefinition.returnGeometry, this.datesInUnknownTimezone && (d2.timeReferenceUnknownClient = true), d2.orderByFields = "" !== t2.pagesDefinition.orderByFields ? t2.pagesDefinition.orderByFields.split(",") : null, this.isTable() && d2.geometry && d2.spatialRelationship)
      return [];
    const p2 = await this.executeQuery(d2, "execute");
    if (this._checkCancelled(r$12), !p2.hasOwnProperty("features"))
      throw new s$2(r.InvalidStatResponse);
    const h = [];
    if (t2.pagesDefinition.internal.lastPage !== u)
      return [];
    p2.features.length > 0 && void 0 === p2.features[0].attributes[t2.pagesDefinition.generatedOid] && (t2.pagesDefinition.generatedOid = t2.pagesDefinition.generatedOid.toLowerCase());
    for (let e3 = 0; e3 < p2.features.length; e3++)
      t2.pagesDefinition.internal.set[o + e3] = p2.features[e3].attributes[t2.pagesDefinition.generatedOid];
    for (let a4 = 0; a4 < p2.features.length; a4++)
      h.push(new c$1({ attributes: p2.features[a4].attributes, geometry: null }));
    return true === t2.pagesDefinition.useOIDpagination ? 0 === p2.features.length ? t2.pagesDefinition.internal.fullyResolved = true : t2.pagesDefinition.internal.lastMaxId = p2.features[p2.features.length - 1].attributes[t2.pagesDefinition.generatedOid] : (void 0 === p2.exceededTransferLimit && p2.features.length !== t2.pagesDefinition.resultRecordCount || false === p2.exceededTransferLimit) && (t2.pagesDefinition.internal.fullyResolved = true), t2.pagesDefinition.internal.lastRetrieved = l2 + p2.features.length, t2.pagesDefinition.internal.lastPage += t2.pagesDefinition.resultRecordCount, h;
  }
  static create(e3, t2, i, r2, s2) {
    const a4 = new We({ url: e3, outFields: null === t2 ? ["*"] : t2 });
    return new P({ layer: a4, spatialReference: i, lrucache: r2, interceptor: s2 });
  }
  ...
  async queryRelatedFeatures(t2) {
    ...
    void 0 !== t2.resultOffset && null !== t2.resultOffset && (r$12.resultOffset = t2.resultOffset.toString()), void 0 !== t2.resultRecordCount && null !== t2.resultRecordCount && (r$12.resultRecordCount = t2.resultRecordCount.toString()), t2.orderByFields && (r$12.orderByFields = t2.orderByFields.join(",")), t2.objectIds && t2.objectIds.length > 0 && (r$12.objectIds = t2.objectIds.join(",")), t2.outSpatialReference && (r$12.outSR = d$3(t2.outSpatialReference)), this.featureSetQueryInterceptor && this.featureSetQueryInterceptor.preRequestCallback({ layer: this._layer, queryPayload: r$12, method: "relatedrecords", url: this._layer.parsedUrl.path + "/queryRelatedRecords" });
    const s2 = await U$1(this._layer.parsedUrl.path + "/queryRelatedRecords", { responseType: "json", query: r$12 });
    if (s2.data) {
      const t3 = {}, i = s2.data;
      if (i?.relatedRecordGroups) {
        ...
        for (const s3 of i.relatedRecordGroups) {
          ...
          for (const t4 of s3.relatedRecords) {
            ...
            const i2 = new c$1({ geometry: t4.geometry ? y$3(t4.geometry) : null, attributes: t4.attributes });
            n2.push(i2);
          }
  ...
  async getOwningSystemUrl() {
    ...
    if (r2 = s2 > -1 ? r2.substring(0, s2) : r2, r2) {
      r2 += "/rest/info";
      try {
        const e4 = await U$1(r2, { query: { f: "json" } });
        let t2 = "";
  ...
  getDataSourceFeatureSet() {
    const e3 = new P({ layer: this._layer, spatialReference: this.spatialReference ?? void 0, outFields: this._overrideFields ?? void 0, includeGeometry: !this._removeGeometry, lrucache: this.recentlyUsedQueries ?? void 0, interceptor: this.featureSetQueryInterceptor ?? void 0 });
  ...
  async getFeatureSetInfo() {
    ...
    if (t2) {
      const s3 = await U$1(t2, { responseType: "json", query: { f: "json" } });
...
class f extends x {
  ...
  _changeFeature(t2) {
    const s2 = {};
    for (const e3 of this.fields)
      s2[e3.name] = t2.attributes[e3.name];
    return new c$1({ geometry: true === this._removeGeometry ? null : t2.geometry, attributes: s2 });
  }
  async _getFilteredSet(e3, t2, s2, r2, a4) {
    let n2 = "", u = false;
    if (null !== r2 && (n2 = r2.constructClause(), u = true), this.isTable() && t2 && null !== e3 && "" !== e3) {
      return new t$1([], [], true, null);
    }
    const h = new b$2();
    h.returnZ = this.hasZ, h.returnM = this.hasM, h.where = null === s2 ? null === t2 ? "1=1" : "" : f$2(s2, l.Standardised), h.spatialRelationship = this._makeRelationshipEnum(e3), h.outSpatialReference = this.spatialReference, h.orderByFields = "" !== n2 ? n2.split(",") : null, h.geometry = null === t2 ? null : t2, h.returnGeometry = true, h.relationParameter = this._makeRelationshipParam(e3);
  ...
  async _queryAllFeatures() {
    ...
    if (e3.where = "1=1", await this._ensureLoaded(), this._layer.source && this._layer.source.items) {
      ...
      return this._layer.source.items.forEach((t3) => {
        ...
        e4.push(s3), this._featureCache[s3] = this._changeFeature(t3);
      }), this._wset = new t$1([], e4, false, null), this._wset;
    }
    e3.returnZ = this.hasZ, e3.returnM = this.hasM;
    const t2 = await this._layer.queryFeatures(e3), s2 = [];
    return t2.features.forEach((e4) => {
      const t3 = e4.attributes[this._layer.objectIdField];
      s2.push(t3), this._featureCache[t3] = this._changeFeature(e4);
    }), this._wset = new t$1([], s2, false, null), this._wset;
  }
  async _getFeatures(e3, r$12, i) {
    const a4 = [];
    -1 !== r$12 && void 0 === this._featureCache[r$12] && a4.push(r$12);
    for (let t2 = e3._lastFetchedIndex; t2 < e3._known.length && (e3._lastFetchedIndex += 1, !(void 0 === this._featureCache[e3._known[t2]] && (e3._known[t2] !== r$12 && a4.push(e3._known[t2]), a4.length > i))); t2++)
      ;
    if (0 === a4.length)
      return "success";
  ...
  static create(e3, t2) {
    let s2 = e3.layerDefinition.objectIdField;
    const r2 = e3.layerDefinition.typeIdField ?? "", i = [];
    ...
    if (!s2) {
      let t3 = false;
      for (const r3 of e3.layerDefinition.fields)
        if ("oid" === r3.type || "esriFieldTypeOID" === r3.type) {
          s2 = r3.name, t3 = true;
          break;
        }
      if (false === t3) {
        let t4 = "FID", r3 = true, i2 = 0;
        for (; r3; ) {
          let s3 = true;
          for (const r4 of e3.layerDefinition.fields)
            if (r4.name === t4) {
              s3 = false;
              break;
            }
          true === s3 ? r3 = false : (i2++, t4 = "FID" + i2.toString());
        }
        e3.layerDefinition.fields.push({ type: "esriFieldTypeOID", name: t4, alias: t4 });
        const a5 = [];
        for (let s3 = 0; s3 < l2.length; s3++)
          a5.push({ geometry: e3.featureSet.features[s3].geometry, attributes: e3.featureSet.features[s3].attributes ? this._cloneAttr(e3.featureSet.features[s3].attributes) : {} }), a5[s3].attributes[t4] = s3;
        l2 = a5, s2 = t4;
      }
    }
    const o = [];
    ...
    if ("esriGeometryNull" !== y2)
      for (const h of l2)
        h.geometry && h.geometry instanceof n$7 == false && (h.geometry.type = y2, void 0 === h.geometry.spatialReference && (h.geometry.spatialReference = n2));
    else
      for (const u of l2)
        u.geometry && (u.geometry = null);
    const d2 = { outFields: ["*"], source: l2, fields: o, hasZ: true === e3?.layerDefinition?.hasZ || true === e3?.featureSet?.hasZ, hasM: true === e3?.layerDefinition?.hasM || true === e3?.featureSet?.hasM, types: i, typeIdField: r2, objectIdField: s2, spatialReference: t2 }, _ = "esriGeometryNull" === y2 || null === y2;
    _ || (d2.geometryType = y2);
    const m2 = new We(d2);
    e3?.layerDefinition?.subtypeField && e3?.layerDefinition?.subtypes && m2.read({ subtypes: e3.layerDefinition.subtypes, subtypeField: e3.layerDefinition.subtypeField });
    return new f({ layer: m2, spatialReference: t2, isTable: _ });
  }
  ...
  async getFeatureByObjectId(e3) {
    ...
    return 1 === s2.features.length ? s2.features[0] : null;
  }
  async getOwningSystemUrl() {
    return "";
  }
...
class d extends x {
  ...
  async _getPhysicalPage(e3, t2, r2) {
    const i = e3.pagesDefinition.internal.lastRetrieved, s2 = i, a4 = e3.pagesDefinition.internal.lastPage, n2 = this._layer.nativeCapabilities(), d2 = new d$4();
...
async function S(e3, t2) {
  if (a$3.applicationCache) {
    ...
    if (r2) {
      const a4 = await r2;
      return new We({ url: e3, outFields: t2, sourceJSON: a4 });
    }
    const n2 = new We({ url: e3, outFields: t2 }), i = (async () => (await n2.load(), n2.sourceJSON))();
    if (a$3.applicationCache) {
...
async function N(t2) {
  ...
  const a4 = (async () => {
    const a5 = await U$1(t2, { responseType: "json", query: { f: "json" } });
...
async function C(t2, a4) {
  ...
  const n2 = (async () => {
    const r$13 = await U$1(t2 + "/queryDataElements", { method: "post", responseType: "json", query: { layers: JSON.stringify([a4.toString()]), f: "json" } });
    if (r$13.data) {
      const e3 = r$13.data;
...
async function A(e3, t2) {
  const a4 = { metadata: null, networkId: -1, unVersion: 3, terminals: [], queryelem: null, layerNameLkp: {}, lkp: null }, r2 = await T(e3);
...
class O2 extends e$1 {
  ...
  async featureSetByName(e3, t2 = true, r2 = null) {
    ...
    const i = this._map.allLayers.find((t3) => {
      if (t3 instanceof We) {
        if (t3.title === e3)
          return true;
      } else if (Ee(t3) && t3.title === e3)
        return true;
      return false;
    });
    if (i)
      return this._makeAndAddFeatureSet(i, t2, r2);
    if (this._map.tables) {
      ...
      if (a4) {
        ...
        if (a4._materializedTable)
          ...
          a4._materializedTable = new We(e4);
        }
...
class b2 extends e$1 {
  ...
  clone() {
    return new b2(this._url, this._overridespref, this._lrucache, this._interceptor);
  }
  async featureSetByName(e3, t2 = true, a4 = null) {
    ...
    if (!i)
      for (const s2 of n2.tables ?? [])
        s2.name === e3 && (i = s2);
    if (i) {
      const e4 = await S(this._url + "/" + i.id, ["*"]);
...
async function q(e3, t2, a4, r2, n2, i, s2, l2 = null) {
  if (a$3.applicationCache) {
    ...
    if (o2) {
      const e4 = await o2;
      return g(new We({ url: J(e4.url) + "/" + t2, outFields: ["*"] }), a4, r2, n2, s2, l2);
    }
  }
  const o = new S$3({ id: e3, portal: i }).load();
...
const featureSetUtils = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  constructAssociationMetaDataFeatureSetFromUrl: A,

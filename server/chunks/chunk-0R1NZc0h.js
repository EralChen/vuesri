import { gC as t, aQ as U$1, gI as d, lz as d$1, gD as f, dm as d$2 } from "./chunk-ejFG4zJ0.js";
import "luxon";
...
async function s(e, t2, o) {
  ...
  for (const a2 of s2.relatedRecordGroups) {
    const e2 = { fields: void 0, objectIdFieldName: void 0, geometryType: n2, spatialReference: d2, hasZ: !!s2.hasZ, hasM: !!s2.hasM, features: a2.relatedRecords };
    if (null != a2.objectId)
      c[a2.objectId] = e2;
    else
...
async function a(t$1, s2, n2 = {}, a2) {
  const d2 = t({ ...t$1.query, f: "json", ...a2, ...r(s2, a2) });
  return U$1(t$1.path + "/queryRelatedRecords", { ...n2, query: { ...n2.query, ...d2 } });
}

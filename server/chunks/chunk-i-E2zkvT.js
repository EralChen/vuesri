...
r = i, e = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, t = function(n = {}) {
  ...
  var o2 = Object.assign({}, i2), a2 = "object" == typeof window, u = "function" == typeof importScripts;
  ...
  Object.assign(i2, o2), o2 = null, i2.arguments && i2.arguments, i2.thisProgram && i2.thisProgram, i2.quit && i2.quit, i2.wasmBinary && (l = i2.wasmBinary), i2.noExitRuntime, "object" != typeof WebAssembly && D("no native wasm support detected");
  ...
  function X() {
    ...
    if (H(), i2.instantiateWasm)
      try {
        ...
        v("Module.instantiateWasm callback failed with error: " + o3), t2(o3);
      }
  ...
  function hn(n2) {
    ...
    vn([n2], i3.map((n3) => n3.getterReturnType).concat(i3.map((n3) => n3.setterArgumentType)), (n3) => {
      ...
      return i3.forEach((r4, e3) => {
        ...
        o3[t4] = { read: (n4) => a3.fromWireType(u2(c2, n4)), write: (n4, r5) => {
          var e4 = [];
  ...
  function Gn(n2, r3, e2, t3, i3, o3, a3) {
    var u2 = Hn(r3, e2);
    n2 = wn(n2), i3 = Bn(t3, i3), On(n2, function() {
      ...
      return zn(n2, Un(n2, t4, null, i3, o3), r3 - 1), [];
    });
  }
  function Xn(n2, r3, e2) {
    switch (r3) {
  ...
  function Jn(n2, r3, e2, t3) {
    if (!(t3 > 0))
      return 0;
    for (var i3 = e2, o3 = e2 + t3 - 1, a3 = 0; a3 < n2.length; ++a3) {
    ...
    Tn(n2, { name: r3, fromWireType: function(n3) {
      ...
      if (e2)
        for (var o3 = i3, a3 = 0; a3 <= t3; ++a3) {
          ...
          if (a3 == t3 || 0 == m[u2]) {
            var c2 = rr(o3, u2 - o3);
            void 0 === r4 ? r4 = c2 : (r4 += String.fromCharCode(0), r4 += c2), o3 = u2 + 1;
          }
        }
      else {
        var f2 = new Array(t3);
  ...
  function or(n2, r3, e2) {
    if (void 0 === e2 && (e2 = 2147483647), e2 < 2)
      return 0;
    for (var t3 = r3, i3 = (e2 -= 2) < 2 * n2.length ? e2 / 2 : n2.length, o3 = 0; o3 < i3; ++o3) {
  ...
  function cr(n2, r3, e2) {
    if (void 0 === e2 && (e2 = 2147483647), e2 < 4)
      return 0;
    for (var t3 = r3, i3 = t3 + e2 - 4, o3 = 0; o3 < n2.length; ++o3) {
      var a3 = n2.charCodeAt(o3);
  ...
  function sr(n2, r3, e2) {
    var t3, i3, o3, a3, u2;
    e2 = wn(e2), 2 === r3 ? (t3 = ir, i3 = or, a3 = ar, o3 = () => y, u2 = 1) : 4 === r3 && (t3 = ur, i3 = cr, a3 = fr, o3 = () => w, u2 = 2), Tn(n2, { name: e2, fromWireType: function(n3) {
      for (var e3, i4 = w[n3 >> 2], a4 = o3(), c2 = n3 + 4, f2 = 0; f2 <= i4; ++f2) {
        var s2 = n3 + 4 + f2 * r3;
        if (f2 == i4 || 0 == a4[s2 >> u2]) {
          var l2 = t3(c2, s2 - c2);
      ...
      return w[c2 >> 2] = o4 >> u2, i3(t4, c2 + 4, o4 + r3), null !== n3 && n3.push(Sr, c2), c2;
    }, argPackAdvance: 8, readValueFromPointer: en, destructorFunction: function(n3) {
      Sr(n3);
    } });
  }
  function lr(n2, r3, e2, t3, i3, o3) {
    nn[n2] = { name: wn(r3), rawConstructor: Bn(e2, t3), rawDestructor: Bn(i3, o3), fields: [] };
  }
  function dr(n2, r3, e2, t3, i3, o3, a3, u2, c2, f2) {
    nn[n2].fields.push({ fieldName: wn(r3), getterReturnType: e2, getter: Bn(t3, i3), getterContext: o3, setterArgumentType: a3, setter: Bn(u2, c2), setterContext: f2 });
  }
  function pr(n2, r3) {
  ...
  function Cr(n2) {
    ...
    for (var i3 = 1; i3 <= 4; i3 *= 2) {
      var o3 = r3 * (1 + 0.2 / i3);
      if (o3 = Math.min(o3, n2 + 100663296), Tr(Math.min(e2, t3(Math.max(n2, o3), 65536))))
        return true;
    }
    return false;
  }
...
const o = o$1(i.exports), a = Object.freeze(Object.defineProperty({ __proto__: null, default: o }, Symbol.toStringTag, { value: "Module" }));
export {
  a as i
};

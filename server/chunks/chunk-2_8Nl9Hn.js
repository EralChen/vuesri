...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_VaBasemap, mergeProps({
    orphan: _ctx.orphan,
    thumbnailUrl: _ctx.thumbnailUrl,
    onLoad: ($event) => _ctx.$emit("load", $event)
  }, _attrs), {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_VaTdtWebTileLayer, {
          defaultOptions: _ctx.webTileLayerOptions,
          type: _ctx.type,
          orphan: true,
          spatialReference: _ctx.spatialReference,
          maxScale: _ctx.maxScale,
          minScale: _ctx.minScale,
          token: _ctx.token,
        ...
        return [
          createVNode(_component_VaTdtWebTileLayer, {
            ...
            _: 1
          }, 8, ["defaultOptions", "type", "spatialReference", "maxScale", "minScale", "token"]),
          _ctx.anno ? (openBlock(), createBlock(_component_VaTdtWebTileLayer, {
            ...
            _: 1
          }, 8, ["type", "spatialReference", "maxScale", "minScale", "token", "defaultOptions"])) : createCommentVNode("", true),

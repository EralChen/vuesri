import { kZ as d$1, gc as K, k_ as e, aM as s$1, el as d$2, bI as b$1, bb as s$2, a_ as I, a$ as j, dj as Z, dk as i, gb as H, ge as i$1, gn as n, c4 as d$3, az as s$3, c0 as M, c6 as B, cZ as f$1, h2 as t$1, hS as t$2, ds as N$1, bj as bt, dl as o$1 } from "./chunk-KFNcxJaF.js";
import { t } from "./chunk-H58sM9yM.js";
import { m as m$1 } from "./chunk-UzDyJefO.js";
import { x as x$1 } from "./chunk-XCl2NxdK.js";
import { W } from "./chunk-mk4KSkT-.js";
import { a as a$1 } from "./chunk-pLXZyeZ7.js";
...
class P {
  ...
  async _fetch(t2) {
    ...
    const s2 = I(i2);
    return (await j(s2.path, { query: { ...s2.query, ...r2 }, responseType: "text", signal: t2 })).data;
  }
  _createQueryEngine(e2) {
    ...
    return new W({ fieldsIndex: Z.fromLayerJSON({ fields: i$12, dateFieldsTimeReference: { timeZoneIANA: i } }), geometryType: "esriGeometryPoint", hasM: false, hasZ: false, timeInfo: r2, objectIdField: t2, spatialReference: n2.spatialReference || { wkid: 4326 }, cacheSpatialQueries: true, featureStore: s2 });
  }
  async _createFeatures(e2) {
    const { latitudeFieldName: t$3, longitudeFieldName: n$1 } = this._locationInfo, { objectIdField: r2, fieldsIndex: s2, spatialReference: o2 } = this._queryEngine;
    let a$12 = [];
    ...
    const w = a(e2, h2, this._delimiter, i$1(I2, r2));
    for (const l2 of w) {
      const e3 = this._parseCoordinateValue(l2[t$3]), o3 = this._parseCoordinateValue(l2[n$1]);
    ...
    if (!d$3({ wkid: 4326 }, o2))
      if (s$3(o2))
        ...
        a$12 = B(t, a$12, f$1.WGS84, o2, null, null);
    const E = [];
    for (let i2 = 0; i2 < a$12.length; i2++) {
      const { x: e3, y: t2 } = a$12[i2], n2 = u2[i2];
      n2[r2] = i2 + 1, E.push(new t$1(new t$2([], [e3, t2]), n2, null, n2[r2]));
    }
    return E;
  }

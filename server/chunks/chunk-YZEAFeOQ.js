...
var t, _, r, o = { exports: {} };
t = o, _ = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, "undefined" != typeof __filename && (_ = _ || __filename), r = function(e = {}) {
  var t2, r2, o2 = e;
  o2.ready = new Promise((e2, _2) => {
    t2 = e2, r2 = _2;
  });
  var n2, p2, i, c = Object.assign({}, o2), s = "./this.program", P = "object" == typeof window, a = "function" == typeof importScripts, g = "object" == typeof process && "object" == typeof process.versions && "string" == typeof process.versions.node, y = "";
  function u(e2) {
  ...
  if (g) {
    ...
    y = a ? f.dirname(y) + "/" : __dirname + "/", n2 = (e2, t3) => (e2 = B(e2) ? new URL(e2) : f.normalize(e2), d.readFileSync(e2, t3 ? void 0 : "utf8")), i = (e2) => {
      ...
      e2 = B(e2) ? new URL(e2) : f.normalize(e2), d.readFile(e2, r3 ? void 0 : "utf8", (e3, o3) => {
        e3 ? _2(e3) : t3(r3 ? o3.buffer : o3);
      });
  ...
  var ee = "undefined" != typeof TextDecoder ? new TextDecoder("utf8") : void 0, te = (e2, t3, _2) => {
    for (var r3 = t3 + _2, o3 = t3; e2[o3] && !(o3 >= r3); )
      ++o3;
  ...
  var oe = (e2, t3, _2, r3) => {
    if (!(r3 > 0))
      return 0;
    for (var o3 = _2, n3 = _2 + r3 - 1, p3 = 0; p3 < e2.length; ++p3) {
  ...
  function ye(e2, t3, _2) {
    var r3 = ge(e2, t3), o3 = new Date(1e3 * r3);
    h[_2 >> 2] = o3.getSeconds(), h[_2 + 4 >> 2] = o3.getMinutes(), h[_2 + 8 >> 2] = o3.getHours(), h[_2 + 12 >> 2] = o3.getDate(), h[_2 + 16 >> 2] = o3.getMonth(), h[_2 + 20 >> 2] = o3.getFullYear() - 1900, h[_2 + 24 >> 2] = o3.getDay();
    var n3 = 0 | ae(o3);
    h[_2 + 28 >> 2] = n3, h[_2 + 36 >> 2] = -60 * o3.getTimezoneOffset();
    var p3 = new Date(o3.getFullYear(), 0, 1), i2 = new Date(o3.getFullYear(), 6, 1).getTimezoneOffset(), c2 = p3.getTimezoneOffset(), s2 = 0 | (i2 != c2 && o3.getTimezoneOffset() == Math.min(c2, i2));
    h[_2 + 32 >> 2] = s2;
  }
  var ue = (e2) => {
    ...
    for (var _2 = 0; _2 < e2.length; ++_2)
      O[t3++ >> 0] = e2.charCodeAt(_2);
    O[t3 >> 0] = 0;
  };
  function Se(e2, t3, _2, r3, o3) {
    return 70;
  }
  ...
  function le(e2, t3, _2) {
    var r3 = _2 > 0 ? _2 : ue(e2) + 1, o3 = new Array(r3), n3 = oe(e2, o3, 0, o3.length);
  ...
  var Me = { c: re, r: (e2, t3, _2) => {
    ...
    var r3 = (/* @__PURE__ */ new Date()).getFullYear(), o3 = new Date(r3, 0, 1), n3 = new Date(r3, 6, 1), p3 = o3.getTimezoneOffset(), i2 = n3.getTimezoneOffset(), c2 = Math.max(p3, i2);
    function s2(e3) {
    ...
    if (e2 > _2)
      return false;
    for (var r3 = (e3, t4) => e3 + (t4 - e3 % t4) % t4, o3 = 1; o3 <= 4; o3 *= 2) {
      var n3 = t3 * (1 + 0.2 / o3);
    ...
    var _2 = 0;
    return Te().forEach((r3, o3) => {
      var n3 = t3 + _2;
      l[e2 + 4 * o3 >> 2] = n3, Oe(r3, n3), _2 += r3.length + 1;
    }), 0;
  }, f: (e2, t3) => {
    var _2 = Te();
    l[e2 >> 2] = _2.length;
  ...
  o2._pe_getPeGTlistExtendedEntrySize = () => (o2._pe_getPeGTlistExtendedEntrySize = ve._b)(), o2._pe_getPeGTlistExtendedGTsSize = () => (o2._pe_getPeGTlistExtendedGTsSize = ve.$b)(), o2._pe_getPeHorizonSize = () => (o2._pe_getPeHorizonSize = ve.ac)(), o2._pe_geog_to_geog = (e2, t3, _2, r3, n3) => (o2._pe_geog_to_geog = ve.cc)(e2, t3, _2, r3, n3), o2._pe_geog_to_proj = (e2, t3, _2) => (o2._pe_geog_to_proj = ve.dc)(e2, t3, _2), o2._pe_geog_to_dd = (e2, t3, _2, r3, n3) => (o2._pe_geog_to_dd = ve.ec)(e2, t3, _2, r3, n3), o2._pe_dd_to_geog = (e2, t3, _2, r3) => (o2._pe_dd_to_geog = ve.fc)(e2, t3, _2, r3), o2._pe_geog_to_ddm = (e2, t3, _2, r3, n3) => (o2._pe_geog_to_ddm = ve.gc)(e2, t3, _2, r3, n3), o2._pe_ddm_to_geog = (e2, t3, _2, r3) => (o2._pe_ddm_to_geog = ve.hc)(e2, t3, _2, r3), o2._pe_geog_to_dms = (e2, t3, _2, r3, n3) => (o2._pe_geog_to_dms = ve.ic)(e2, t3, _2, r3, n3), o2._pe_dms_to_geog = (e2, t3, _2, r3) => (o2._pe_dms_to_geog = ve.jc)(e2, t3, _2, r3), o2._pe_geog_to_mgrs_extended = (e2, t3, _2, r3, n3, p3, i2) => (o2._pe_geog_to_mgrs_extended = ve.kc)(e2, t3, _2, r3, n3, p3, i2), o2._pe_mgrs_to_geog_extended = (e2, t3, _2, r3, n3) => (o2._pe_mgrs_to_geog_extended = ve.lc)(e2, t3, _2, r3, n3), o2._pe_geog_to_usng = (e2, t3, _2, r3, n3, p3, i2) => (o2._pe_geog_to_usng = ve.mc)(e2, t3, _2, r3, n3, p3, i2), o2._pe_usng_to_geog = (e2, t3, _2, r3) => (o2._pe_usng_to_geog = ve.nc)(e2, t3, _2, r3), o2._pe_geog_to_utm = (e2, t3, _2, r3, n3) => (o2._pe_geog_to_utm = ve.oc)(e2, t3, _2, r3, n3), o2._pe_utm_to_geog = (e2, t3, _2, r3, n3) => (o2._pe_utm_to_geog = ve.pc)(e2, t3, _2, r3, n3), o2._pe_object_to_string_ext = (e2, t3, _2) => (o2._pe_object_to_string_ext = ve.qc)(e2, t3, _2), o2._pe_proj_to_geog_center = (e2, t3, _2, r3) => (o2._pe_proj_to_geog_center = ve.rc)(e2, t3, _2, r3), o2.___start_em_js = 2033306, o2.___stop_em_js = 2033404, o2.getValue = Q, o2.UTF8ToString = _e, w = function e2() {
    De || or(), De || (w = e2);
  ...
  var yr = { buffer: 0, size: 0, pos: 0, temps: [], needed: 0, prepare() {
    ...
    yr.buffer || (yr.size += 128, yr.buffer = o2._webidl_malloc(yr.size), R(yr.buffer)), yr.pos = 0;
  }, alloc(e2, t3) {
    R(yr.buffer);
    var _2, r3 = t3.BYTES_PER_ELEMENT, n3 = e2.length * r3;
    return n3 = n3 + 7 & -8, yr.pos + n3 >= yr.size ? (R(n3 > 0), yr.needed += n3, _2 = o2._webidl_malloc(n3), yr.temps.push(_2)) : (_2 = yr.buffer + yr.pos, yr.pos += n3), _2;
  }, copy(e2, t3, _2) {
  ...
  function Mr(e2, t3, _2, r3, o3, n3) {
    e2 && "object" == typeof e2 && (e2 = e2.ptr), t3 && "object" == typeof t3 && (t3 = t3.ptr), _2 && "object" == typeof _2 && (_2 = _2.ptr), r3 && "object" == typeof r3 && (r3 = r3.ptr), o3 && "object" == typeof o3 && (o3 = o3.ptr), n3 && "object" == typeof n3 && (n3 = n3.ptr), this.ptr = Nt(e2, t3, _2, r3, o3, n3), pr(Mr)[this.ptr] = this;
  }
  function vr() {
  ...
  return Tr.prototype = Object.create(nr.prototype), Tr.prototype.constructor = Tr, Tr.prototype.__class__ = Tr, Tr.__cache__ = {}, o2.PeObject = Tr, Tr.prototype.getCode = Tr.prototype.getCode = function() {
    ...
    var e2 = this.ptr;
    return Xt(e2);
  }, Rr.prototype = Object.create(nr.prototype), Rr.prototype.constructor = Rr, Rr.prototype.__class__ = Rr, Rr.__cache__ = {}, o2.PeGTlistExtended = Rr, Rr.prototype.getGTlist = Rr.prototype.getGTlist = function(e2, t3, _2, r3, o3, n3) {
    var p3 = this.ptr;
    return e2 && "object" == typeof e2 && (e2 = e2.ptr), t3 && "object" == typeof t3 && (t3 = t3.ptr), _2 && "object" == typeof _2 && (_2 = _2.ptr), r3 && "object" == typeof r3 && (r3 = r3.ptr), o3 && "object" == typeof o3 && (o3 = o3.ptr), n3 && "object" == typeof n3 && (n3 = n3.ptr), ir(zt(p3, e2, t3, _2, r3, o3, n3), Ar);
  }, Rr.prototype.get_PE_GTLIST_OPTS_COMMON = Rr.prototype.get_PE_GTLIST_OPTS_COMMON = function() {
    var e2 = this.ptr;
    return Zt(e2);
  }, Object.defineProperty(Rr.prototype, "PE_GTLIST_OPTS_COMMON", { get: Rr.prototype.get_PE_GTLIST_OPTS_COMMON }), Ar.prototype = Object.create(nr.prototype), Ar.prototype.constructor = Ar, Ar.prototype.__class__ = Ar, Ar.__cache__ = {}, o2.PeGTlistExtendedEntry = Ar, Ar.prototype.getEntries = Ar.prototype.getEntries = function() {
    var e2 = this.ptr;
    return ir(Wt(e2), Gr);
...
const n = o$1(o.exports), p = Object.freeze(Object.defineProperty({ __proto__: null, default: n }, Symbol.toStringTag, { value: "Module" }));
export {
  p
};

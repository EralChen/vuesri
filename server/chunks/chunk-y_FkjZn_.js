import { dM as u$5, cJ as m$4, dJ as N$2, bu as u$6, p3 as a$2, bb as s$5, tG as h$3, tH as s$6, n1 as r$4, aq as has, rz as n$4, b$ as n$5, tj as n$6, tl as o$4, tI as i$3, tJ as n$7, tK as c$3, tL as e$3, tM as i$4, tN as I$2, tO as z$1, cS as t$2, a$ as j$1, aM as s$7, tP as y$2, tQ as g$3, h8 as u$7, tR as y$3, tS as d$4, tT as p$2, i6 as a$3, tU as g$4, hq as h$4, tV as d$5, tW as j$2, ht as y$4, hp as N$3, tX as k$1, dK as i$5, tY as R$1, tZ as D$2 } from "./chunk-KFNcxJaF.js";
const n$3 = /^-?(\d+)(\.(\d+))?$/i;
function e$2(t2, n2) {
  return t2 - n2;
}
...
function o$3(t2, n2, e2, r2, o2) {
  const i2 = l$2(t2, n2, e2, r2), u2 = null == i2.previous || i2.previous <= o2, s2 = null == i2.next || i2.next <= o2;
  return u2 && s2 || i2.previous + i2.next <= 2 * o2;
}
function i$2(t2) {
  const e2 = String(t2), r2 = e2.match(n$3);
  if (r2 && r2[1])
...
function u$4(t2, n2 = {}) {
  ...
  for (let e2 = 0; e2 < c2.length; e2++) {
    const t3 = c2[e2], n3 = l2[t3], a2 = 0 === t3 ? null : l2[t3 - 1], f2 = t3 === l2.length - 1 ? null : l2[t3 + 1], m2 = i$2(n3).fractional;
    if (m2) {
      let i2, c3 = 0, g2 = false;
      for (; c3 <= m2 && !g2; ) {
        const t4 = r$3(n3, c3);
        i2 = s2 && 0 === e2 ? t4[1] : t4[0], g2 = o$3(n3, i2, a2, f2, u2), c3++;
      }
      g2 && (l2[t3] = i2);
    }
  }
...
const i$1 = "<", a$1 = ">";
function r$2(l2, r2, s2, o2) {
  let n2 = "";
  0 === r2 ? n2 = `${i$1} ` : r2 === s2 && (n2 = `${a$1} `);
  return n2 + (o2 ? N$2(l2, o2) : c$2(l2));
}
...
async function o$2(A2) {
  if (!("visualVariables" in A2) || !A2.visualVariables)
    return null;
  const t2 = A2.visualVariables.find((A3) => "color" === A3.type);
  if (!t2)
    return null;
  let l2 = null, i2 = null;
  if (t2.stops) {
    if (1 === t2.stops.length)
      return t2.stops[0].color;
    l2 = t2.stops[0].value, i2 = t2.stops[t2.stops.length - 1].value;
  }
  const a2 = null != l2 && null != i2 ? l2 + (i2 - l2) / 2 : 0, { getColor: r2 } = await import("./chunk-KFNcxJaF.js").then((n2) => n2.D_);
  return r2(t2, a2) ?? null;
}
async function n$2(A2, t2) {
  const i2 = A2.trailCap, a2 = A2.trailWidth || 1, r2 = t2 || await o$2(A2) || A2.color;
  return new m$4({ cap: i2, color: r2, width: a2 });
}
function e$1(A2) {
  return null != A2 && "object" == typeof A2 && "min" in A2 && "max" in A2;
}
const o$1 = new u$6([64, 64, 64]);
function n$1(l2, o2) {
...
async function r$1(l2, e2, o2) {
  ...
  return (await Promise.all(a2.map(async (o3, n2) => ({ value: o3, color: "opacity" === l2.type ? await t$1(o3, l2, e2) : (await import("./chunk-KFNcxJaF.js").then((n3) => n3.D_)).getColor(l2, o3), label: r2 ? u2[n2] : c2?.[n2] ?? "" })))).reverse();
}
async function t$1(e2, n2, r2) {
  const t2 = new u$6(r2 ?? o$1), a2 = (await import("./chunk-KFNcxJaF.js").then((n3) => n3.D_)).getOpacity(n2, e2);
...
function u$3(e2, o2) {
  ...
  if (n2 === r2)
    return o2[n2].color;
  const a2 = u$6.blendColors(o2[n2].color, o2[r2].color, t2);
  return new u$6(a2);
}
function s$2(l2, e2) {
...
function i(e2, o2) {
  ...
  if (e2 && "multipart" === e2.type)
    e2.colorRamps.reverse().forEach((r2, t2) => {
      0 === t2 ? n2.push({ value: o2.max, color: new u$6(r2.toColor), label: "high" }) : n2.push({ value: null, color: new u$6(r2.toColor), label: "" }), t2 === e2.colorRamps.length - 1 ? n2.push({ value: o2.min, color: new u$6(r2.fromColor), label: "low" }) : n2.push({ value: null, color: new u$6(r2.fromColor), label: "" });
    });
  else {
    let r2, t2;
    e2 && "algorithmic" === e2.type ? (r2 = e2.fromColor, t2 = e2.toColor) : (r2 = [0, 0, 0, 1], t2 = [255, 255, 255, 1]), n2 = [{ value: o2.max, color: new u$6(t2), label: "high" }, { value: o2.min, color: new u$6(r2), label: "low" }];
  }
  return n2;
}
function r(r2) {
  ...
  if (e2 && e2[0]) {
    const r3 = e2[t2];
    r3 && 1 !== r3.ratio && (e2.push(new a$2({ ratio: 1, color: r3.color })), t2++);
  }
  return e2.map((o2, e3) => {
    let l2 = "";
...
s$5.getLogger("esri.renderers.support.utils");
async function w$1(e2, l2, t2) {
  r$4(e2, l2, () => []).push(...t2);
}
async function x$2(l2) {
  const t2 = /* @__PURE__ */ new Map();
  if (!l2)
    return t2;
  if ("visualVariables" in l2 && l2.visualVariables) {
    const e2 = l2.visualVariables.filter((e3) => "color" === e3.type);
    for (const l3 of e2) {
      const e3 = (await r$1(l3) ?? []).map((e4) => e4.color);
      await w$1(t2, l3.field || l3.valueExpression, e3);
    }
  }
  if ("heatmap" === l2.type) {
    const e2 = r(l2).map((e3) => e3.color);
    await w$1(t2, l2.field || l2.valueExpression, e2);
  } else if ("pie-chart" === l2.type) {
    for (const e2 of l2.attributes)
      await w$1(t2, e2.field || e2.valueExpression, [e2.color]);
    await w$1(t2, "default", [l2?.othersCategory?.color, h$3(l2.backgroundFillSymbol, null)]);
  } else if ("dot-density" === l2.type) {
    for (const e2 of l2.attributes)
      await w$1(t2, e2.field || e2.valueExpression, [e2.color]);
    await w$1(t2, "default", [l2.backgroundColor]);
  } else if ("unique-value" === l2.type)
    if ("predominance" === l2.authoringInfo?.type)
      for (const e2 of l2.uniqueValueInfos ?? [])
        await w$1(t2, e2.value.toString(), [h$3(e2.symbol, null)]);
    else {
      const e2 = (l2.uniqueValueInfos ?? []).map((e3) => h$3(e3.symbol, null)), { field: i2, field2: o2, field3: a2, valueExpression: n2 } = l2;
      (i2 || n2) && await w$1(t2, i2 || n2, e2), o2 && await w$1(t2, o2, e2), a2 && await w$1(t2, a2, e2);
    }
  else if ("class-breaks" === l2.type) {
    const e2 = l2.classBreakInfos.map((e3) => h$3(e3.symbol, null)), { field: i2, valueExpression: o2 } = l2;
    await w$1(t2, i2 ?? o2, e2);
  } else
    "simple" === l2.type && await w$1(t2, "default", [h$3(l2.symbol, null)]);
  return "defaultSymbol" in l2 && l2.defaultSymbol && await w$1(t2, "default", [h$3(l2.defaultSymbol, null)]), t2.forEach((l3, i2) => {
    const o2 = s$6(l3.filter(Boolean), (e2, l4) => JSON.stringify(e2) === JSON.stringify(l4));
    t2.set(i2, o2);
  }), t2;
}
var t;
...
function d$3(t2, e2) {
  ...
  if ("type" in t2 && ("linear" === t2.type || "pattern" === t2.type))
    return t2;
  const m2 = new u$6(t2);
  return new u$6([h$2(m2.r, e2), h$2(m2.g, e2), h$2(m2.b, e2), m2.a]);
}
const h$1 = "http://www.w3.org/2000/svg";
let f$1 = 0, c = 0;
const d$2 = has("android"), u$1 = has("chrome") || d$2 && d$2 >= 4 ? "auto" : "optimizeLegibility", y$1 = { m: 2, l: 2, h: 1, v: 1, c: 6, s: 4, q: 4, t: 2, a: 7, z: 0 }, p = /([A-DF-Za-df-z])|([-+]?\d*[.]?\d+(?:[eE][-+]?\d+)?)/g;
let g$2 = {}, m$2 = {};
const x$1 = { solid: "none", shortdash: [4, 1], shortdot: [1, 1], shortdashdot: [4, 1, 1, 1], shortdashdotdot: [4, 1, 1, 1, 1, 1], dot: [1, 3], dash: [4, 3], longdash: [8, 3], dashdot: [4, 3, 1, 3], longdashdot: [8, 3, 1, 3], longdashdotdot: [8, 3, 1, 3, 1, 3] }, w = Math.PI;
let k = 1;
function b$1(t2, e2) {
  const i2 = t2 * (w / 180);
...
function v$1(t2, i2, n2, r2) {
  if (t2) {
    if ("circle" === t2.type)
      return n$4("circle", { cx: t2.cx, cy: t2.cy, fill: i2, "fill-rule": "evenodd", r: t2.r, stroke: n2.color, "stroke-dasharray": n2.dashArray, "stroke-dashoffset": n2.dashOffset, "stroke-linecap": n2.cap, "stroke-linejoin": n2.join, "stroke-miterlimit": "4", "stroke-width": n2.width });
    if ("ellipse" === t2.type)
      return n$4("ellipse", { cx: t2.cx, cy: t2.cy, fill: i2, "fill-rule": "evenodd", rx: t2.rx, ry: t2.ry, stroke: n2.color, "stroke-dasharray": n2.dashArray, "stroke-linecap": n2.cap, "stroke-linejoin": n2.join, "stroke-miterlimit": "4", "stroke-width": n2.width });
    if ("rect" === t2.type)
      return n$4("rect", { fill: i2, "fill-rule": "evenodd", height: t2.height, stroke: n2.color, "stroke-dasharray": n2.dashArray, "stroke-linecap": n2.cap, "stroke-linejoin": n2.join, "stroke-miterlimit": "4", "stroke-width": n2.width, width: t2.width, x: t2.x, y: t2.y });
    if ("image" === t2.type)
      return n$4("image", { height: t2.height, href: t2.src, preserveAspectRatio: "none", width: t2.width, x: t2.x, y: t2.y });
    if ("path" === t2.type) {
      const e2 = "string" != typeof t2.path ? j(t2.path) : t2.path;
      return n$4("path", { d: e2, fill: i2, "fill-rule": "evenodd", stroke: n2.color, "stroke-dasharray": n2.dashArray, "stroke-linecap": n2.cap, "stroke-linejoin": n2.join, "stroke-miterlimit": "4", "stroke-width": n2.width });
    }
    if ("text" === t2.type)
      return n$5(r2), n$4("text", { "dominant-baseline": r2.dominantBaseline, fill: i2, "fill-rule": "evenodd", "font-family": r2.font.family, "font-size": r2.font.size, "font-style": r2.font.style, "font-variant": r2.font.variant, "font-weight": r2.font.weight, kerning: r2.kerning, rotate: r2.rotate, stroke: n2.color, "stroke-dasharray": n2.dashArray, "stroke-linecap": n2.cap, "stroke-linejoin": n2.join, "stroke-miterlimit": "4", "stroke-width": n2.width, "text-anchor": r2.align, "text-decoration": r2.decoration, "text-rendering": u$1, x: t2.x, y: t2.y }, t2.text);
  }
  return null;
}
function M(e2) {
  ...
  if (e2) {
    if ("type" in e2 && "pattern" === e2.type) {
      ...
      const n2 = "linearGradientId-" + ++c;
      i2.fill = `url(#${n2})`, i2.linearGradient = { id: n2, x1: e2.x1, y1: e2.y1, x2: e2.x2, y2: e2.y2, stops: e2.colors.map((e3) => ({ offset: e3.offset, color: e3.color && new u$6(e3.color).toString() })) };
    } else if (e2) {
      const n2 = new u$6(e2);
      i2.fill = n2.toString();
    }
...
function A$1(e2) {
  ...
  if (e2 && (null != e2.width && (i2.width = e2.width), e2.cap && (i2.cap = e2.cap), e2.join && (i2.join = e2.join.toString()), e2.color && (i2.color = new u$6(e2.color).toString()), e2.dashArray && (i2.dashArray = e2.dashArray), e2.dashArray && (i2.dashOffset = e2.dashoffset), e2.style)) {
    let t2 = null;
    if (e2.style in x$1 && (t2 = x$1[e2.style]), Array.isArray(t2)) {
      t2 = t2.slice(0);
      const i3 = e2.width ?? 0;
...
function S$1(t2, i2) {
  const n2 = { align: null, decoration: null, kerning: null, rotate: null, font: { style: null, variant: null, weight: null, size: null, family: null } };
  if (t2) {
    const r2 = t2.alignBaseline, o2 = "baseline" === r2 ? "auto" : "top" === r2 ? "text-top" : "bottom" === r2 ? "hanging" : r2;
    n2.align = t2.align, n2.dominantBaseline = o2, n2.decoration = t2.decoration, n2.kerning = t2.kerning ? "auto" : "0", n2.rotate = t2.rotated ? "90" : "0", n$5(i2), n2.font.style = i2.style || "normal", n2.font.variant = i2.variant || "normal", n2.font.weight = i2.weight || "normal", n2.font.size = i2.size && i2.size.toString() || "10pt", n2.font.family = i2.family || "serif";
  }
  return n2;
}
function $$1(t2) {
  ...
  if (e2)
    return n$4("pattern", { height: e2.height, id: e2.id, patternUnits: "userSpaceOnUse", width: e2.width, x: e2.x, y: e2.y }, n$4("image", { height: e2.image.height, href: e2.image.href, width: e2.image.width, x: e2.image.x, y: e2.image.y }));
  if (i2) {
    const t3 = i2.stops.map((t4, e3) => n$4("stop", { key: `${e3}-stop`, offset: t4.offset, "stop-color": t4.color }));
    return n$4("linearGradient", { gradientUnits: "userSpaceOnUse", id: i2.id, x1: i2.x1, x2: i2.x2, y1: i2.y1, y2: i2.y2 }, t3);
  }
  return null;
}
function N$1(t2, e2) {
  ...
  const i2 = [];
  for (const n2 of t2) {
    const { shape: t3, fill: e3, stroke: r2, font: o2 } = n2, s2 = M(e3), a2 = A$1(r2), l2 = "text" === t3.type ? S$1(t3, o2) : null, h2 = v$1(t3, s2.fill, a2, l2);
    h2 && i2.push(h2);
  }
  return n$4("mask", { id: e2, maskUnits: "userSpaceOnUse" }, n$4("g", null, i2));
}
function G$1(t2, e2, i2) {
  return i$3(t2, n$7(t2), [e2, i2]);
}
function I$1(t2, e2, i2, n2, r2) {
  return c$3(t2, n$7(t2), [e2, i2]), t2[4] = t2[4] * e2 - n2 * e2 + n2, t2[5] = t2[5] * i2 - r2 * i2 + r2, t2;
}
function z(t2, e2, i2, n2) {
  const r2 = e2 % 360 * Math.PI / 180;
  e$3(t2, n$7(t2), r2);
  const s2 = Math.cos(r2), l2 = Math.sin(r2), h2 = t2[4], f2 = t2[5];
  return t2[4] = h2 * s2 - f2 * l2 + n2 * l2 - i2 * s2 + i2, t2[5] = f2 * s2 + h2 * l2 - i2 * l2 - n2 * s2 + n2, t2;
}
function B$1(t2, e2) {
  g$2 && "left" in g$2 ? (null != g$2.left && g$2.left > t2 && (g$2.left = t2), (null == g$2.right || g$2.right < t2) && (g$2.right = t2), (null == g$2.top || g$2.top > e2) && (g$2.top = e2), (null == g$2.bottom || g$2.bottom < e2) && (g$2.bottom = e2)) : g$2 = { left: t2, bottom: e2, right: t2, top: e2 };
}
function U$1(t2) {
  ...
  switch (t2.action) {
    ...
    case "m": {
      let t3 = 0;
      "x" in m$2 || (B$1(m$2.x = e2[0], m$2.y = e2[1]), t3 = 2);
      for (n2 = t3; n2 < i2; n2 += 2)
        B$1(m$2.x += e2[n2], m$2.y += e2[n2 + 1]);
      break;
    }
    case "l":
    case "t":
    ...
    case "h":
      for (n2 = 0; n2 < i2; ++n2)
        B$1(m$2.x += e2[n2], m$2.y);
      break;
    case "v":
      for (n2 = 0; n2 < i2; ++n2)
        B$1(m$2.x, m$2.y += e2[n2]);
      break;
    case "c":
      for (n2 = 0; n2 < i2; n2 += 6)
        B$1(m$2.x + e2[n2], m$2.y + e2[n2 + 1]), B$1(m$2.x + e2[n2 + 2], m$2.y + e2[n2 + 3]), B$1(m$2.x += e2[n2 + 4], m$2.y += e2[n2 + 5]);
      break;
    case "s":
    case "q":
      for (n2 = 0; n2 < i2; n2 += 4)
        B$1(m$2.x + e2[n2], m$2.y + e2[n2 + 1]), B$1(m$2.x += e2[n2 + 2], m$2.y += e2[n2 + 3]);
      break;
    case "A":
      for (n2 = 0; n2 < i2; n2 += 7)
        B$1(e2[n2 + 5], e2[n2 + 6]);
    ...
    case "a":
      for (n2 = 0; n2 < i2; n2 += 7)
        B$1(m$2.x += e2[n2 + 5], m$2.y += e2[n2 + 6]);
  }
}
function F$1(t2, e2, i2) {
  const n2 = y$1[t2.toLowerCase()];
  let r2;
  "number" == typeof n2 && (n2 ? e2.length >= n2 && (r2 = { action: t2, args: e2.slice(0, e2.length - e2.length % n2) }, i2.push(r2), U$1(r2)) : (r2 = { action: t2, args: [] }, i2.push(r2), U$1(r2)));
}
function O$1(t2) {
  const e2 = ("string" != typeof t2.path ? j(t2.path) : t2.path).match(p), i2 = [];
  if (g$2 = {}, m$2 = {}, !e2)
    return null;
  let n2 = "", r2 = [];
  const o2 = e2.length;
  for (let a2 = 0; a2 < o2; ++a2) {
    ...
    isNaN(o3) ? (n2 && F$1(n2, r2, i2), r2 = [], n2 = t3) : r2.push(o3);
  }
  F$1(n2, r2, i2);
  const s2 = { x: 0, y: 0, width: 0, height: 0 };
  return g$2 && "left" in g$2 && (s2.x = g$2.left, s2.y = g$2.top, s2.width = g$2.right - g$2.left, s2.height = g$2.bottom - g$2.top), s2;
}
function T$1(t2) {
...
function E$1(t2) {
  const e2 = { x: 0, y: 0, width: 0, height: 0 };
  let i2 = null, n2 = Number.NEGATIVE_INFINITY, r2 = Number.NEGATIVE_INFINITY;
  for (const o2 of t2)
    i2 ? (i2.x = Math.min(i2.x, o2.x), i2.y = Math.min(i2.y, o2.y), n2 = Math.max(n2, o2.x + o2.width), r2 = Math.max(r2, o2.y + o2.height)) : (i2 = e2, i2.x = o2.x, i2.y = o2.y, n2 = o2.x + o2.width, r2 = o2.y + o2.height);
  return i2 && (i2.width = n2 - i2.x, i2.height = r2 - i2.y), i2;
}
function V$2(t2, e2, r2, o2, s2, a2, l2, h2, f2) {
  let c2 = (l2 && a2 ? b$1(a2, e2) : e2) / 2, d2 = (l2 && a2 ? b$1(a2, r2) : r2) / 2;
  if (f2) {
    const t3 = f2[0], e3 = f2[1];
    c2 = (l2 && a2 ? b$1(a2, t3) : t3) / 2, d2 = (l2 && a2 ? b$1(a2, e3) : e3) / 2;
  }
  const u2 = t2.width + o2, y2 = t2.height + o2, p2 = n$6(), g2 = n$6();
  let m2 = false;
  if (s2 && 0 !== u2 && 0 !== y2) {
    const t3 = e2 !== r2 ? e2 / r2 : u2 / y2, i2 = e2 > r2 ? e2 : r2;
    let o3 = 1, s3 = 1;
    isNaN(i2) || (t3 > 1 ? (o3 = i2 / u2, s3 = i2 / t3 / y2) : (s3 = i2 / y2, o3 = i2 * t3 / u2)), o$4(g2, g2, I$1(p2, o3, s3, c2, d2)), m2 = true;
  }
  const x2 = t2.x + (u2 - o2) / 2, w2 = t2.y + (y2 - o2) / 2;
  if (o$4(g2, g2, G$1(p2, c2 - x2, d2 - w2)), !m2 && (u2 > e2 || y2 > r2)) {
    const t3 = u2 / e2 > y2 / r2, i2 = (t3 ? e2 : r2) / (t3 ? u2 : y2);
    o$4(g2, g2, I$1(p2, i2, i2, x2, w2));
  }
  return a2 && o$4(g2, g2, z(p2, a2, x2, w2)), h2 && o$4(g2, g2, G$1(p2, h2[0], h2[1])), `matrix(${g2[0]},${g2[1]},${g2[2]},${g2[3]},${g2[4]},${g2[5]})`;
}
function C$1(t2, e2, i2) {
  const n2 = t2?.effects.find((t3) => "bloom" === t3.type);
  if (!n2)
    return null;
  const { strength: r2, radius: o2 } = n2, s2 = r2 > 0 ? o2 : 0, a2 = (r2 + s2) * e2, h2 = 4 * r2 + 1;
  return n$4("filter", { filterUnits: "userSpaceOnUse", height: "300%", id: `bloom${i2}`, width: "300%", x: "-100%", y: "-100%" }, n$4("feMorphology", { in: "SourceGraphic", operator: "dilate", radius: (r2 + 0.5 * s2) * (5 ** (e2 / 100) * (0.4 + e2 / 100)), result: "dilate" }), n$4("feGaussianBlur", { in: "dilate", result: "blur", stdDeviation: a2 / 25 }), n$4("feGaussianBlur", { in: "blur", result: "intensityBlur", stdDeviation: a2 / 50 }), n$4("feComponentTransfer", { in: "SourceGraphic", result: "intensityBrightness" }, n$4("feFuncR", { slope: h2, type: "linear" }), n$4("feFuncG", { slope: h2, type: "linear" }), n$4("feFuncB", { slope: h2, type: "linear" })), n$4("feMerge", null, n$4("feMergeNode", { in: "intensityBlur" }), n$4("feMergeNode", { in: "intensityBrightness" }), n$4("feGaussianBlur", { stdDeviation: r2 / 10 })));
}
function D$1(t2, i2, n2, r2 = {}) {
  const o2 = [], s2 = [], a2 = ++k, f2 = C$1(r2.effectView, i2, a2);
  let c2 = null;
  if (f2) {
    const t3 = r2.effectView?.effects.find((t4) => "bloom" === t4.type), e2 = (t3.strength ? t3.strength + t3.radius / 2 : 0) / 3, o3 = i2 + i2 * e2, s3 = n2 + n2 * e2;
    c2 = [Math.max(o3, 10), Math.max(s3, 10)];
  }
  for (let e2 = 0; e2 < t2.length; e2++) {
    const a3 = t2[e2], h2 = [], f3 = [];
    let d3 = 0, u2 = 0, y2 = 0;
    for (const t3 of a3) {
      const { shape: e3, fill: i3, stroke: n3, font: s3, offset: a4 } = t3;
      r2.ignoreStrokeWidth || "text" === e3.type || (d3 += n3?.width || 0);
      const l2 = M(i3), c3 = A$1(n3), p3 = "text" === e3.type ? S$1(e3, s3) : null;
      o2.push($$1(l2)), h2.push(v$1(e3, l2.fill, c3, p3)), f3.push(T$1(e3)), a4 && (u2 += a4[0], y2 += a4[1]);
    }
    const p2 = V$2(E$1(f3), i2, n2, d3, r2.scale ?? false, r2.rotation, r2.useRotationSize ?? false, [u2, y2], c2);
    let g2 = null;
    if (r2.masking) {
      const t3 = `mask-${e2}`, i3 = r2.masking[e2];
      o2.push(N$1(i3, t3)), g2 = `url(#${t3})`;
    }
    s2.push(g2 ? n$4("g", { mask: g2 }, n$4("g", { transform: p2 }, h2)) : n$4("g", { transform: p2 }, h2));
  }
  r2.useRotationSize && r2.rotation && (i2 = b$1(r2.rotation, i2), n2 = b$1(r2.rotation, n2)), f2 && (n$5(c2), i2 = c2[0], n2 = c2[1]);
  const d2 = "display: block;";
  return n$4("svg", { "aria-labelledby": r2.ariaLabel, focusable: false, height: n2, role: "img", style: d2, width: i2, xmlns: h$1 }, f2, n$4("defs", null, o2), f2 ? n$4("g", { filter: `url(#bloom${a2})` }, s2) : s2);
}
const s = i$4();
function h(t2, e2) {
...
function l(t2, e2, i2) {
  ...
  return h(o2, () => D$1(t2, r2, n2, i2)), o2;
}
function m$1(t2, e2) {
...
function g$1(t2, i2, r2) {
  return t2 ? j$1(t2, { responseType: "image" }).then((t3) => {
  ...
  }) : Promise.reject(new s$7("renderUtils: imageDataSize", "href not provided."));
}
function u(t2, e2) {
...
const P = t.size, D = t.maxSize, U = t.maxOutlineSize, O = t.lineWidth, C = t.tallSymbolWidth;
function R(e2) {
  ...
  const s2 = u$7(t2.size) || 0;
  return { color: "rgba(" + (null != t2.color ? t2.color.toRgba() : "255,255,255,1") + ")", width: Math.min(s2, U), style: "pattern" in t2 && null != t2.pattern && "style" === t2.pattern.type ? d$4(t2.pattern.style) : null, join: "butt", cap: "patternCap" in t2 ? t2.patternCap : "butt" };
}
async function E(t2, l2) {
  ...
  const a2 = a$3("esri/images/Legend/legend3dsymboldefault.png");
...
async function H(t2, l2) {
  ...
  if ("none" === a2)
    return null;
  return { type: "pattern", x: 0, y: 0, src: await h$4(a$3(`esri/symbols/patterns/${a2}.png`), l2.toCss(true)), width: 5, height: 5 };
}
function N(e2) {
...
function T(e2, t2) {
  ...
  if (!l2)
    return null;
  let a2 = "rgba(";
  return a2 += h$2(l2.r, t2) + ",", a2 += h$2(l2.g, t2) + ",", a2 += h$2(l2.b, t2) + ",", a2 + l2.a + ");";
}
function W(e2, t2) {
  const l2 = T(e2, t2);
  if (!l2)
  ...
  if ("pattern" in e2 && null != e2.pattern && "style" === e2.pattern.type && "none" === e2.pattern.style)
    return null;
  return { color: l2, width: Math.min(e2.size ? u$7(e2.size) : 0.75, U), style: "pattern" in e2 && null != e2.pattern && "style" === e2.pattern.type ? d$4(e2.pattern.style) : null, cap: "cap" in e2 ? e2.cap : null, join: "join" in e2 ? "miter" === e2.join ? u$7(2) : e2.join : null };
}
function F(e2, t2, l2) {
...
function A(e2, t2, l2) {
  ...
  switch (e2.type) {
    case "icon": {
      ...
      switch (e2.resource && e2.resource.primitive || j$2) {
        case "circle":
    ...
    case "object":
      switch (e2.resource && e2.resource.primitive || d$5) {
        case "cone": {
          const s2 = F(q(e2, 0), q(e2, -0.6), l2 ? C : t2), n2 = l$1(t2, l2);
        ...
        case "cylinder": {
          const s2 = F(q(e2, 0), q(e2, -0.6), l2 ? C : t2), n$12 = n(t2, l2);
...
function B(e2) {
  ...
  return t2 ? u$7(t2) : null;
}
function G(e2) {
  return "icon" === e2.type ? "multiply" : "tint";
}
async function J(e2, t2) {
  const l$12 = B(t2), a2 = t2?.maxSize ? u$7(t2.maxSize) : null, r2 = t2?.disableUpsampling ?? false, o2 = e2.symbolLayers, i2 = [];
  let c2 = 0, p2 = 0;
  const u2 = o2.at(-1);
  let h2;
  u2 && "icon" === u2.type && (h2 = u2.size && u$7(u2.size)), o2.forEach((s2) => {
    if ("icon" !== s2.type && "object" !== s2.type)
      return;
    const o3 = "icon" === s2.type ? s2.size && u$7(s2.size) : 0, u3 = l$12 || o3 ? Math.ceil(Math.min(l$12 || o3, a2 || D)) : P;
    if (s2?.resource?.href) {
      ...
      c2 = Math.max(c2, a3 ? C : e3), p2 = Math.max(p2, e3), i2.push(Promise.resolve(A(s2, e3, a3)));
    }
  });
  const m2 = await Promise.allSettled(i2), f2 = [];
  return m2.forEach((e3) => {
    "fulfilled" === e3.status ? f2.push(e3.value) : e3.reason && s$5.getLogger("esri.symbols.support.previewSymbol3D").warn("error while building swatchInfo!", e3.reason);
  }), l(f2, [c2, p2], { node: t2?.node, scale: false, opacity: t2?.opacity, ariaLabel: t2?.ariaLabel });
}
function K(e$12, t2) {
  const l$12 = e$12.symbolLayers, a2 = [], s2 = y$3(e$12), r2 = B(t2), o2 = (t2?.maxSize ? u$7(t2.maxSize) : null) || U;
  let i2, c2 = 0, p2 = 0;
...
async function Q(e$12, t2) {
  const l$12 = "mesh-3d" === e$12.type, a2 = e$12.symbolLayers, s2 = B(t2), r2 = t2?.maxSize ? u$7(t2.maxSize) : null, o2 = s2 || P, i2 = [];
...
function V$1(e2, t2) {
  if (0 === e2.symbolLayers.length)
    return Promise.reject(new s$7("symbolPreview: renderPreviewHTML3D", "No symbolLayers in the symbol."));
  switch (e2.type) {
    case "point-3d":
      return J(e2, t2);
    case "line-3d":
  ...
  return Promise.reject(new s$7("symbolPreview: swatchInfo3D", "symbol not supported."));
}
...
function b(e2, t$12, i2) {
  const { backgroundColor: r2, outline: a2, dotSize: s2 } = e2, n2 = i2?.swatchSize || t.size, o2 = 0.8, c2 = Math.round(n2 * n2 / s2 ** 2 * o2), u2 = window.devicePixelRatio, f2 = document.createElement("canvas"), p2 = n2 * u2;
  f2.width = p2, f2.height = p2, f2.style.width = f2.width / u2 + "px", f2.style.height = f2.height / u2 + "px";
  const h2 = f2.getContext("2d");
  if (r2 && (h2.fillStyle = r2.toCss(true), h2.fillRect(0, 0, p2, p2), h2.fill()), h2.fillStyle = t$12?.toCss(true) ?? "", y && y.length / 2 === c2)
    for (let l2 = 0; l2 < 2 * c2; l2 += 2) {
      const e3 = y[l2], t2 = y[l2 + 1];
      h2.fillRect(e3, t2, s2 * u2, s2 * u2), h2.fill();
    }
  else {
    y = [];
    for (let e3 = 0; e3 < 2 * c2; e3 += 2) {
      const e4 = m(0, p2), t2 = m(0, p2);
      y.push(e4, t2), h2.fillRect(e4, t2, s2 * u2, s2 * u2), h2.fill();
    }
  }
  a2 && (a2.color && (h2.strokeStyle = a2.color.toCss(true)), h2.lineWidth = a2.width, h2.strokeRect(0, 0, p2, p2));
  const d2 = new Image(n2, n2);
  return d2.src = f2.toDataURL(), d2.ariaLabel = i2?.ariaLabel ?? null, d2.alt = i2?.ariaLabel ?? "", d2;
}
function g(e2, l$12 = {}) {
  const r2 = l$12.radius || 40, a2 = 2 * Math.PI * r2, s2 = e2.length, n2 = a2 / s2, o2 = [], c2 = y$4(l$12.outline);
  null != c2?.width && (c2.width *= 2), (c2 || l$12.backgroundColor) && o2.push({ shape: { type: "circle", cx: r2, cy: r2, r: r2 }, fill: l$12.backgroundColor, stroke: c2, offset: [0, 0] });
  const u2 = l$12.values, f2 = u2 && u2.length === s2 && 100 === u2.reduce((e3, t2) => e3 + t2, 0), p2 = [0];
  for (let t2 = 0; t2 < s2; t2++) {
    let l2 = null;
    f2 && (l2 = u2[t2] * a2 / 100, p2.push(l2 + p2[t2])), o2.push({ shape: { type: "circle", cx: r2, cy: r2, r: r2 / 2 }, fill: [0, 0, 0, 0], stroke: { width: r2, dashArray: `${(l2 ?? n2) / 2} ${a2}`, dashoffset: "-" + (f2 ? p2[t2] / 2 : t2 * (n2 / 2)), color: e2[t2] }, offset: [0, 0] });
  }
  let h2 = null;
  const y2 = 2 * r2 + (c2?.width || 0), m2 = l$12.holePercentage;
  if (m2) {
    c2 && o2.push({ shape: { type: "circle", cx: r2, cy: r2, r: r2 * m2 }, fill: null, stroke: c2, offset: [0, 0] });
    const e3 = y2 / 2;
    h2 = [[{ shape: { type: "circle", cx: e3, cy: e3, r: e3 }, fill: d, stroke: c2 ? { ...c2, color: d } : null, offset: [0, 0] }, { shape: { type: "circle", cx: e3, cy: e3, r: r2 * m2 }, fill: [0, 0, 0], stroke: null, offset: [0, 0] }]];
  }
  return l([o2], [y2, y2], { effectView: l$12.effectList, ignoreStrokeWidth: true, masking: h2, rotation: -90, ariaLabel: l$12.ariaLabel });
}
function v(e2, t2 = {}) {
  const l2 = 24, i2 = 75, r2 = "horizontal" === t2.align, a2 = r2 ? i2 : l2, s2 = r2 ? l2 : i2, n2 = t2.width ?? a2, o2 = t2.height ?? s2, c2 = t2.gradient ?? true, u2 = window.devicePixelRatio, f2 = n2 * u2, p2 = o2 * u2, h2 = document.createElement("canvas");
  h2.width = f2, h2.height = p2, h2.ariaLabel = t2.ariaLabel ?? null, h2.style.width = `${n2}px`, h2.style.height = `${o2}px`;
  const y2 = h2.getContext("2d"), d2 = r2 ? f2 : 0, m2 = r2 ? 0 : p2;
  if (c2) {
    const t3 = y2.createLinearGradient(0, 0, d2, m2), l3 = e2.length, i3 = 1 === l3 ? 0 : 1 / (l3 - 1);
    e2.forEach((e3, l4) => t3.addColorStop(l4 * i3, e3.toString())), y2.fillStyle = t3, y2.fillRect(0, 0, f2, p2);
  } else {
    const t3 = r2 ? f2 / e2.length : f2, l3 = r2 ? p2 : p2 / e2.length;
    let i3 = 0, a3 = 0;
    for (const s3 of e2)
      y2.fillStyle = s3.toString(), y2.fillRect(i3, a3, t3, l3), i3 = r2 ? i3 + t3 : 0, a3 = r2 ? 0 : a3 + l3;
  }
...
function S(e2, t2) {
  ...
  if (l2) {
    for (const i2 of l2)
      if ("drop-shadow" === i2?.type) {
        i2.offsetX < 0 ? e2.style.marginLeft = `${Math.abs(i2.offsetX)}px` : e2.style.marginRight = `${i2.offsetX}px`;
        break;
      }
  }
}
async function V(e2, t2) {
  switch (e2.type) {
    case "web-style": {
      const { previewWebStyleSymbol: l2 } = await import("./chunk--cwIG5Fn.js");
      return l2(e2, V, t2);
    }
    case "label-3d":
    case "line-3d":
    ...
    case "picture-fill":
    case "text": {
      const { previewSymbol2D: l2 } = await import("./chunk-OvZMGmFq.js");
      return l2(e2, t2);
    }
    case "cim": {
      const { previewCIMSymbol: l2 } = await import("./chunk-1peoqOht.js");
      return l2(e2, t2);
    }
    default:
      return;
...
function x(e2) {
  return e2 && "opacity" in e2 ? e2.opacity * x(e2.parent) : 1;
}
async function L(t2, l2) {
  if (!t2)
    return;
  const i2 = t2.sourceLayer, r2 = (null != l2 && l2.useSourceLayer ? i2 : t2.layer) ?? i2, a2 = x(r2);
  if (null != t2.symbol && (null == l2 || true !== l2.ignoreGraphicSymbol)) {
    ...
    return k$1(e2, null, a2), e2;
  }
  const u2 = (null != l2 ? l2.renderer : null) ?? (r2 && "renderer" in r2 ? r2.renderer : null);
  ...
  if (f2 = "web-style" === f2.type ? await f2.fetchSymbol({ ...l2, cache: null != l2 ? l2.webStyleCache : null }) : f2.clone(), !u2 || !("visualVariables" in u2) || !u2.visualVariables?.length)
    return k$1(f2, null, a2), f2;
  if ("arcadeRequiredForVisualVariables" in u2 && u2.arcadeRequiredForVisualVariables && null == l2?.arcade) {
    const t3 = { ...l2 };
    t3.arcade = await i$5(), l2 = t3;
  }
  const { getColor: p2, getOpacity: h2, getAllSizes: y2, getRotationAngle: d2 } = await import("./chunk-KFNcxJaF.js").then((n2) => n2.D_), m2 = [], b2 = [], g2 = [], w2 = [];
  ...
  if (null != a2 && (L2 = null != L2 ? L2 * a2 : a2), k$1(f2, S2, L2), g2.length) {
    const e2 = y2(g2, t2, l2);
    await R$1(f2, e2);
  }
  for (const e2 of w2)
    D$2(f2, d2(e2, t2, l2), e2.axis);
  return f2;
}
export {
  $$1 as $,

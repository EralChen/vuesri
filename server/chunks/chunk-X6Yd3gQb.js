import { b6 as u$1, b7 as s, b8 as a$1, b9 as w, ba as r, bb as u, bc as l, bd as m, be as f$1, bf as s$1, bg as a$2, bh as s$2, bi as g$1, bj as i } from "./chunk-ejFG4zJ0.js";
function p(t) {
  return f(t, true);
}
function a(t) {
...
function f(i$1, n) {
  if (null == i$1)
    return null;
  const p2 = i$1.spatialReference, a2 = s(p2), f2 = a$1(i$1) ? i$1.toJSON() : i$1;
  if (!a2)
    return f2;
  const I2 = w(p2) ? 102100 : 4326, g2 = r[I2].maxX, v2 = r[I2].minX;
  if (u(f2))
    return y(f2, g2, v2);
  if (l(f2))

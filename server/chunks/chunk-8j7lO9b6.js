import { defineComponent, ref, resolveComponent, unref, withCtx, createTextVNode, createVNode, useSSRContext } from "vue";
        ...
        before: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_ElButton, {
              onClick: ($event) => definitionExpression.value = `Park = 'Big Bend National Park'`
            }, {
          ...
          if (_push2) {
            ...
            return [
              ...
              createVNode(unref(VaServerFeatureLayer), {
                ...
                onLoad: layerLoad,
                onClick: layerClick
              }, null, 8, ["definitionExpression", "renderer", "url"])
            ];
          }
        }),
        _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("examples/server-feature-layer/basic.vue");

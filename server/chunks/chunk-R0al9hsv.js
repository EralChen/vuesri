import { aV as e, aX as y, a_ as c$2, bZ as S$1, jT as i$2, jc as u$3, db as f$1, iJ as s$2, uw as n$4, jd as s$3, dw as We, aO as s$4 } from "./chunk-ejFG4zJ0.js";
import "luxon";
...
function i$1(e2, r) {
  return "number" == typeof e2 ? t.includes(e2) ? "feet" : "meters" : n$3(r);
}
function u$2(e2, t2) {
  return e2 && c$1.includes(e2) || 4326 === t2 ? "ellipsoidal" : "gravity-related-height";
}
let p$3 = class p extends S$1 {
  constructor() {
  ...
  get unitAndHeightInfo() {
    const { horizontalWKID: t2, verticalWKID: o2 } = this;
    let e2 = t2, r = o2;
    const p5 = this;
    if (4 === p5.type) {
      const { properties: t3 } = p5;
      e2 = 4326, r = t3.verticalWKID;
    }
    return { heightModel: u$2(r, e2), heightUnit: i$1(r, e2), horizontalUnit: n$3(e2) };
  }
};
e([y({ json: { write: true } })], p$3.prototype, "affineTransformations", void 0), e([y({ json: { write: true } })], p$3.prototype, "focalLength", void 0), e([y({ json: { write: true } })], p$3.prototype, "principalOffsetPoint", void 0), e([y({ json: { write: true } })], p$3.prototype, "radialDistortionCoefficients", void 0), e([y({ json: { write: true } })], p$3.prototype, "tangentialDistortionCoefficients", void 0), e([y({ json: { write: true } })], p$3.prototype, "horizontalWKID", void 0), e([y({ json: { write: true } })], p$3.prototype, "verticalWKID", void 0), e([y({ json: { write: true } })], p$3.prototype, "x", void 0), e([y({ json: { write: true } })], p$3.prototype, "y", void 0), e([y({ json: { write: true } })], p$3.prototype, "z", void 0), e([y({ json: { write: true } })], p$3.prototype, "type", void 0), e([y({ readOnly: true })], p$3.prototype, "unitAndHeightInfo", null), p$3 = e([c$2("esri.layers.orientedImagery.core.CameraOrientation")], p$3);
const a$1 = p$3;
let s$1 = class s extends i$2(u$3(a$1)) {
  constructor() {
    super(...arguments), this.type = 1;
  }
  toString() {
    const { type: o2, horizontalWKID: t2, verticalWKID: r, x: e2, y: i2, z: p5, heading: s3, pitch: n2, roll: a2, affineTransformations: c2, focalLength: m2, principalOffsetPoint: y2, radialDistortionCoefficients: f2, tangentialDistortionCoefficients: u2 } = this, d2 = [o2, t2, r, e2, i2, p5, s3, n2, a2];
    return this.isAdvanced && (c2?.forEach((o3) => d2.push(o3)), d2.push(m2), y2?.forEach((o3) => d2.push(o3)), f2?.forEach((o3) => d2.push(o3)), u2?.forEach((o3) => d2.push(o3))), d2.map((o3) => Number.isNaN(o3) ? "" : o3).join("|");
  }
};
e([y({ json: { write: true } })], s$1.prototype, "type", void 0), e([y({ type: [Number], json: { write: true } })], s$1.prototype, "affineTransformations", void 0), e([y({ type: Number, json: { write: true } })], s$1.prototype, "focalLength", void 0), e([y({ type: [Number], json: { write: true } })], s$1.prototype, "principalOffsetPoint", void 0), e([y({ type: [Number], json: { write: true } })], s$1.prototype, "radialDistortionCoefficients", void 0), e([y({ type: [Number], json: { write: true } })], s$1.prototype, "tangentialDistortionCoefficients", void 0), e([y({ type: Number, json: { write: true } })], s$1.prototype, "heading", void 0), e([y({ type: Number, json: { write: true } })], s$1.prototype, "pitch", void 0), e([y({ type: Number, json: { write: true } })], s$1.prototype, "roll", void 0), e([y({ type: Number, json: { write: true } })], s$1.prototype, "horizontalWKID", void 0), e([y({ type: Number, json: { write: true } })], s$1.prototype, "verticalWKID", void 0), e([y({ type: Number, json: { write: true } })], s$1.prototype, "x", void 0), e([y({ type: Number, json: { write: true } })], s$1.prototype, "y", void 0), e([y({ type: Number, json: { write: true } })], s$1.prototype, "z", void 0), s$1 = e([c$2("esri.layers.orientedImagery.core.CameraOrientationHPR")], s$1);
const n$2 = s$1;
let s2 = class extends i$2(u$3(a$1)) {
  constructor() {
    super(...arguments), this.type = 2, this.verticalWKID = null;
  }
  toString() {
    const { type: o2, horizontalWKID: t2, verticalWKID: r, x: e2, y: i2, z: p5, omega: s3, phi: n2, kappa: a2, affineTransformations: c2, focalLength: m2, principalOffsetPoint: y2, radialDistortionCoefficients: f2, tangentialDistortionCoefficients: u2 } = this, d2 = [o2, t2, r, e2, i2, p5, s3, n2, a2];
    return this.isAdvanced && (c2?.forEach((o3) => d2.push(o3)), d2.push(m2), y2?.forEach((o3) => d2.push(o3)), f2?.forEach((o3) => d2.push(o3)), u2?.forEach((o3) => d2.push(o3))), d2.map((o3) => isNaN(o3) ? "" : o3).join("|");
  }
};
e([y({ json: { write: true } })], s2.prototype, "type", void 0), e([y({ type: [Number], json: { write: true } })], s2.prototype, "affineTransformations", void 0), e([y({ type: Number, json: { write: true } })], s2.prototype, "focalLength", void 0), e([y({ type: [Number], json: { write: true } })], s2.prototype, "principalOffsetPoint", void 0), e([y({ type: [Number], json: { write: true } })], s2.prototype, "radialDistortionCoefficients", void 0), e([y({ type: [Number], json: { write: true } })], s2.prototype, "tangentialDistortionCoefficients", void 0), e([y({ type: Number, json: { write: true } })], s2.prototype, "omega", void 0), e([y({ type: Number, json: { write: true } })], s2.prototype, "phi", void 0), e([y({ type: Number, json: { write: true } })], s2.prototype, "kappa", void 0), e([y({ type: Number, json: { write: true } })], s2.prototype, "horizontalWKID", void 0), e([y({ type: Number, json: { write: true } })], s2.prototype, "verticalWKID", void 0), e([y({ type: Number, json: { write: true } })], s2.prototype, "x", void 0), e([y({ type: Number, json: { write: true } })], s2.prototype, "y", void 0), e([y({ type: Number, json: { write: true } })], s2.prototype, "z", void 0), s2 = e([c$2("esri.layers.orientedImagery.core.CameraOrientationOPK")], s2);
const n$1 = s2;
let p$2 = class p2 extends i$2(u$3(a$1)) {
  constructor() {
  ...
  toString() {
    const { type: o2, horizontalWKID: t2, verticalWKID: e2, x: r, y: i2, z: s3, yaw: p5, pitch: n2, roll: a2, affineTransformations: c2, focalLength: f2, principalOffsetPoint: m2, radialDistortionCoefficients: y2, tangentialDistortionCoefficients: l2 } = this, u2 = [o2, t2, e2, r, i2, s3, p5, n2, a2];
    return this.isAdvanced && (c2?.forEach((o3) => u2.push(o3)), u2.push(f2), m2?.forEach((o3) => u2.push(o3)), m2?.forEach((o3) => u2.push(o3)), y2?.forEach((o3) => u2.push(o3)), l2?.forEach((o3) => u2.push(o3))), u2.map((o3) => Number.isNaN(o3) ? "" : o3).join("|");
  }
};
...
const n = p$2;
let i = class extends f$1 {
  constructor() {
    super(...arguments), this.url = null;
  }
};
e([y({ type: Number, json: { write: true } })], i.prototype, "lod", void 0), e([y({ type: String, json: { write: true } })], i.prototype, "rasterFunction", void 0), e([y({ type: String, json: { write: true } })], i.prototype, "url", void 0), i = e([c$2("esri.layers.orientedImagery.core.ElevationSourceDefinitions.ElevationSource")], i);
let p$1 = class p3 extends f$1 {
  constructor() {
...
const a = (o2) => null != o2 && "constantElevation" in o2 && "number" == typeof o2.constantElevation;
var P$1;
!function(P2) {
  P2[P2.HPR = 1] = "HPR", P2[P2.OPK = 2] = "OPK", P2[P2.YPR = 3] = "YPR", P2[P2.LTP = 4] = "LTP";
}(P$1 || (P$1 = {}));
function u$1(t2, n2, e2) {
  return n2 && (t2 = `${n2}${t2}`), e2 && (t2 += `${e2}`), t2;
}
function f(t2, n2, e2) {
  let { url: i$12 } = t2;
  return i$12 ? (i$12 = u$1(i$12, n2, e2), new i({ ...t2, url: i$12 })) : null;
}
function c(t2, n2, e2) {
  return t2 ? a(t2) ? new p$1(t2) : f(t2, n2, e2) : t2;
}
const m$1 = new s$2({ Minutes: "minutes", Hours: "hours", Days: "days", Weeks: "weeks", Months: "months", Years: "years" }), p4 = new s$2({ 360: "360", Horizontal: "horizontal", Inspection: "inspection", Nadir: "nadir", Oblique: "oblique", "": null }), g = /* @__PURE__ */ new Map();
g.set(`${P$1.OPK}`, { desc: "Using Omega Phi Kappa", constructor: n$1 }), g.set(`${P$1.HPR}`, { desc: "Using Heading, Pitch and Roll", constructor: n$2 }), g.set(`${P$1.YPR}`, { desc: "Using Yaw, Pitch and Roll", constructor: n });
const h = /* @__PURE__ */ new Map();
function d(t2) {
  const [n2, e2, i2, r, o2, l2, s3, u2, f2, c2, m2, p5, g2, h2, d2, P2, D2, O2, w, $, b, C] = t2.slice(1), K = [f2, c2, m2, p5, g2, h2].map((t3) => Number(t3)), y2 = [P2, D2].map((t3) => Number(t3)), N = [O2, w, $].map((t3) => Number(t3)), R = [b, C].map((t3) => Number(t3));
  return { horizontalWKID: n2, verticalWKID: e2, x: i2, y: r, z: o2, omega: l2, phi: s3, kappa: u2, affineTransformations: 6 === K.filter(n$4).length ? K : null, focalLength: d2, principalOffsetPoint: 2 !== y2.filter(n$4).length ? null : y2, radialDistortionCoefficients: 3 !== N.filter(n$4).length ? [0, 0, 0] : N, tangentialDistortionCoefficients: 2 !== R.filter(n$4).length ? [0, 0] : R };
}
function P(t2) {
  const [n2, e2, i2, r, o2, l2, s3, u2, f2, c2, m2, p5, g2, h2, d2, P2, D2, O2, w, $, b, C] = t2.slice(1), K = [f2, c2, m2, p5, g2, h2].map((t3) => Number(t3)), y2 = [P2, D2].map((t3) => Number(t3)), N = [O2, w, $], R = [b, C];
  return { horizontalWKID: n2, verticalWKID: e2, x: i2, y: r, z: o2, heading: l2, pitch: s3, roll: u2, affineTransformations: 6 === K.filter(n$4).length ? K : null, focalLength: d2, principalOffsetPoint: 2 !== y2.filter(n$4).length ? null : y2, radialDistortionCoefficients: 3 !== N.filter(n$4).length ? null : N, tangentialDistortionCoefficients: 2 !== R.filter(n$4).length ? null : R };
}
function D(t2) {
  const [n2, e2, i2, r, o2, l2, s3, u2, f2, c2, m2, p5, g2, h2, d2, P2, D2, O2, w, $, b, C] = t2.slice(1), K = [f2, c2, m2, p5, g2, h2].map((t3) => Number(t3)), y2 = [P2, D2].map((t3) => Number(t3)), N = [O2, w, $], R = [b, C];
  return { horizontalWKID: n2, verticalWKID: e2, x: i2, y: r, z: o2, yaw: l2, pitch: s3, roll: u2, affineTransformations: 6 === K.filter(n$4).length ? K : null, focalLength: d2, principalOffsetPoint: 2 !== y2.filter(n$4).length ? null : y2, radialDistortionCoefficients: 3 !== N.filter(n$4).length ? null : N, tangentialDistortionCoefficients: 2 !== R.filter(n$4).length ? null : R };
}
function O(t2) {
  const [n2, e2, i2, r, o2, ...l2] = t2.slice(1), s3 = h.get(o2);
  if (!s3)
    return null;
  return { latitude: n2, longitude: e2, ellipsoidRadius: i2, squaredEccentricity: r, properties: s3([o2, "", ...l2]) };
}
h.set(`${P$1.HPR}`, P), h.set(`${P$1.YPR}`, D), h.set(`${P$1.OPK}`, d), h.set(`${P$1.LTP}`, O);
function l(e2, t2, r) {
...
let m = class extends We {
  ...
  _verifySource() {
    if (super._verifySource(), "point" !== this.geometryType)
      throw new s$4("oriented-imagery-layer:invalid-geometry-type", "OrientedImageryLayer only supports point geometry type");
  }
};
...
}) }), s$3((e2) => e2 ? e2.trim().split(",").map(Number) : null)], m.prototype, "orientationAccuracy", void 0), e([y({ json: { ...l("orientedImageryType", p4.write, p4.read), type: p4.apiValues } })], m.prototype, "orientedImageryType", void 0), e([y({ json: { read: false }, value: "oriented-imagery", readOnly: true })], m.prototype, "type", void 0), e([y({ json: { ...l("timeIntervalUnit", m$1.write, m$1.read), type: m$1.apiValues } })], m.prototype, "timeIntervalUnit", void 0), e([y({ type: Number, json: l("verticalFieldOfView") })], m.prototype, "verticalFieldOfView", void 0), e([y({ json: { ...l("verticalMeasurementUnit"), type: new s$2({ Feet: "feet", Meter: "meter" }).apiValues } })], m.prototype, "verticalMeasurementUnit", void 0), e([y({ type: String, json: l("videoPathPrefix") })], m.prototype, "videoPathPrefix", void 0), e([y({ type: String, json: l("videoPathSuffix") })], m.prototype, "videoPathSuffix", void 0), m = e([c$2("esri.layers.OrientedImageryLayer")], m);
const u = m;
export {
  u as default
};

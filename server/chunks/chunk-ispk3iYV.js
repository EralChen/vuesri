import { fM as t, a_ as I, be as R, fJ as t$1, a$ as j, fN as V, fO as v, fP as T$1 } from "./chunk-KFNcxJaF.js";
const u = "Layer does not support extent calculation.";
function y(t2, e) {
  const r = t2.geometry, o = t2.toJSON(), s = o;
  if (null != r && (s.geometry = JSON.stringify(r), s.geometryType = v(r), s.inSR = T$1(r.spatialReference)), o.topFilter?.groupByFields && (s.topFilter.groupByFields = o.topFilter.groupByFields.join(",")), o.topFilter?.orderByFields && (s.topFilter.orderByFields = o.topFilter.orderByFields.join(",")), o.topFilter && (s.topFilter = JSON.stringify(s.topFilter)), o.objectIds && (s.objectIds = o.objectIds.join(",")), o.orderByFields && (s.orderByFields = o.orderByFields.join(",")), o.outFields && !(e?.returnCountOnly || e?.returnExtentOnly || e?.returnIdsOnly) ? o.outFields.includes("*") ? s.outFields = "*" : s.outFields = o.outFields.join(",") : delete s.outFields, o.outSR ? s.outSR = T$1(o.outSR) : r && o.returnGeometry && (s.outSR = s.inSR), o.returnGeometry && delete o.returnGeometry, o.timeExtent) {
...
function c(n, i, l, u2 = {}, p2 = {}) {
  ...
  return u2.responseType = "pbf" === l ? "array-buffer" : "json", R(d2, null, u2).then((e) => {
    ...
    return j(V(m2.path, "queryTopFeatures"), { ...u2, query: { ...o, ...u2.query } });
  });
}
export {
  a,

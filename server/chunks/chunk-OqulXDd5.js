import { gz as S, gA as m$1, gB as a$1, gC as t, aQ as U$1 } from "./chunk-ejFG4zJ0.js";
import "luxon";
...
function a(o, n) {
  ...
  for (const a2 of n) {
    ...
    for (const a3 of m2) {
      const { id: m3 } = a3, p = S(m$1(`${o.path}/${n2}/attachments/${m3}`)), i = a$1.fromJSON(a3);
...
function c(t$1, e, r) {
  ...
  return r && (a2 = { ...r, ...a2, query: { ...r.query, ...a2.query } }), U$1(t$1.path + "/queryAttachments", a2).then((t2) => t2.data.attachmentGroups);
}
async function m(t2, e, n) {
  const { objectIds: r } = e, s2 = [];
  for (const a2 of r)
    s2.push(U$1(t2.path + "/" + a2 + "/attachments", n));

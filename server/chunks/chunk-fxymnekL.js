import { bo as e$1, bp as y, br as c$1, bs as g$1, mU as r$1, mV as n$1, d1 as o, df as h$2, fy as e$2, bJ as d$1, eg as p, fz as _, mW as n$2, b8 as a$1, cL as y$1, cJ as m, bt as S$1 } from "./chunk-KFNcxJaF.js";
import { i as i$1 } from "./chunk-s_1zK5-o.js";
import { F as Fe } from "./chunk-cBUQnPnC.js";
import { S } from "./chunk-WQPcs7l9.js";
let h$1 = class h extends g$1 {
  constructor(r2) {
  ...
  remove(r2) {
    const s2 = !r2 || Array.isArray(r2) ? r2 : [r2];
    s2?.length && s2.forEach((r3) => this._unhighlight(r3));
  }
  removeAll() {
...
e$1([y()], h$1.prototype, "view", void 0), h$1 = e$1([c$1("esri.views.draw.support.HighlightHelper")], h$1);
const l = h$1;
class t {
  constructor(t2, i2, s2, h3, e2) {
    this.graphic = t2, this.index = i2, this.x = s2, this.y = h3, this.viewEvent = e2, this.type = "graphic-click";
  }
}
class i {
  constructor(t2, i2, s2, h3, e2) {
    this.graphic = t2, this.index = i2, this.x = s2, this.y = h3, this.viewEvent = e2, this.type = "graphic-double-click";
  }
}
class s {
  constructor(t2, i2, s2, h3, e2, r2, c2, a2, n2, p2) {
    this.graphic = t2, this.allGraphics = i2, this.index = s2, this.x = h3, this.y = e2, this.dx = r2, this.dy = c2, this.totalDx = a2, this.totalDy = n2, this.viewEvent = p2, this.defaultPrevented = false, this.type = "graphic-move-start";
  }
  preventDefault() {
...
class h2 {
  constructor(t2, i2, s2, h3, e2, r2, c2, a2, n2, p2) {
    this.graphic = t2, this.allGraphics = i2, this.index = s2, this.x = h3, this.y = e2, this.dx = r2, this.dy = c2, this.totalDx = a2, this.totalDy = n2, this.viewEvent = p2, this.defaultPrevented = false, this.type = "graphic-move";
  }
  preventDefault() {
    this.defaultPrevented = true;
  }
...
class e {
  constructor(t2, i2, s2, h3, e2, r2, c2, a2, n2, p2) {
    this.graphic = t2, this.allGraphics = i2, this.index = s2, this.x = h3, this.y = e2, this.dx = r2, this.dy = c2, this.totalDx = a2, this.totalDy = n2, this.viewEvent = p2, this.defaultPrevented = false, this.type = "graphic-move-stop";
  }
  preventDefault() {
    this.defaultPrevented = true;
  }
...
class r {
  constructor(t2, i2, s2, h3, e2) {
    this.graphic = t2, this.index = i2, this.x = s2, this.y = h3, this.viewEvent = e2, this.type = "graphic-pointer-over";
  }
}
class c {
  constructor(t2, i2, s2, h3, e2) {
    this.graphic = t2, this.index = i2, this.x = s2, this.y = h3, this.viewEvent = e2, this.type = "graphic-pointer-out";
  }
}
class a {
  constructor(t2, i2, s2, h3, e2) {
    this.graphic = t2, this.index = i2, this.x = s2, this.y = h3, this.viewEvent = e2, this.type = "graphic-pointer-down";
  }
}
class n {
  constructor(t2, i2, s2, h3, e2) {
    this.graphic = t2, this.index = i2, this.x = s2, this.y = h3, this.viewEvent = e2, this.type = "graphic-pointer-up";
  }
}
...
let E = class extends o.EventedAccessor {
  ...
  initialize() {
    e$2(this.view, this.layer), this._highlightHelper = new l({ view: this.view }), this.refresh(), this.addHandles([d$1(() => this.graphics.length, () => this.refresh()), p(() => this.view?.ready, () => {
  ...
  _dragHandler(i2) {
    ...
    const { action: t2, x: s$1, y: r2 } = i2, o2 = this.graphics.indexOf(this._activeGraphic), h$12 = this._dragEvent ? s$1 - this._dragEvent.x : 0, a2 = this._dragEvent ? r2 - this._dragEvent.y : 0, n2 = s$1 - i2.origin.x, l2 = r2 - i2.origin.y, p2 = "start" === t2 ? this._activeGraphic.geometry : this._initialDragGeometry, d = i$1(p2, n2, l2, this.view);
    if (this._activeGraphic.geometry = d, this.enableMoveAllGraphics && this.graphics.forEach((i3) => {
      i3 !== this._activeGraphic && (i3.geometry = i$1(i3.geometry, h$12, a2, this.view));
    }), this._dragEvent = i2, "start" === t2) {
      this._initialDragGeometry = a$1(p2);
      const t3 = new s(this._activeGraphic, this.graphics, o2, s$1, r2, h$12, a2, n2, l2, i2);
      ...
      const t3 = new h2(this._activeGraphic, this.graphics, o2, s$1, r2, h$12, a2, n2, l2, i2);
      ...
      const t3 = new e(this._activeGraphic, this.graphics, o2, s$1, r2, h$12, a2, n2, l2, i2);

...
import { r as rCrowdinFilesAsReflect, a as CrowdinFilePath } from "./chunk-vndPU1ZH.js";
...
async function createVueApp(pageContext, ssrApp = true, renderHead = false) {
  const runCbs = (hook) => {
...
const onRenderHtml = async (pageContext) => {
  ...
  const lang = getLang(pageContext) || "zh-CN";
  let pageView = "";
  let fromHtmlRenderer = void 0;
...
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="font-600 plr-l ptb-s text-primary"><a${ssrRenderAttr("href", unref(base))}>@vuesri/core</a></div>`);
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const basePath = "/vuesri/" + componentCrow.lang + "/component";

import { cN as c$1, cO as o$1 } from "./chunk-ejFG4zJ0.js";
...
function i(e, t, n2) {
  ...
  let a2 = c.indexOf("0");
  -1 !== a2 && (a2 = c.length - a2, a2 > o2[0].length && (o2[0] = o2[0].padStart(a2, "0")), c.includes("#") || (o2[0] = o2[0].substr(o2[0].length - a2)));
...
function a(t) {
  ...
  const p2 = g(a2, (n3) => (n3 = "(?:" + o$1(n3, ".") + ")").replace(l, (e) => {
    ...
    let s3 = t.places;
    1 === r2.length && 1 !== c && (r2[1] = "###"), 1 === r2.length || 0 === s3 ? n4.fractional = false : (void 0 === s3 && (s3 = t.pattern ? r2[1].lastIndexOf("0") + 1 : 1 / 0), s3 && null == t.fractional && (n4.fractional = true), !t.places && +s3 < r2[1].length && (s3 += "," + r2[1].length), n4.places = s3);
    const l2 = r2[0].split(",");
    return l2.length > 1 && (n4.groupSize = l2.pop().length, l2.length > 1 && (n4.groupSize2 = l2.pop().length)), "(" + u(n4) + ")";
  }), true);
  return { regexp: p2.replaceAll(/[\xa0 ]/g, "[\\s\\xa0]"), group: o2, decimal: i2, factor: c };
}
function p(e, t) {

...
import { qh as f, mz as e, dd as _, bJ as d$1, bq as j, de as b$1, qi as K, cD as t, du as j$1, bN as b$2 } from "./chunk-KFNcxJaF.js";
...
const MaskingLayerView2D = f.createSubclass({
    ...
    this.watchHandles.add([
      ...
      d$1(() => this.layer.geometry, () => {
        ...
        projectionPromise.then(() => {
          layerView.projectedGeometry = b$1(
            layer.geometry,
  ...
  manageTileImages() {
    ...
    this.tileContexts.forEach((_2, id) => {
      if (!tileIdSet.has(id)) {
...
const MaskingLayer = t(b$2).createSubclass({
  properties: {
    color: {},
    geometry: {},
    distance: {},

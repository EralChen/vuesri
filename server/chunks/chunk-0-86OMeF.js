import { aN as o$1, b1 as s$1, gR as n$1 } from "./chunk-KFNcxJaF.js";
import "@popperjs/core";
import "luxon";
import "@esri/arcgis-html-sanitizer";
import "@esri/calcite-components/dist/components/index.js";
var i, s, a = { exports: {} };
a.exports, i = a, a.exports, s = function() {
  return function(e) {
    var t = {};
    function r(n) {
      if (t[n])
    ...
    Object.defineProperty(t, "__esModule", { value: true }), t.isNotPNG = u2, t.isNotAPNG = h2, t.default = c2;
    var n = s2(r(1)), i2 = r(2);
    function s2(e2) {
    ...
    function c2(e2) {
      ...
      if (p(t2, function(e3) {
        ...
        return o2;
      var n2 = [], s3 = [], u3 = null, h3 = null, c3 = 0, f2 = new i2.APNG();
      if (p(t2, function(e3, t3, r3, a3) {
        var o3 = new DataView(t3.buffer);
        switch (e3) {
          case "IHDR":
            u3 = t3.subarray(r3 + 8, r3 + 8 + a3), f2.width = o3.getUint32(r3 + 8), f2.height = o3.getUint32(r3 + 12);
            break;
          case "acTL":
            f2.numPlays = o3.getUint32(r3 + 8 + 4);
            break;
          case "fcTL":
            h3 && (f2.frames.push(h3), c3++), (h3 = new i2.Frame()).width = o3.getUint32(r3 + 8 + 4), h3.height = o3.getUint32(r3 + 8 + 8), h3.left = o3.getUint32(r3 + 8 + 12), h3.top = o3.getUint32(r3 + 8 + 16);
            var l3 = o3.getUint16(r3 + 8 + 20), p2 = o3.getUint16(r3 + 8 + 22);
            0 === p2 && (p2 = 100), h3.delay = 1e3 * l3 / p2, h3.delay <= 10 && (h3.delay = 100), f2.playTime += h3.delay, h3.disposeOp = o3.getUint8(r3 + 8 + 24), h3.blendOp = o3.getUint8(r3 + 8 + 25), h3.dataParts = [], 0 === c3 && 2 === h3.disposeOp && (h3.disposeOp = 1);
            break;
          case "fdAT":
      ...
      }), h3 && f2.frames.push(h3), 0 == f2.frames.length)
        return o2;
      var m2 = new Blob(n2), g = new Blob(s3);
      return f2.frames.forEach(function(e3) {
        var t3 = [];
    ...
    function p(e2, t2) {
      ...
      do {
        s3 = r2.getUint32(n2), a3 = t2(i3 = f(e2, n2 + 4, 4), e2, n2, s3), n2 += 12 + s3;
...
const o = o$1(a.exports);
async function u(e, t) {
  const i2 = o(e);
  if (i2 instanceof Error)
    throw i2;
  await i2.createImages(), s$1(t);
  const { frames: s2, width: a2, height: u2 } = i2, h2 = document.createElement("canvas");
  h2.width = a2, h2.height = u2;
  const l2 = h2.getContext("2d", { willReadFrequently: true }), c2 = [], p = [];
  let f = 0;
  for (const r of s2) {
    ...
    const s3 = l2.getImageData(0, 0, a2, u2);
    c2.push(s3), 0 === r.disposeOp || (1 === r.disposeOp ? l2.clearRect(r.left, r.top, r.width, r.height) : 2 === r.disposeOp && l2.putImageData(i3, r.left, r.top));
  }
  return { frameCount: s2.length, duration: f, frameDurations: p, getFrame: (e2) => c2[e2], width: a2, height: u2 };
}
const h = [137, 80, 78, 71, 13, 10, 26, 10];
function l(e) {
  const t = new Uint8Array(e);
  return !h.some((e2, r) => e2 !== t[r]);
}
function c(e) {
  if (!l(e))
    return false;

import { defineComponent, ref, resolveComponent, unref, withCtx, createTextVNode, toDisplayString, createVNode, useSSRContext } from "vue";
...
import { a as levelToScale } from "./chunk-VS0cZDQt.js";
        ...
        before: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_ElButton, {
              onClick: ($event) => preVisible.value = !preVisible.value
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(preVisible.value)}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(preVisible.value), 1)
                  ];
                }
              }),
              _: 1
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(VaFeaturePopupLayer), {
                    class: "fpl-demo",
                    visible: preVisible.value && visible.value,
                    "onUpdate:visible": ($event) => visible.value = $event,
                    "max-scale": unref(levelToScale)[9],
                    "min-scale": unref(levelToScale)[1],
                    "query-extent": true
                  }, {
                  ...
                  return [
                    createVNode(unref(VaFeaturePopupLayer), {
                      ...
                      _: 1
                    }, 8, ["visible", "onUpdate:visible", "max-scale", "min-scale"])
                  ];
                }
              }),
              _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("examples/feature-popup-layer/visible.vue");

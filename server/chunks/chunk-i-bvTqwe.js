...
import { eY as i$1 } from "./chunk-KFNcxJaF.js";
...
class o {
  ...
  add(s2) {
    ...
    if (!this._trackIdToObservations.has(o2)) {
      const s3 = null != this._purgeOptions?.maxObservations ? this._purgeOptions.maxObservations : r, i3 = i$1(s3, 0, r);
  ...
  checkForUpdates() {
    ...
    (o2.length || r2?.length) && this.store.update(o2, r2);
  }
  _getToAdd() {

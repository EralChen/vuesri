...
import { V as VaZoom } from "./chunk-n-CMOZOO.js";
      ...
      _push(ssrRenderComponent(unref(VaMapView), mergeProps({ defaultOptions: {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(VaZoom), { position: "top-trailing" }, null, _parent2, _scopeId));
          } else {
            return [
              ...
              createVNode(unref(VaZoom), { position: "top-trailing" })
            ];
          }
        }),
        _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("examples/zoom/basic.vue");

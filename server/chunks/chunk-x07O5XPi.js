...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    s$1.request.interceptors?.push({
      urls: [
        "http://183.249.87.107:21000/api/kmlrms/http/oneMap/stockpilePlanQuery/1"
      ],
      before(e) {
        e.requestOptions.headers = {
          "authorization": "8B158F24E8F042E5B04623F5FFFA1365EWWP38PBKVHVPSPY"
        };
        console.log("request before", e);
      },
      after(res) {
        console.log(res, "request after");
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(VaGeojsonLayer), {
              ...
              url: "http://183.249.87.107:21000/api/kmlrms/http/oneMap/stockpilePlanQuery/1?f=json",
              onLoad: layerLoad
            }, null, _parent2, _scopeId));
          } else {
            return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("examples/geojson-layer/interceptors.vue");

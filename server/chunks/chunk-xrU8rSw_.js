import { aV as e$1, aX as y, a_ as c$3, db as f, td as o, tG as a$5, tH as a$6, tI as o$1, iJ as s$1, bD as a$7, b$ as u$2, jX as T, tJ as p$2, tK as a$8 } from "./chunk-ejFG4zJ0.js";
var s;
let i$1 = s = class extends f {
  constructor() {
...
const l$3 = p$1;
const e = { key: "type", base: a$5, typeMap: { "fixed-size": l$3, splat: a$6 } };
...
e$1([y({ type: u$1.apiValues, readOnly: true, nonNullable: true, json: { type: u$1.jsonValues, read: false, write: u$1.write } })], c$2.prototype, "type", void 0), e$1([y({ types: e, json: { write: true } })], c$2.prototype, "pointSizeAlgorithm", void 0), e$1([y({ type: l$4, json: { write: true } })], c$2.prototype, "colorModulation", void 0), e$1([y({ json: { write: true }, nonNullable: true, type: Number })], c$2.prototype, "pointsPerInch", void 0), c$2 = e$1([c$3("esri.renderers.PointCloudRenderer")], c$2), function(o2) {
...
let a$2 = n$1 = class extends a$4 {
  ...
  clone() {
    return new n$1({ ...this.cloneProperties(), field: this.field, fieldTransformType: this.fieldTransformType, colorClassBreakInfos: a$7(this.colorClassBreakInfos), legendOptions: a$7(this.legendOptions) });
  }
};
e$1([o({ pointCloudClassBreaksRenderer: "point-cloud-class-breaks" })], a$2.prototype, "type", void 0), e$1([y({ json: { write: true }, type: String })], a$2.prototype, "field", void 0), e$1([y({ type: p$2, json: { write: true } })], a$2.prototype, "legendOptions", void 0), e$1([y({ type: a$4.fieldTransformTypeKebabDict.apiValues, json: { type: a$4.fieldTransformTypeKebabDict.jsonValues, read: a$4.fieldTransformTypeKebabDict.read, write: a$4.fieldTransformTypeKebabDict.write } })], a$2.prototype, "fieldTransformType", void 0), e$1([y({ type: [c$1], json: { write: true } })], a$2.prototype, "colorClassBreakInfos", void 0), a$2 = n$1 = e$1([c$3("esri.renderers.PointCloudClassBreaksRenderer")], a$2);
const d$1 = a$2;
var l$2;

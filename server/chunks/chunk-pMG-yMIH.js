import { aM as s$1, bV as S, bW as a$1, bX as k$1 } from "./chunk-KFNcxJaF.js";
function t(r) {
...
function i(e, t2) {
  const s2 = { ...a$1, ...t2 }, u2 = e.uniqueValueInfos?.map((r) => S(r.symbol, s2).error).filter(k$1), i2 = S(e.defaultSymbol, s2);
  return i2.error && u2?.unshift(i2.error), l(e, u2);
}
function a(e) {
  const o = e.classBreakInfos.map((r) => S(r.symbol).error).filter(k$1), t2 = S(e.defaultSymbol);

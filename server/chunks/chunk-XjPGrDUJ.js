import { aV as e, aX as y, a_ as c, db as f, jD as c$1, jE as p$1, d1 as n, jG as f$1, ax as t$1, d2 as f$2, au as l, av as u$1, aw as j, ay as m, az as e$1, jT as i$1, aB as f$3, f9 as k, aO as s, aP as a, jH as p$2, jU as o, aT as s$1, jV as D, hZ as o$1, fg as r$1, jI as p$3, ck as b, jn as A, aQ as U$1, dv as y$1, jJ as g, c$ as t$2, jW as h, aC as M, jM as m$1, jK as C, jL as i$2, d4 as c$2, jX as T, jY as S, jZ as T$1, jN as y$2, dp as P, jO as m$2, jP as u, cV as o$2, bD as a$1, jQ as p$4, aZ as d, jS as s$2, a$ as b$1 } from "./chunk-ejFG4zJ0.js";
import "luxon";
import "@esri/arcgis-html-sanitizer";
import "@esri/calcite-components/dist/components/index.js";
var t;
let i = t = class extends f {
  constructor() {
...
let ee = class extends c$1(p$1(n(f$1(t$1(f$2(l(u$1(j(m(e$1(i$1(b$1)))))))))))) {
  ...
  load(e2) {
    ...
    return this.addResolvingPromise(this.loadFromPortal({ supportedTypes: ["Stream Service", "Feed"] }, e2).catch(a).then(() => this._fetchService(t2))), Promise.resolve(this);
  }
  ...
  readRenderer(e2, t2, i2) {
    ...
    const o$12 = t2.drawingInfo?.renderer;
    if (o$12) {
      const e3 = o(o$12, t2, i2) || void 0;
      return e3 || s$1.getLogger(this).error("Failed to create renderer", { rendererDefinition: t2.drawingInfo.renderer, layer: this, context: i2 }), e3;
    }
    return D(t2, i2);
  }
  async connect(e2) {
    const [{ createConnection: t2 }] = await Promise.all([import("./chunk-mXYE4zLb.js"), this.load()]), r = this.geometryType ? o$1.toJSON(this.geometryType) : null, { customParameters: i2 = null, definitionExpression: o2 = null, geometryDefinition: s2 = null, maxReconnectionAttempts: n2 = 0, maxReconnectionInterval: a2 = 20, spatialReference: l2 = this.spatialReference } = e2 || this.createConnectionParameters(), d2 = t2(this.parsedUrl, this.spatialReference, l2, r, o2, s2, n2, a2, i2 ?? void 0), m2 = r$1([this.on("send-message-to-socket", (e3) => d2.sendMessageToSocket(e3)), this.on("send-message-to-client", (e3) => d2.sendMessageToClient(e3))]);
  ...
  async _fetchService(e2) {
    if (!!!this.webSocketUrl && this.parsedUrl) {
      if (!this.sourceJSON) {
        const { data: t2 } = await U$1(this.parsedUrl.path, { query: { f: "json", ...this.customParameters, ...this.parsedUrl.query }, responseType: "json", signal: e2 });
        this.sourceJSON = t2;
      }
    } else {
    ...
    return this.read(this.sourceJSON, { origin: "service", portalItem: this.portalItem, portal: this.portalItem?.portal, url: this.parsedUrl }), p$2(this.renderer, this.fieldsIndex), g(this.timeInfo, this.fieldsIndex), this.objectIdField || (this.objectIdField = "__esri_stream_id__"), t$2(this, { origin: "service" });
  }
};
e([y({ type: String })], ee.prototype, "copyright", void 0), e([y({ readOnly: true })], ee.prototype, "defaultPopupTemplate", null), e([y({ type: String, json: { name: "layerDefinition.definitionExpression", write: { enabled: true, allowNull: true } } })], ee.prototype, "definitionExpression", void 0), e([y({ type: String })], ee.prototype, "displayField", void 0), e([y({ type: h })], ee.prototype, "elevationInfo", void 0), e([y({ json: { origins: { "web-map": { read: false, write: false }, "portal-item": { read: false, write: false }, "web-scene": { read: false, write: false } } } })], ee.prototype, "featureReduction", null), e([y(Y.fields)], ee.prototype, "fields", void 0), e([y(Y.fieldsIndex)], ee.prototype, "fieldsIndex", void 0), e([y({ type: M, json: { name: "layerDefinition.definitionGeometry", write: true } })], ee.prototype, "geometryDefinition", void 0), e([y({ type: o$1.apiValues, json: { read: { reader: o$1.read } } })], ee.prototype, "geometryType", void 0), e([y(m$1)], ee.prototype, "labelsVisible", void 0), e([y({ type: [C], json: { name: "layerDefinition.drawingInfo.labelingInfo", read: { reader: i$2 }, write: true } })], ee.prototype, "labelingInfo", void 0), e([y(c$2)], ee.prototype, "legendEnabled", void 0), e([y({ type: ["show", "hide"], json: { origins: { "portal-item": { read: false, write: false } } } })], ee.prototype, "listMode", void 0), e([y({ type: T })], ee.prototype, "maxReconnectionAttempts", void 0), e([y({ type: T })], ee.prototype, "maxReconnectionInterval", void 0), e([y(S)], ee.prototype, "maxScale", void 0), e([y(T$1)], ee.prototype, "minScale", void 0), e([y({ type: String })], ee.prototype, "objectIdField", void 0), e([y({ value: "ArcGISStreamLayer", type: ["ArcGISStreamLayer"] })], ee.prototype, "operationalLayerType", void 0), e([y({ readOnly: true })], ee.prototype, "outFields", void 0), e([y(y$2)], ee.prototype, "popupEnabled", void 0), e([y({ type: P, json: { name: "popupInfo", write: true } })], ee.prototype, "popupTemplate", void 0), e([y({ type: p })], ee.prototype, "purgeOptions", void 0), e([y({ json: { read: false, write: false } })], ee.prototype, "refreshInterval", void 0), e([y({ types: m$2, json: { origins: { service: { write: { target: "drawingInfo.renderer", enabled: false } }, "web-scene": { name: "layerDefinition.drawingInfo.renderer", types: u, write: true } }, write: { target: "layerDefinition.drawingInfo.renderer" } } })], ee.prototype, "renderer", null), e([o$2("service", "renderer", ["drawingInfo.renderer", "defaultSymbol"]), o$2("renderer", ["layerDefinition.drawingInfo.renderer", "layerDefinition.defaultSymbol"])], ee.prototype, "readRenderer", null), e([y((() => {
  const e2 = a$1(p$4);
  return e2.json.origins["portal-item"] = { read: false, write: false }, e2;
})())], ee.prototype, "screenSizePerspectiveEnabled", void 0), e([y()], ee.prototype, "sourceJSON", void 0), e([y({ type: f$3, json: { origins: { service: { read: { source: "spatialReference" } } } } })], ee.prototype, "spatialReference", void 0), e([y({ json: { read: false } })], ee.prototype, "type", void 0), e([y(d)], ee.prototype, "url", void 0), e([y({ type: Number })], ee.prototype, "updateInterval", void 0), e([y({ json: { read: false, write: false } })], ee.prototype, "useViewTime", void 0), e([y({ type: String })], ee.prototype, "webSocketUrl", void 0), ee = e([c("esri.layers.StreamLayer")], ee);
const te = ee;
export {
  te as default
};

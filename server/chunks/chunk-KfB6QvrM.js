import { oz as t, e6 as r$1, cN as c$2, aC as M } from "./chunk-ejFG4zJ0.js";
...
let n$2 = class n {
  ...
  toFormat(t2 = null, r2 = true) {
    if (null === t2 || "" === t2)
      return this.toString();
    if (r2 && (t2 = o(t2)), !t2)
      return "";
    const s2 = this.toDateTime("unknown");
    return m.dateTimeToArcadeDate(s2).toFormat(t2, { locale: c$2(), numberingSystem: "latn" });
  }
  toArcadeDate() {

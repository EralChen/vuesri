...
var e, r, a, i = { exports: {} };
e = i, r = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, a = function(n) {
  var e2, a2, i2;
  n = n || {}, e2 || (e2 = void 0 !== n ? n : {}), e2.ready = new Promise(function(n2, t) {
    a2 = n2, i2 = t;
  });
  var o2 = Object.assign({}, e2), u2 = "./this.program", c = "";
  ...
  Object.assign(e2, o2), o2 = null, e2.thisProgram && (u2 = e2.thisProgram), e2.wasmBinary && (f = e2.wasmBinary), e2.noExitRuntime, "object" != typeof WebAssembly && R("no native wasm support detected");
    ...
    for (r2 = ""; t < e3; ) {
      ...
      if (128 & a3) {
        ...
        if (192 == (224 & a3))
          ...
          var o3 = 63 & n2[t++];
          65536 > (a3 = 224 == (240 & a3) ? (15 & a3) << 12 | i3 << 6 | o3 : (7 & a3) << 18 | i3 << 12 | o3 << 6 | 63 & n2[t++]) ? r2 += String.fromCharCode(a3) : (a3 -= 65536, r2 += String.fromCharCode(55296 | a3 >> 10, 56320 | 1023 & a3));
        }
      } else
        ...
        if (55296 <= i3 && 57343 >= i3 && (i3 = 65536 + ((1023 & i3) << 10) | 1023 & n2.charCodeAt(++a3)), 127 >= i3) {
          ...
          if (2047 >= i3) {
            ...
            if (65535 >= i3) {
              ...
              if (e3 + 3 >= r2)
                break;
              t[e3++] = 240 | i3 >> 18, t[e3++] = 128 | i3 >> 12 & 63;
            }
            t[e3++] = 128 | i3 >> 6 & 63;
          }
          t[e3++] = 128 | 63 & i3;
  ...
  var M, U = 0, I = null;
  function R(n2) {
    throw e2.onAbort && e2.onAbort(n2), l(n2 = "Aborted(" + n2 + ")"), C = true, n2 = new WebAssembly.RuntimeError(n2 + ". Build with -sASSERTIONS for more info."), i2(n2), n2;
  }
  function x() {
  ...
  function Wn(n2, t, e3, r2, a3, i3, o3, u3) {
    this.name = n2, this.constructor = t, this.oa = e3, this.na = r2, this.la = a3, this.Pa = i3, this.va = o3, this.Ka = u3, this.$a = [];
  }
  function En(n2, t, e3) {
    for (; t !== e3; )
  ...
  function Fn(n2, t, e3, r2, a3, i3, o3, u3, c2, f2, s2) {
    this.name = n2, this.ea = t, this.Aa = e3, this.wa = r2, this.xa = a3, this.Za = i3, this.fb = o3, this.Ga = u3, this.Ba = c2, this.ab = f2, this.na = s2, a3 || void 0 !== t.la ? this.toWireType = On : (this.toWireType = r2 ? jn : Sn, this.ja = null);
  }
  function Dn(n2, t, r2) {
  ...
  function Hn(n2, t, e3, r2, a3) {
    ...
    var o3 = null !== t[1] && null !== e3, u3 = false;
    ...
    return function() {
      if (arguments.length !== f2 && cn("function " + n2 + " called with " + arguments.length + " arguments, expected " + f2 + " args!"), h2.length = 0, l2.length = o3 ? 2 : 1, l2[0] = a3, o3) {
      ...
      if (i4 = r2.apply(null, l2), u3)
        ...
        for (var d2 = o3 ? 1 : 2; d2 < t.length; d2++) {
          var p2 = 1 === d2 ? e4 : s2[d2 - 2];
          null !== t[d2].ja && t[d2].ja(p2);
        }
      return e4 = c2 ? t[0].fromWireType(i4) : void 0;
    };
  }
  function Yn(n2, t) {
  ...
  function et(n2, t, e3) {
    ...
    for (var a3 = 0; a3 < n2.length; ++a3) {
      var i3 = n2.charCodeAt(a3);
      if (55296 <= i3 && 57343 >= i3 && (i3 = 65536 + ((1023 & i3) << 10) | 1023 & n2.charCodeAt(++a3)), g[t >> 2] = i3, (t += 4) + 4 > e3)
        break;
    }
    return g[t >> 2] = 0, t - r2;
  }
  ...
  function bt(n2, t, e3, r2) {
    ...
    function c2(n3) {
      ...
      return e4 = new Date(n3.getFullYear() + 1, 0, 4), t2 = u3(new Date(n3.getFullYear(), 0, 4)), e4 = u3(e4), 0 >= o3(t2, n3) ? 0 >= o3(e4, n3) ? n3.getFullYear() + 1 : n3.getFullYear() : n3.getFullYear() - 1;
    }
    var f2 = g[r2 + 40 >> 2];
  ...
  var Tt = { n: function(n2) {
    ...
    en([n2], a3.map((n3) => n3.Ta).concat(a3.map((n3) => n3.cb)), (n3) => {
      ...
      return a3.forEach((t2, e4) => {
        var r3 = n3[e4], o3 = t2.Ra, u3 = t2.Sa, c2 = n3[e4 + a3.length], f2 = t2.bb, s2 = t2.eb;
        i3[t2.Na] = { read: (n4) => r3.fromWireType(o3(u3, n4)), write: (n4, t3) => {
          var e5 = [];
        ...
        var o3 = e3();
        for (a4 in i3)
          i3[a4].write(o3, t2[a4]);
        return null !== n4 && n4.push(r2, o3), o3;
    ...
    i3 && (a3 = (1n << 64n) - 1n), fn(n2, { name: t, fromWireType: function(n3) {
      ...
      return e4;
    }, argPackAdvance: 8, readValueFromPointer: sn(t, e3, !i3), ja: null });
  ...
  }, f: function(n2, t, e3, r2, a3, i3, o3, u3, c2, f2, s2, l2, h2) {
    s2 = on(s2), i3 = Un(a3, i3), u3 && (u3 = Un(o3, u3)), f2 && (f2 = Un(c2, f2)), h2 = Un(l2, h2);
    var d2 = Z(s2);
    kn(d2, function() {
      ...
      if (t2 = t2[0], r2)
        ...
        a4 = Pn.prototype;
      t2 = K(d2, function() {
        if (Object.getPrototypeOf(this) !== o4)
      ...
      var o4 = Object.create(a4, { constructor: { value: t2 } });
      t2.prototype = o4;
      var c3 = new Wn(s2, t2, o4, h2, e4, i3, u3, f2);
  ...
  }, o: function(n2, t, e3, r2, a3, i3, o3) {
    var u3 = Yn(e3, r2);
    t = on(t), i3 = Un(a3, i3), en([], [n2], function(n3) {
      ...
      return void 0 === c2[t] ? (r3.sa = e3 - 1, c2[t] = r3) : ($n(c2, t, a4), c2[t].ha[e3 - 1] = r3), en([], u3, function(n4) {
        return n4 = Hn(a4, [n4[0], null].concat(n4.slice(1)), null, i3, o3), void 0 === c2[t].ha ? (n4.sa = e3 - 1, c2[t] = n4) : c2[t].ha[e3 - 1] = n4, [];
      }), [];
    });
  }, i: function(n2, t, e3, r2, a3, i3) {
    0 < t || R();
    var o3 = Yn(t, e3);
    a3 = Un(r2, a3), en([], [n2], function(n3) {
      ...
      return n3.ea.pa[t - 1] = () => {
        xn("Cannot construct " + n3.name + " due to unbound types", o3);
      }, en([], o3, function(r3) {
        return r3.splice(1, 0, null), n3.ea.pa[t - 1] = Hn(e4, r3, null, a3, i3), [];
      }), [];
    });
  }, b: function(n2, t, e3, r2, a3, i3, o3, u3) {
    var c2 = Yn(e3, r2);
    t = on(t), i3 = Un(a3, i3), en([], [n2], function(n3) {
      function r3() {
      ...
      return void 0 === s2 || void 0 === s2.ha && s2.className !== n3.name && s2.sa === e3 - 2 ? (r3.sa = e3 - 2, r3.className = n3.name, f2[t] = r3) : ($n(f2, t, a4), f2[t].ha[e3 - 2] = r3), en([], c2, function(r4) {
        return r4 = Hn(a4, r4, n3, i3, o3), void 0 === f2[t].ha ? (r4.sa = e3 - 2, f2[t] = r4) : f2[t].ha[e3 - 2] = r4, [];
      }), [];
    });
  }, c: function(n2, t, e3, r2, a3, i3, o3, u3, c2, f2) {
    t = on(t), a3 = Un(r2, a3), en([], [n2], function(n3) {
      var r3 = (n3 = n3[0]).name + "." + t, s2 = { get: function() {
        xn("Cannot access " + r3 + " due to unbound types", [e3, o3]);
      }, enumerable: true, configurable: true };
      return s2.set = c2 ? () => {
        xn("Cannot access " + r3 + " due to unbound types", [e3, o3]);
      } : () => {
        cn(r3 + " is a read-only property");
      }, Object.defineProperty(n3.ea.oa, t, s2), en([], c2 ? [e3, o3] : [e3], function(e4) {
        var o4 = e4[0], s3 = { get: function() {
          var t2 = Vn(this, n3, r3 + " getter");
          return o4.fromWireType(a3(i3, t2));
        }, enumerable: true };
        if (c2) {
          c2 = Un(u3, c2);
          var l2 = e4[1];
  ...
  }, V: function(n2, t, e3, r2, a3, i3) {
    var o3 = Yn(t, e3);
    n2 = on(n2), a3 = Un(r2, a3), kn(n2, function() {
      xn("Cannot call " + n2 + " due to unbound types", o3);
    }, t - 1), en([], o3, function(e4) {
      return Dn(n2, Hn(n2, [e4[0], null].concat(e4.slice(1)), null, a3, i3), t - 1), [];
    });
    ...
    e3 = t.includes("unsigned") ? function(n3, t2) {
      ...
      return t2;
    }, fn(n2, { name: t, fromWireType: i3, toWireType: e3, argPackAdvance: 8, readValueFromPointer: sn(t, a3, 0 !== r2), ja: null });
  }, q: function(n2, t, e3) {
    function r2(n3) {
      var t2 = b;
  ...
  }, h: function(n2, t, e3, r2, a3, i3, o3, u3, c2, f2, s2, l2) {
    e3 = on(e3), i3 = Un(a3, i3), u3 = Un(o3, u3), f2 = Un(c2, f2), l2 = Un(s2, l2), en([n2], [t], function(n3) {
      return n3 = n3[0], [new Fn(e3, n3.ea, false, false, true, n3, r2, i3, u3, f2, l2)];
    });
  }, F: function(n2, t) {
    ...
    fn(n2, { name: t, fromWireType: function(n3) {
      ...
      var a3 = e3 && r2 ? W(t2) : t2.length, i3 = Ct(4 + a3 + 1), o3 = i3 + 4;
      if (b[i3 >> 2] = a3, e3 && r2)
        k(t2, v, o3, a3 + 1);
      else if (r2)
        for (r2 = 0; r2 < a3; ++r2) {
          var u3 = t2.charCodeAt(r2);
          255 < u3 && (Pt(o3), cn("String has UTF-16 code units that do not fit in 8 bits")), v[o3 + r2] = u3;
        }
      else
        for (r2 = 0; r2 < a3; ++r2)
          v[o3 + r2] = t2[r2];
    ...
    if (e3 = on(e3), 2 === t)
      var r2 = Kn, a3 = Qn, i3 = nt, o3 = () => y, u3 = 1;
    else
      4 === t && (r2 = tt, a3 = et, i3 = rt, o3 = () => b, u3 = 2);
    fn(n2, { name: e3, fromWireType: function(n3) {
      for (var e4, a4 = b[n3 >> 2], i4 = o3(), c2 = n3 + 4, f2 = 0; f2 <= a4; ++f2) {
        var s2 = n3 + 4 + f2 * t;
        f2 != a4 && 0 != i4[s2 >> u3] || (c2 = r2(c2, s2 - c2), void 0 === e4 ? e4 = c2 : (e4 += String.fromCharCode(0), e4 += c2), c2 = s2 + t);
      }
      return Pt(n3), e4;
    }, toWireType: function(n3, r3) {
      "string" != typeof r3 && cn("Cannot pass non-string to C++ string type " + e3);
      var o4 = i3(r3), c2 = Ct(4 + o4 + t);
      return b[c2 >> 2] = o4 >> u3, a3(r3, c2 + 4, o4 + t), null !== n3 && n3.push(Pt, c2), c2;
    }, argPackAdvance: 8, readValueFromPointer: L, ja: function(n3) {
      Pt(n3);
    } });
  }, v: function(n2, t, e3, r2, a3, i3) {
    q[n2] = { name: on(t), Ba: Un(e3, r2), na: Un(a3, i3), Fa: [] };
  }, l: function(n2, t, e3, r2, a3, i3, o3, u3, c2, f2) {
    q[n2].Fa.push({ Na: on(t), Ta: e3, Ra: Un(r2, a3), Sa: i3, cb: o3, bb: Un(u3, c2), eb: f2 });
  }, T: function(n2, t) {
    ...
    for (var a3 = Array(t), i3 = 0; i3 < t; ++i3) {
      var o3 = e3[i3];
      a3[i3] = o3.readValueFromPointer(r2), r2 += o3.argPackAdvance;
    }
    return n2 = n2.apply(void 0, a3), Ln(n2);
  }, U: function(n2, t, e3, r2, a3) {
    n2 = ut[n2], t = Nn(t), e3 = ot(e3);
    var i3 = [];
    return b[r2 >> 2] = Ln(i3), n2(t, e3, i3, a3);
  }, G: function(n2, t, e3, r2) {
    (n2 = ut[n2])(t = Nn(t), e3 = ot(e3), null, r2);
  }, a: qn, H: function(n2) {
    ...
    if (void 0 !== a3)
      return a3;
    var i3 = Array(n2 - 1);
    return a3 = ft((t2, a4, o3, u3) => {
      for (var c2 = 0, f2 = 0; f2 < n2 - 1; ++f2)
        i3[f2] = e3[f2 + 1].readValueFromPointer(u3 + c2), c2 += e3[f2 + 1].argPackAdvance;
      for (t2 = t2[a4].apply(t2, i3), f2 = 0; f2 < n2 - 1; ++f2)
        e3[f2 + 1].Ja && e3[f2 + 1].Ja(i3[f2]);
      if (!r2.Xa)
        return r2.toWireType(o3, t2);
    }), st[t] = a3;
  }, r: function(n2, t) {
    ...
    for (var a3 = 0, i3 = 0; i3 < e3; i3++) {
      var o3 = b[t >> 2], u3 = b[t + 4 >> 2];
      t += 8;
      for (var c2 = 0; c2 < u3; c2++) {
        var f2 = v[o3 + c2], h2 = pt[n2];
  ...
  !function() {
    ...
    if (U++, e2.monitorRunDependencies && e2.monitorRunDependencies(U), e2.instantiateWasm)
      try {
        ...
        l("Module.instantiateWasm callback failed with error: " + o3), i2(o3);
      }

import { d1 as n, ax as t, d2 as f, as as j$1, aB as f$1, aC as M, b6 as u$1, aQ as U$1, j8 as o, aO as s, aV as e, aX as y, a_ as c$1, j4 as t$1, a$ as b$1, iJ as s$1, av as u$2, ay as m$1, cY as x$1, e2 as p } from "./chunk-ejFG4zJ0.js";
import "luxon";
import "@esri/arcgis-html-sanitizer";
import "@esri/calcite-components/dist/components/index.js";
var h$1;
const d = new t$1("0/0/0", 0, 0, 0, void 0);
let g = h$1 = class extends n(t(f(b$1))) {
  constructor() {
    super(...arguments), this.tileInfo = j$1.create({ spatialReference: f$1.WebMercator, size: 256 }), this.type = "base-tile", this.fullExtent = new M(-20037508342787e-6, -2003750834278e-5, 2003750834278e-5, 20037508342787e-6, f$1.WebMercator), this.spatialReference = f$1.WebMercator;
  }
  ...
  fetchTile(e2, r, o2, s2 = {}) {
    const { signal: i } = s2, a = this.getTileUrl(e2, r, o2), p2 = { responseType: "image", signal: i, query: { ...this.refreshParameters } };
    return U$1(a ?? "", p2).then((e3) => e3.data);
  }
  async fetchImageBitmapTile(e2, r, o$1, s2 = {}) {
    ...
    const a = this.getTileUrl(e2, r, o$1) ?? "", p2 = { responseType: "blob", signal: i, query: { ...this.refreshParameters } }, { data: l } = await U$1(a, p2);
...
const j = g;
const c = new s$1({ BingMapsAerial: "aerial", BingMapsRoad: "road", BingMapsHybrid: "hybrid" }), m = "https://dev.virtualearth.net";
let h = class extends n(u$2(m$1(j))) {
  constructor(e2) {
  ...
  getTileUrl(e2, t2, r) {
    if (!this.loaded || null == this.bingMetadata)
      return null;
    const o2 = this.bingMetadata.resourceSets[0].resources[0], a = o2.imageUrlSubdomains[t2 % o2.imageUrlSubdomains.length], s2 = this._getQuadKey(e2, t2, r);
    return o2.imageUrl.replace("{subdomain}", a).replace("{quadkey}", s2);
  }
  ...
  _getMetadata() {
    ...
    return U$1(`${m}/REST/v1/Imagery/Metadata/${e2}`, { responseType: "json", query: { include: "ImageryProviders", uriScheme: "https", key: this.key, suppressStatus: true, output: "json", culture: this.culture, userRegion: this.region } }).then((e3) => {
      const t2 = e3.data;
  ...
  _getPortalBingKey() {
    return U$1(this.portalUrl ?? "", { responseType: "json", authMode: "no-prompt", query: { f: "json" } }).then((e2) => {
      if (!e2.data.bingKey)

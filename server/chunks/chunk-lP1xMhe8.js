import { ws as v$3, rz as n$2, wt as g$2, tN as I$3, ht as y$2, hs as f$3, wu as b$3, tR as y$3, wv as m$1, cL as y$4, cJ as m$2, ww as x$1, wx as r$3, uh as I$4, bu as u$7, dM as u$8, c7 as s$3, bt as S$1, bo as e$2, bp as y$5, br as c$3, bs as g$3, bh as V$2, e3 as v$5, bJ as d$2, bn as P$1, wy as a$5, wz as r$5, c$ as t, bb as s$4, ej as k$3, dS as w$2, cT as Et, a$ as j$3, bX as k$4, iH as e$3, eo as m$3, fH as m$4, wA as i$4, wB as s$5, fs as e$5, wC as a$8, dH as Z, dI as be$1, wD as r$8, sF as f$4, rA as s$7, sD as f$5, wE as o$2, eg as p$4, tM as i$6, h8 as u$a, iZ as u$b, rx as e$6, wF as t$3, ry as O$1, wG as e$7, wH as n$4, wI as e$8, iA as s$8, wJ as i$7 } from "./chunk-KFNcxJaF.js";
import { t as t$2 } from "./chunk-pMG-yMIH.js";
import { M as M$1, A as A$2, $ as $$2, v as v$4, T as T$3, E as E$2, V as V$1, q as q$1, u as u$6, n as n$3, i as i$2, r as r$4, a as l$4, b as i$3, c as a$6, f as v$6, g as u$9, h as a$7, j as b$4, l as l$5, k as g$4, m as r$6, o as e$4, p as i$5, s as o$1, w as s$6, t as t$1, x as V$3, y as r$7, D as D$1 } from "./chunk-y_FkjZn_.js";
...
function T$2(n2, d2, b2 = {}) {
  const { focus: u2, numClasses: c2, colors: h2, rotation: T2 } = n2, { opacity: _2, effectList: q2, ariaLabel: L2 } = b2, g2 = b2.size ?? 60, $2 = !!u2, C2 = Math.sqrt(g2 ** 2 + g2 ** 2) + ($2 ? 0 : 5), v3 = [], w2 = [], y2 = [], x2 = (g2 || 75) / c2;
...
const l$2 = (e2, l2) => {
  const a2 = e2.featuresTilingScheme.getClosestInfoForScale(e2.scale).level;
  return l2?.levels ? l2.levels[a2] : null;
};
function a$4(a2, i2) {
  if (!a2 || !("visualVariables" in a2) || !a2.visualVariables)
    return null;
  const s2 = a2.visualVariables.find((e2) => "size" === e2.type), n2 = l$2(i2, s2);
  return n2 ? new b$3({ field: s2.field, minSize: n2[2].size, minDataValue: n2[2].value, maxSize: n2[3].size, maxDataValue: n2[3].value }) : null;
}
const p$2 = 30, y$1 = 12, b$1 = [255, 255, 255], h$2 = [200, 200, 200], d$1 = [128, 128, 128], w$1 = 20, g$1 = 5;
function S(e2) {
...
async function k$1(e2, l2, n2, i2, o2, a2, u2) {
  const c2 = l2.legendOptions, m2 = c2?.customValues, f2 = u2 || await U$1(e2, n2), p2 = l2.stops, y2 = !!f2, b2 = !!m2, h2 = null != l2.minSize && null != l2.maxSize, d2 = p2 && p2.length > 1, w2 = !!l2.target;
  if (!y2 || !b2 && !(h2 || d2 && !w2))
    return;
  const g2 = y$3(f2);
  let S2 = false, v3 = null, z2 = null;
  v3 = g2 && !d2 ? u$6([l2.minDataValue, l2.maxDataValue]) : m2 ?? await D(l2, f2, i2, o2?.type);
  const j2 = e2?.authoringInfo, k2 = "univariate-color-size" === j2?.type, C2 = k2 && "above-and-below" === j2?.univariateTheme;
  if (!v3 && d2 && (v3 = p2.map((e3) => e3.value), S2 = p2.some((e3) => !!e3.label), "flow" === e2.type && (v3 = u$6(v3)), S2 && (z2 = p2.map((e3) => e3.label))), g2 && null != v3 && v3?.length > 2 && !C2 && (v3 = [v3[0], v3[v3.length - 1]]), !v3)
    return null;
  k2 && 5 !== v3?.length && (v3 = E$1({ minSize: v3[0], maxSize: v3[v3.length - 1] }));
  const I2 = g2 ? x(e2, v3) : null, M2 = m$1(f2), T2 = S2 ? null : V(v3, a2);
  return (await Promise.all(v3.map(async (t2, n3) => {
    const s2 = g2 ? I2[n3] : await B(l2, f2, t2, i2, o2?.type);
...
async function U$1(e2, l2) {
  if ("flow" === e2.type)
    return n$3(e2, l2);
  if ("pie-chart" === e2.type)
    return new y$4({ color: null, outline: e2.outline?.width ? e2.outline : new m$2() });
  let t2 = null, n2 = null;
  if ("simple" === e2.type)
    t2 = e2.symbol;
...
function I$2(e2) {
  "line-3d" === e2.type ? e2.symbolLayers.forEach((e3) => {
    ...
    "icon" !== e3.type || e3.resource?.href ? e3.material = { color: h$2 } : (e3.material = { color: b$1 }, e3.outline = { color: d$1, size: 1.5 });
  });
}
function M(l2) {
  const t2 = r$3();
...
async function D(e2, l2, n2, i2) {
  const o2 = (await import("./chunk-KFNcxJaF.js").then((n3) => n3.D_)).getSizeRangeAtScale(e2, n2, i2), s2 = o2 && E$1(o2);
  if (!o2 || !s2)
    return;
...
async function q(e2, l2, o2, s2, r2, a2) {
  const u2 = await B(e2, l2, o2, r2, a2), c2 = await B(e2, l2, s2, r2, a2), m2 = i$2(o2), f2 = m2.fractional, p2 = w$1;
  ...
  for (let n2 = y2 - 1; n2 >= 0; n2--) {
    ...
    null != b2 && (m3 /= b2, f3 /= b2);
    let y3 = (m3 + f3) / 2;
    [, y3] = u$6([m3, y3, f3], { indexes: [1] });
    const d2 = await B(e2, l2, m3, r2, a2), w2 = await B(e2, l2, f3, r2, a2), g2 = await B(e2, l2, y3, r2, a2), S2 = l$4(u2, d2, c2, null), v3 = l$4(u2, w2, c2, null), z2 = l$4(u2, g2, c2, null);
    let j2 = S2.previous <= p2, V2 = v3.previous <= p2;
    if (j2 && V2 && (S2.previous <= v3.previous ? (j2 = true, V2 = false) : (V2 = true, j2 = false)), j2 ? h2 = [m3, d2] : V2 ? h2 = [f3, w2] : z2.previous <= p2 && (h2 = [y3, g2]), h2)
      break;
  }
  return h2;
}
async function B(e2, l2, t2, n2, i2) {
  const { getSize: o2 } = await import("./chunk-KFNcxJaF.js").then((n3) => n3.D_);
...
function s$1(t2) {
  ...
  return u$8(t2, { notation: s2, minimumSignificantDigits: n2, maximumSignificantDigits: e2 });
}
const ne = "https://utility.arcgis.com/sharing/tools/legend", ae = "esri.layers.ImageryLayer", oe = "esri.layers.ImageryTileLayer", ue = "esri.layers.WCSLayer", ce = /^\s*(return\s+)?\$view\.scale\s*(;)?\s*$/i, de = new s$3({ esriGeometryPoint: "point", esriGeometryMultipoint: "multipoint", esriGeometryPolyline: "polyline", esriGeometryPolygon: "polygon", esriGeometryMultiPatch: "multipatch" }), ye = new y$4({ size: 6, outline: { color: [128, 128, 128, 0.5], width: 0.5 } }), he = new S$1({ style: "solid" });
function me(e2) {
  return "flow" === e2.type;
}
function fe(e2) {
...
function Le(e2) {
  return Ce(e2) || Ie(e2) || Re(e2) || Ee(e2);
}
function Ee(e2) {
...
function Te(e2, t2) {
  return Se(e2) || _e(e2) || we(e2) || ve(e2) || Fe(e2) || Ve(e2) ? "2d" === t2.type || t$2(e2) : ge(e2) || pe(e2) || be(e2) || Ce(e2) || Ie(e2) || Re(e2) || fe(e2) || me(e2);
}
function ze(e2) {
...
function Ue(e2) {
  return e2.declaredClass === oe;
}
function ke(e2) {
  return e2.declaredClass === ue;
}
function Be(e2) {
...
async function $e(e2, t2) {
  const s2 = await f$4("esri/widgets/Legend/t9n/Legend");
  return "previewTemplateAriaLabel" !== e2 || t2 || (e2 = "previewAriaLabel"), s$7(s2[e2], { label: t2 });
}
const We = new y$4({ style: "path", path: "M10,5 L5,0 0,5 M5,0 L5,15", size: 15, outline: { width: 1, color: [85, 85, 85, 1] } });
let Ge = {}, Je = class extends g$3 {
  constructor(e2) {
    super(e2), this._hasColorRamp = false, this._hasOpacityRamp = false, this._hasSizeRamp = false, this._webStyleSymbolCache = /* @__PURE__ */ new Map(), this._dotDensityUrlCache = /* @__PURE__ */ new Map(), this._scaleDrivenSizeVariable = null, this._hasClusterSizeVariable = false, this.children = new V$2(), this.layerView = null, this.layer = null, this.legendElements = [], this.parent = null, this.hideLayersNotInCurrentView = false, this.keepCacheOnDestroy = false, this.respectLayerVisibility = true, this.sublayerIds = [], this.title = null, this.view = null;
  }
  initialize() {
    ...
    this.addHandles([v$5(() => this.children, "change", (t2) => {
      ...
      s2.forEach((t3) => {
        ...
        this.addHandles(d$2(() => t3.ready, e2, P$1), s3);
      }), l2.forEach((e3) => this.removeHandles(e3.layer.uid)), e2();
    })]), this.keepCacheOnDestroy || (Ge = {});
  }
  destroy() {
    this._webStyleSymbolCache = null, this._dotDensityUrlCache = null, this._scaleDrivenSizeVariable = null, this.keepCacheOnDestroy || (Ge = null);
  }
  get effectList() {
    const e2 = this.layer;
    let t2 = null;
    return "effect" in e2 && e2.effect && (t2 = new a$5(), t2.effect = e2.effect, t2.endTransitions(), t2.scale = this.scale), t2;
  }
  get opacity() {
  ...
  async buildLegendElementsForFeatureCollections(e2) {
    ...
    const t$12 = Array.from(e2, (e3) => {
      ...
      if (e3.featureSet?.features.length) {
        const t$13 = e3.layerDefinition, s2 = t$13?.drawingInfo, l2 = s2 && t(s2.renderer), i2 = de.read(t$13.geometryType);
    ...
    if (xe(e2))
      ...
      await this._getLegendLayers(`${e2.uid}-${t2}`).then(async (t3) => {
        ...
        const s2 = t3.map(async (t4) => {
          if (Me(e2) || Ue(e2)) {
            const t5 = d$2(() => ["renderingRule" in e2 && e2.rasterFunction, e2.bandIds], () => k$3(async () => {
              Ge.default = null, e2.renderer ? await this.buildLegendElementsForRenderer(e2.renderer) : await this.buildLegendElementsForTools();
            })());
            this.addHandles(t5, "imageryLayers-watcher");
          }
          const s3 = this._generateSymbolTableElementForLegendLayer(t4);
          s3 && s3.infos.length && (Me(e2) && (s3.title = e2.title), this.legendElements.push(s3)), this.notifyChange("ready");
        });
  ...
  _isGroupActive() {
    ...
    return !!e2.length && e2.some((e3) => e3.ready);
  }
  ...
  _isScaleDrivenSizeVariable(e2) {
    ...
    return !("object" != typeof s2 || !s2 || !this._isScaleDrivenSizeVariable(s2)) || (!("object" != typeof l2 || !l2 || !this._isScaleDrivenSizeVariable(l2)) || (!!t2.expression || ce.test(t2.valueExpression)));
  }
  _isLayerScaleDriven(e2) {
    ...
    const t2 = e2.parent;
    if (false === e2.loaded && t2 && Pe(t2) && "source" in e2 && e2.source && "map-layer" === e2.source.type) {
  ...
  async _constructLegendElementsForVoxellayer() {
    ...
    const e2 = this.layer;
    this.addHandles(d$2(() => e2.currentVariableId, () => this._constructLegendElementsForVoxellayer()), "voxel-current-variable"), this.addHandles(d$2(() => e2.getVariableStyles(), () => this._constructLegendElementsForVoxellayer()), "voxel-style-watcher");
    ...
    if (t2) {
      if (t2.uniqueValues?.length) {
        ...
        const { colorStops: e3, stretchRange: l3 } = t2.transferFunction, i3 = e3.toArray().reverse(), r2 = l3.map((e4, t3) => `${0 === t3 ? i$3 : a$6} ${s$1(e4)}`).reverse(), n2 = i3.map((e4) => ({ color: e4.color, value: null, label: null }));
        n2[0].label = r2[0], n2[n2.length - 1].label = r2[1], s2.push({ type: "color-ramp", title: t2.label, infos: n2, preview: v$6(i3.map((e4) => e4.color), { ariaLabel: await $e("previewColorRampAriaLabel") }) });
      }
    }
  ...
  _constructLegendElementsForWMTSlayer() {
    ...
    if (this.addHandles(d$2(() => {
      const { layer: e3 } = this;
      return e3 && "activeLayer" in e3 && e3.activeLayer;
    }, () => this._constructLegendElementsForWMTSlayer()), "wmts-activeLayer-watcher"), e2.styleId && e2.styles) {
      let t2 = null;
      e2.styles.some((s2) => e2.styleId === s2.id && (t2 = s2.legendUrl, true)), t2 && (this.legendElements = [{ type: "symbol-table", title: e2.title, infos: [{ src: t2, opacity: this.opacity }] }]);
    }
  ...
  async _constructLegendElementsForWMSSublayers() {
    ...
    const e2 = this.layer;
    let t2 = null;
    (e2.customParameters || e2.customLayerParameters) && (t2 = { ...e2.customParameters, ...e2.customLayerParameters }), this.addHandles(d$2(() => {
      const { layer: e3 } = this;
  ...
  async _generateLegendElementsForWMSSublayers(e2, t2) {
    ...
    const l2 = e2.toArray();
    for (const i2 of l2) {
      const e3 = d$2(() => [i2.title, i2.visible, i2.legendEnabled], () => this._constructLegendElementsForWMSSublayers());
      if (this.addHandles(e3, "wms-sublayers-watcher"), !this.respectLayerVisibility || i2.visible && i2.legendEnabled) {
        const e4 = await this._generateSymbolTableElementForWMSSublayer(i2, t2);
        e4?.infos.length && s2.unshift(e4);
      }
    }
    return s2;
  }
  ...
  async _generateSymbolTableElementForLegendUrl(e2, t2) {
    ...
    try {
      r2 = (await j$3(s2, { responseType: "image" })).data, r2 && (r2.style.opacity = n2);
    } catch {
    }
  ...
  _legendRequest(e2) {
    ...
    if ("version" in t2 && +t2.version >= 10.01) {
      ...
      i2 = ne + "?soapUrl=" + encodeURI(t3) + "&returnbytes=true";
    }
    return j$3(i2, { query: s2 }).then((e3) => e3.data);
  }
  async _constructLegendElementsForBuildingSceneLayer() {
    this.legendElements = [], this.removeHandles("sublayers-watcher");
    const e2 = this.layer;
    this.addHandles(d$2(() => e2.sublayers, () => this._constructLegendElementsForBuildingSceneLayer()), "sublayers-watcher");
    try {
  ...
  async _generateLegendElementsForBuildingSublayers(e2, t2) {
    ...
    const l2 = e2.toArray();
    for (const i2 of l2) {
      const e3 = d$2(() => ["renderer" in i2 && i2.renderer, i2.opacity, i2.title, i2.visible], () => this._constructLegendElementsForBuildingSceneLayer());
  ...
  async _constructLegendElementsForSublayers() {
    this.legendElements = [], this.removeHandles("sublayers-watcher");
    const e2 = this.layer;
    if (Pe(e2) || Ae(e2) || De(e2)) {
      this.addHandles(d$2(() => e2.sublayers, () => this._constructLegendElementsForSublayers), "sublayers-watcher");
      try {
  ...
  async _generateLegendElementsForSublayers(e2, t2, s2) {
    ...
    let n2 = e2.toArray();
    !s2 && this.sublayerIds && this.sublayerIds.length && (n2 = De(l2) ? this.sublayerIds.map((e3) => l2.findSublayerForSubtypeCode(e3)).filter(k$4) : this.sublayerIds.map((e3) => l2.findSublayerById(e3)).filter(k$4));
    for (const r2 of n2) {
      const e3 = d$2(() => [r2.renderer, r2.opacity, r2.title, r2.visible, r2.legendEnabled], () => this._constructLegendElementsForSublayers());
      if (this.addHandles(e3, "sublayers-watcher"), !this.respectLayerVisibility || r2.visible && r2.legendEnabled && this._isSublayerInScale(r2)) {
        const e4 = null != r2?.opacity ? r2.opacity : null, l3 = null != e4 ? e4 * t2 : t2, n3 = !He(r2) || r2.originIdOf("renderer") > e$3.SERVICE && !r2.sublayers;
        if (r2.renderer && n3) {
          await r2.load();
  ...
  async _generateSymbolTableElementForSublayer(e2, t2, s2) {
    if (!s2) {
      ...
      if (!(!l3 || "map-layer" === l3.type && l3.mapLayerId === e2.id && (!l3.gdbVersion || l3.gdbVersion === ("gdbVersion" in t3 && t3.gdbVersion))) || e2.originIdOf("renderer") > e$3.SERVICE || e2.originIdOf("labelingInfo") > e$3.SERVICE || e2.originIdOf("labelsVisible") > e$3.SERVICE) {
        const e3 = new m$3({ layer: this.layer });
    ...
    return e2.map((e3) => {
      ...
      if (e3.imageData && e3.imageData.length > 0)
        ...
        if (0 === i2.indexOf("http"))
          return null;
        i2 = m$4(`${this.layer.url}/${t2}/images/${i2}`);
      }
  ...
  async _getRendererLegendElements(e2, t2 = {}) {
    ...
    return Ve(s2) ? this._constructPieChartRendererLegendElements(s2) : this._constructRendererLegendElements(s2, t2);
  }
  ...
  async _constructPointCloudRendererLegendElements(e2, t2 = {}) {
    ...
    if (Ce(e2))
      i2 = { type: "symbol-table", title: s2 || this._getPointCloudRendererTitle(e2), infos: [] }, e2.colorClassBreakInfos.forEach((e3) => {
        i2.infos.unshift({ label: e3.label || e3.minValue + " - " + e3.maxValue, value: [e3.minValue, e3.maxValue], symbol: this._getAppliedCloneSymbol(ye, e3.color) });
      });
    else if (Ie(e2)) {
      const t3 = e2.stops;
      let l3 = null;
      if (t3?.length && (1 === t3.length && (l3 = t3[0].color), !l3)) {
        ...
        if (null != e3 && null != s3) {
          l3 = u$9(e3 + (s3 - e3) / 2, t3);
        }
      }
      i2 = { type: "symbol-table", title: null, infos: [{ label: null, value: null, symbol: this._getAppliedCloneSymbol(ye, l3 || ye.color) }] };
      const n3 = a$7(e2.stops ?? []) ?? [];
      r2 = { type: "color-ramp", title: s2 || this._getPointCloudRendererTitle(e2), infos: n3, preview: v$6(n3.map((e3) => e3.color), { ariaLabel: await $e("previewColorRampAriaLabel") }) };
    } else
      Re(e2) && (i2 = { type: "symbol-table", title: s2 || this._getPointCloudRendererTitle(e2), infos: [] }, e2.colorUniqueValueInfos?.forEach((e3) => {
        i2.infos.push({ label: e3.label || e3.values.join(", "), value: e3.values.join(", "), symbol: this._getAppliedCloneSymbol(ye, e3.color) });
      }));
  ...
  async _getElementInfoForDotDensity(e2, t2) {
    const { color: s2, label: l2, valueExpressionTitle: i2 } = t2, { backgroundColor: r2, outline: n2, dotSize: a2 } = e2, o2 = this.effectList, u2 = o2?.effects.map((e3) => e3.toJSON()), c2 = i$4(u2), d2 = await $e("previewTemplateAriaLabel", l2 || i2), y2 = a2 + "-" + s2 + "-" + r2 + "-" + (n2 && JSON.stringify(n2.toJSON())) + "-" + c2, h2 = this._dotDensityUrlCache, m2 = h2.has(y2) ? h2.get(y2) : b$4(e2, s2, { ariaLabel: d2 });
    h2.set(y2, m2);
    const f2 = { shape: { type: "image", x: 0, y: 0, width: m2.width, height: m2.height, src: m2.src }, fill: null, stroke: null, offset: [0, 0] }, p2 = l$5([[f2]], [m2.width, m2.height], { effectView: this.effectList, ariaLabel: d2 });
  ...
  async _constructPieChartRendererLegendElements(e2) {
    ...
    if (s2.length) {
      ...
      const t3 = r2.filter((e3) => e3.label !== l2).map((e3) => e3.symbol.color).filter(Boolean), a3 = g$4(t3, { holePercentage: e2.holePercentage, backgroundColor: e2.backgroundFillSymbol?.color, effectList: this.effectList, outline: i2, ariaLabel: await $e("previewPieChartAriaLabel") });
  ...
  async _constructRendererLegendElements(e2, t2 = {}) {
    ...
    if (me(e2) && !this._hasSizeRamp) {
      const t3 = await n$3(e2);
      n2.infos.push({ label: null, symbol: t3 });
    } else if (Ne(e2)) {
      let t3 = s2;
      const l3 = qe(e2) ? "univariate-above-and-below-ramp" : "univariate-color-size-ramp", i3 = r2.findIndex((e3) => "color-ramp" === e3.type), n3 = -1 !== i3 ? r2.splice(i3, 1)[0] : null, a3 = r2.findIndex((e3) => "size-ramp" === e3.type), o3 = -1 !== a3 ? r2.splice(a3, 1)[0] : null, u3 = [];
      n3 && (t3 = n3.title, u3.push(n3)), o3 && (t3 = o3.title, u3.push(o3)), u3.length > 0 && r2.push({ type: l3, title: t3, infos: u3 });
    } else if (ve(e2)) {
      const t3 = r$6(e2);
      r2.push({ type: "heatmap-ramp", title: s2 || this._getRendererTitle(e2, i2), infos: t3, preview: v$6(t3.map((e3) => e3.color), { effectList: this.effectList, ariaLabel: await $e("previewColorRampAriaLabel") }) });
    } else if (we(e2)) {
      ...
      if (t3 && "relationship" === t3.type) {
        ...
        if (s3 && l3 && a3) {
          ...
          let c3 = u$4(o3) || 0;
          for (const e3 of t4) {
            const { field: t5, normalizationField: s4, label: l4 } = e3, r3 = l4 || { field: this._getFieldAlias(t5, i2), normField: s4 && this._getFieldAlias(s4, i2) }, a4 = We.clone();
      ...
      } else if (Me(this.layer) || Ue(this.layer))
      ...
      e2.colormapInfos.forEach((e3) => {
        n2.infos.push({ label: e3.label, value: e3.value, symbol: this._getAppliedCloneSymbol(he, e3.color) });
      });
    else if (Se(e2)) {
      let s3 = e2.symbol;
      ...
      be(e2) && r2.push(await this._getStretchLegendElements(e2, { min: 0, max: 255 }));
    const c2 = e2.defaultSymbol;
    !c2 || o2 || Se(e2) || a2 && !this._hasColorRamp && !this._hasSizeRamp && !this._hasOpacityRamp || r2.push({ type: "symbol-table", infos: [{ label: e2.defaultLabel || "others", symbol: c2 }] }), n2.infos.length && r2.unshift(n2);
    const d2 = null == t2.opacity ? this.opacity : t2.opacity, y2 = this._isTallSymbol("visualVariables" in e2 ? e2.visualVariables : null), h2 = Me(this.layer) || Ue(this.layer), m2 = r2.reduce((e3, t3) => [...e3, ...this._getAllInfos(t3)], []).filter((e3) => !!e3?.symbol).filter((e3) => {
  ...
  async _constructTileImageryStretchRendererElements(e2) {
    ...
    if (r2) {
      const e3 = r2[0];
      e$4(e3) ? (l2 = e3.min, i2 = e3.max) : [l2, i2] = e3;
    } else {
  ...
  async _getStretchLegendElements(e2, t2) {
    const s2 = e2.colorRamp, l2 = i$5(s2, t2);
    return { type: "stretch-ramp", title: "", infos: l2, preview: v$6(l2.map((e3) => e3.color), { ariaLabel: await $e("previewColorRampAriaLabel") }) };
  }
  _getClusterSymbol() {
  ...
  async _getSizeLegendElement(e2, t2, s2, l2) {
    return { type: "size-ramp", title: this._hasClusterSizeVariable ? this._getClusterTitle(t2) : e2, infos: await k$1(s2, t2, await o$1(s2), this.scale, this.view, l2, this._hasClusterSizeVariable ? this._getClusterSymbol() : null) };
  }
  ...
  async _getSymbolPreview(e2, t2, s2) {
    let l2 = !s2?.isDefault && null == e2.size && this._hasSizeRamp ? e$5(t$1.size) : e2.size;
    if (this._scaleDrivenSizeVariable && s2?.applyScaleDrivenSize) {
      const { getSize: t3 } = await import("./chunk-KFNcxJaF.js").then((n2) => n2.D_);
    ...
    return V$3(e2.symbol, { size: l2, opacity: t2, scale: false, symbolConfig: s2?.symbolConfig, effectView: s2?.effectList, style: "legend", cimOptions: { allowScalingUp: i2, viewParams: this.isScaleDriven ? { viewingMode: "2d" === this.view?.type ? "map" : this.view?.viewingMode, scale: this.view?.scale } : null }, ariaLabel: e2.label && "string" != typeof e2.label ? null : await $e("previewTemplateAriaLabel", e2.label) }).then((t3) => (e2.preview = t3, e2)).catch(() => (e2.preview = null, e2));
  }
  _getClusterRenderer(e2) {
    this._hasClusterSizeVariable = false;
    const t2 = "renderer" in this.layer ? this.layer.renderer : null, s2 = e2.renderer?.clone() || t2?.clone(), l2 = a$4(this.layerView._effectiveRenderer, this.view);
    if (l2 && null != s2 && "visualVariables" in s2) {
      const t3 = s2.visualVariables?.some((e3) => "size" === e3.type && "outline" !== e3.target && !ce.test(e3.valueExpression));
      if (!t3) {
        if ("clusterMinSize" in e2 && "clusterMaxSize" in e2) {
          const { clusterMinSize: t5, clusterMaxSize: s3 } = e2;
          l2.legendOptions = new a$8({ showLegend: t5 !== s3 });
        }
  ...
  async _loadRenderer(e2) {
    const t2 = [], s2 = e2.clone(), l2 = await o$1(s2);
    if (_e(s2) || we(s2)) {
    ...
    return t2.push(this._fetchSymbol(s2.symbol || s2.defaultSymbol, s2.defaultSymbol ? null : l2).then((e3) => {
      this._applySymbolToRenderer(s2, e3, Se(s2));
    }).catch(() => {
      this._applySymbolToRenderer(s2, null, Se(s2));
  ...
  _getAppliedCloneSymbol(e2, s2) {
    ...
    return l2.type.includes("3d") ? this._applyColorTo3dSymbol(l2, i2) : "cim" === l2.type ? I$4(l2, s2) : l2.color && (l2.color = new u$7(i2 || l2.color)), l2;
  }
  _applyColorTo3dSymbol(e2, s2) {
    s2 && e2.symbolLayers.forEach((e3) => {
      e3 && (e3.material || (e3.material = {}), e3.material.color = new u$7(s2));
    });
  }
  async _getVisualVariableLegendElements(e2, t2) {
    ...
    const a2 = [...l2, ...i2, ...n2];
    let o2, u2;
    if (0 === l2.length && _e(e2) && e2.classBreakInfos && 1 === e2.classBreakInfos.length) {
      const t3 = e2.classBreakInfos[0];
      o2 = t3 && t3.symbol;
    }
    if (0 === l2.length && Se(e2) && (o2 = e2.symbol), o2)
    ...
    return (await Promise.all(a2.map(async (s3) => {
      if (!s3.legendOptions || false !== s3.legendOptions.showLegend) {
        const l3 = me(e2) ? s3.field : this._getRampTitle(s3, t2);
        let i3 = null;
        const r2 = this._getDateFormatOptions(t2, s3);
        if ("color" === s3.type) {
          const e3 = await r$7(s3, null, r2) ?? [];
          i3 = { type: "color-ramp", title: l3, infos: e3, preview: v$6(e3.map((e4) => e4.color), { effectList: c2, ariaLabel: await $e("previewColorRampAriaLabel") }) }, this._hasColorRamp || (this._hasColorRamp = e3.length > 0);
        } else if ("size" === s3.type && "outline" !== s3.target)
          ce.test(s3.valueExpression) ? this._hasClusterSizeVariable || (this._scaleDrivenSizeVariable = s3) : (i3 = await this._getSizeLegendElement(l3, s3, e2, r2), this._hasSizeRamp || (this._hasSizeRamp = !(null == i3.infos || !i3.infos.length)));
        else if ("opacity" === s3.type) {
          const e3 = await r$7(s3, u2, r2) ?? [];
          i3 = { type: "opacity-ramp", title: l3, infos: e3, preview: v$6(e3.map((e4) => e4.color), { effectList: c2, ariaLabel: await $e("previewColorRampAriaLabel") }) }, this._hasOpacityRamp || (this._hasOpacityRamp = e3.length > 0);
        }
  ...
  _getFieldInfo(e2, t2) {
    ...
    if ("featureReduction" in e2)
      switch (e2.featureReduction?.type) {
        case "cluster":
        case "binning": {
          const s2 = e2.featureReduction.fields.find(({ name: e3 }) => e3.toLowerCase() === t2.field.toLowerCase());
          return s2 && "getField" in e2 ? e2.getField(s2.onStatisticField) : null;
        }
      }
    return "getField" in e2 ? e2.getField?.(t2.field) : null;
  }
  _getDateFormat(e2, t2) {
    const s2 = "popupTemplate" in e2 ? e2.popupTemplate?.fieldInfos : null;
    if (s2?.length && t2)
      return s2.find((e3) => e3.fieldName?.toLowerCase() === t2.toLowerCase())?.format?.dateFormat;
  }
  _getDateFormatOptions(e2, t2) {
    const s2 = this._getFieldInfo(e2, t2);
    if (!s2 || !Z(s2) && !be$1(s2))
      return null;
    let l2 = this._getDateFormat(e2, s2.name);
    if (!l2 && "date" === s2.type) {
      let e3 = 0, s3 = 0;
      t2.stops ? (e3 = t2.stops?.at(0)?.value ?? e3, s3 = t2.stops?.at(-1)?.value ?? s3) : "minDataValue" in t2 && "maxDataValue" in t2 && (e3 = t2.minDataValue ?? e3, s3 = t2.maxDataValue ?? s3), l2 = s3 - e3 > 2 * r$8.days ? "short-date" : "short-date-short-time";
    }
    return { fieldType: s2.type, format: l2, timeZoneOptions: { layerTimeZone: "preferredTimeZone" in e2 ? e2.preferredTimeZone : null, viewTimeZone: this.view.timeZone, datesInUnknownTimezone: "datesInUnknownTimezone" in e2 && e2.datesInUnknownTimezone } };
  }
  ...
  _getRendererTitle(e2, t2) {
    ...
    if (_e(s2) && (i2 = s2.normalizationField, r2 = "percent-of-total" === s2.normalizationType), l2 = "function" == typeof l2 ? null : l2, i2 = "function" == typeof i2 ? null : i2, we(s2)) {
  ...
  _getFieldAlias(e2, t2) {
    ...
    let i2;
    l2 && l2.some((t3) => e2 === t3.fieldName && (i2 = t3, true));
    let r2 = null;
    ...
    a2 && (!i2 && "popupTemplate" in a2 && a2.popupTemplate?.fieldInfos && a2.popupTemplate.fieldInfos.some((t3) => e2?.toLowerCase() === t3.fieldName?.toLowerCase() && (i2 = t3, true)), "fields" in a2 && a2.fields && (n2 = a2.fields.find((t3) => t3.name?.toLowerCase() === e2?.toLowerCase())));
    const o2 = i2 || r2 || n2;
    let u2 = null;
  ...
  _isUnclassedRenderer(e2) {
    ...
    let s2 = false;
    return _e(e2) && e2.classBreakInfos && 1 === e2.classBreakInfos.length && t2 && (s2 = e2.field ? t2.some((t3) => !(!t3 || e2.field !== t3.field || (e2.normalizationField || t3.normalizationField) && e2.normalizationField !== t3.normalizationField)) : !!t2.length), s2;
  }
};
e$2([y$5()], Je.prototype, "children", void 0), e$2([y$5({ readOnly: true })], Je.prototype, "effectList", null), e$2([y$5()], Je.prototype, "layerView", void 0), e$2([y$5()], Je.prototype, "layer", void 0), e$2([y$5()], Je.prototype, "legendElements", void 0), e$2([y$5({ readOnly: true })], Je.prototype, "opacity", null), e$2([y$5()], Je.prototype, "parent", void 0), e$2([y$5({ readOnly: true, dependsOn: [] })], Je.prototype, "ready", null), e$2([y$5()], Je.prototype, "hideLayersNotInCurrentView", void 0), e$2([y$5()], Je.prototype, "keepCacheOnDestroy", void 0), e$2([y$5()], Je.prototype, "respectLayerVisibility", void 0), e$2([y$5({ readOnly: true })], Je.prototype, "scale", null), e$2([y$5()], Je.prototype, "sublayerIds", void 0), e$2([y$5({ readOnly: true })], Je.prototype, "isScaleDriven", null), e$2([y$5()], Je.prototype, "title", void 0), e$2([y$5({ readOnly: true, dependsOn: ["ready"], value: 0 })], Je.prototype, "version", null), e$2([y$5()], Je.prototype, "view", void 0), Je = e$2([c$3("esri.widgets.Legend.support.ActiveLayerInfo")], Je);
const Qe = Je;
const h$1 = { state: "state", view: "view", allLayerViews: "all-layer-views", legendProperties: "legend-properties" }, c$1 = V$2.ofType(Qe), L$1 = /* @__PURE__ */ new Set(["esri.layers.BuildingSceneLayer", "esri.layers.CSVLayer", "esri.layers.FeatureLayer", "esri.layers.GeoJSONLayer", "esri.layers.GeoRSSLayer", "esri.layers.GroupLayer", "esri.layers.HeatmapLayer", "esri.layers.ImageryLayer", "esri.layers.ImageryTileLayer", "esri.layers.MapImageLayer", "esri.layers.OGCFeatureLayer", "esri.layers.PointCloudLayer", "esri.layers.StreamLayer", "esri.layers.SceneLayer", "esri.layers.SubtypeGroupLayer", "esri.layers.TileLayer", "esri.layers.VoxelLayer", "esri.layers.WFSLayer", "esri.layers.WMSLayer", "esri.layers.WMTSLayer", "esri.layers.WCSLayer", "esri.layers.LinkChartLayer", "esri.layers.knowledgeGraph.KnowledgeGraphSublayer"]), u$3 = "view.basemapView.baseLayerViews", f$1 = "view.groundView.layerViews", p$1 = "view.basemapView.referenceLayerViews", _$1 = [u$3, f$1, "view.layerViews", p$1];
let v$1 = class v extends g$3 {
  constructor(e2) {
    super(e2), this._layerViewByLayerId = {}, this._layerInfosByLayerViewId = {}, this._activeLayerInfosByLayerViewId = {}, this._activeLayerInfosWithNoParent = new V$2(), this.activeLayerInfos = new c$1(), this.basemapLegendVisible = false, this.groundLegendVisible = false, this.hideLayersNotInCurrentView = false, this.keepCacheOnDestroy = false, this.respectLayerVisibility = true, this.layerInfos = [], this.view = null;
  }
  initialize() {
    this.addHandles(d$2(() => this.view, () => this._viewHandles(), P$1), h$1.view), this.addHandles(f$5(() => this._refresh()));
  }
  destroy() {
  ...
  _viewHandles() {
    this.removeHandles(h$1.state), this.view && this.addHandles(d$2(() => this.state, () => this._stateHandles(), P$1), h$1.state);
  }
  _stateHandles() {
    this._resetAll(), "ready" === this.state && this._watchPropertiesAndAllLayerViews();
  }
  _resetAll() {
    this.removeHandles([h$1.allLayerViews, h$1.legendProperties]), this._destroyViewActiveLayerInfos(), this.activeLayerInfos.removeAll();
  }
  ...
  _watchPropertiesAndAllLayerViews() {
    ...
    r2.length && this._refresh(), this.addHandles(r2.on("change", (e3) => this._allLayerViewsChangeHandle(e3)), h$1.allLayerViews), this.addHandles(d$2(() => [this.layerInfos, this.basemapLegendVisible, this.groundLegendVisible], () => this._propertiesChangeHandle()), h$1.legendProperties);
  }
  _allLayerViewsChangeHandle(e2) {
    e2.removed.forEach((e3) => this._destroyViewActiveLayerInfo(e3.uid)), this._refresh();
  }
  ...
  _generateLayerViews() {
    const e2 = [];
    return _$1.filter(this._filterLayerViews, this).map((e3) => o$2(this, e3)).filter((e3) => null != e3).forEach(this._collectLayerViews("layerViews", e2)), e2;
  }
  _filterLayerViews(e2) {
    const r2 = !this.basemapLegendVisible && (e2 === u$3 || e2 === p$1), i2 = !this.groundLegendVisible && e2 === f$1;
    return !r2 && !i2;
  }
  ...
  _isLayerViewSupported(e2) {
    return !!L$1.has(e2.layer.declaredClass) && (this._layerViewByLayerId[e2.layer.uid] = e2, true);
  }
  _generateActiveLayerInfo(e2) {
    this._isLayerActive(e2) ? this._buildActiveLayerInfo(e2) : (this.removeHandles(e2.uid), this.addHandles(d$2(() => [e2.legendEnabled, e2.layer?.legendEnabled], () => this._layerActiveHandle(e2)), e2.uid));
  }
  ...
  _buildActiveLayerInfo(e2) {
    ...
    if (!o2) {
      ...
      o2 = new Qe({ layer: r2, layerView: e2, title: t2 ? n2.title : r2.title, view: this.view, respectLayerVisibility: this.respectLayerVisibility, hideLayersNotInCurrentView: this.hideLayersNotInCurrentView, keepCacheOnDestroy: this.keepCacheOnDestroy, sublayerIds: n2?.sublayerIds || [] }), this._activeLayerInfosByLayerViewId[i2] = o2;
    }
    ...
    if (o2.parent = this._activeLayerInfosByLayerViewId[l2?.uid], !this.hasHandles(i2)) {
      const n3 = [d$2(() => r2.title, (e3) => this._titleHandle(e3, o2)), d$2(() => [r2.opacity, "renderer" in r2 && r2.renderer, "pointSymbol" in r2 && r2.pointSymbol, "lineSymbol" in r2 && r2.lineSymbol, "polygonSymbol" in r2 && r2.polygonSymbol], () => this._constructLegendElements(o2)), p$4(() => true === this.view?.stationary, () => this._scaleHandle(o2), P$1), d$2(() => e2._effectiveRenderer, () => this._constructLegendElements(o2)), d$2(() => "effect" in r2 && r2.effect, () => this._constructLegendElements(o2)), p$4(() => this.view?.timeZone, () => this._constructLegendElements(o2), P$1)];
      if (this.respectLayerVisibility) {
        const i3 = d$2(() => e2.legendEnabled, (e3) => this._legendEnabledHandle(e3, o2)), s2 = d$2(() => r2.legendEnabled, (e3) => this._legendEnabledHandle(e3, o2));
        n3.push(i3, s2);
      }
  ...
  _constructLegendElements(e2) {
    const r2 = e2.layer;
    "featureCollections" in r2 && r2.featureCollections ? e2.buildLegendElementsForFeatureCollections(r2.featureCollections) : "featureReduction" in r2 && r2.featureReduction && "renderer" in r2.featureReduction && ("binning" === r2.featureReduction.type || "cluster" === r2.featureReduction.type) ? e2.buildLegendElementsForFeatureReduction(r2.featureReduction) : "renderer" in r2 && r2.renderer && !("sublayers" in r2) ? e2.buildLegendElementsForRenderer(r2.renderer) : "url" in r2 && r2.url ? e2.buildLegendElementsForTools() : e2.children.forEach((e3) => this._constructLegendElements(e3));
  }
};
e$2([y$5({ type: c$1 })], v$1.prototype, "activeLayerInfos", void 0), e$2([y$5()], v$1.prototype, "basemapLegendVisible", void 0), e$2([y$5()], v$1.prototype, "groundLegendVisible", void 0), e$2([y$5()], v$1.prototype, "hideLayersNotInCurrentView", void 0), e$2([y$5()], v$1.prototype, "keepCacheOnDestroy", void 0), e$2([y$5()], v$1.prototype, "respectLayerVisibility", void 0), e$2([y$5()], v$1.prototype, "layerInfos", void 0), e$2([y$5({ readOnly: true })], v$1.prototype, "state", null), e$2([y$5()], v$1.prototype, "view", void 0), v$1 = e$2([c$3("esri.widgets.Legend.LegendViewModel")], v$1);
const I$1 = v$1;
...
const l$1 = i$6(), n = 10, r$1 = 20, s = 10, a$2 = 20, c = { univariateAboveAndBelowSymbol: "esri-univariate-above-and-below-ramp__symbol", colorRamp: "esri-legend__color-ramp" };
...
function m(t2, o2, i2 = "vertical", l2) {
  t2.infos.forEach((t3, n2) => {
    if (l2 && 2 === n2)
      ...
      const o3 = u$a(t3.size) + ("horizontal" === i2 ? a$2 : s), l3 = t3.preview, n3 = "div" === l3?.tagName.toLowerCase(), r2 = n3 ? l3 : document.createElement("div");
...
function u$2(t2, o2 = "classic") {
  const i2 = t2.infos;
  return "classic" === o2 ? (u$a(i2[0].size) + s) / 2 : (u$a(i2[0].size) - u$a(i2[i2.length - 1].size)) / 2;
}
function h(e2, t2) {
  if (!e2)
    return null;
...
function v2(t2, o2, i2, l2 = "vertical") {
  let c2 = 0;
  ...
  for (let h2 = m2; h2 <= u2; h2++)
    if (i2 && h2 === p2)
      ...
      c2 += u$a(f2[h2].size) + ("horizontal" === l2 ? a$2 : s);
    }
  return Math.round(c2);
}
function y(t2, o2, i2, l2 = "vertical") {
  const c2 = v2(t2, o2, i2, l2), f2 = t2.infos, p2 = Math.floor(f2.length / 2), m2 = "full" === o2 || "above" === o2 ? 0 : p2, u2 = "full" === o2 || "below" === o2 ? f2.length - 1 : p2, h2 = "full" === o2 ? f2[m2].size + f2[u2].size : "above" === o2 ? f2[m2].size : f2[u2].size, y2 = i2 ? "vertical" === l2 ? r$1 : n : 0, d2 = "vertical" === l2 ? s * ("full" === o2 ? 2 : 1) : a$2 * ("full" === o2 ? 2 : 1);
  return Math.round(c2 - (u$a(h2) / 2 + y2 / 2 + d2 / 2));
}
...
function a$1(e2, t2) {
  return e2.label ? t2[e2.label] + ": " + ("string" == typeof e2.value ? e2.value : u$8(e2.value ?? 0, { style: "decimal", notation: e2.value?.toString().toLowerCase().includes("e") ? "scientific" : "standard" })) : "";
}
...
let T = class extends O$1 {
  ...
  initialize() {
    this.addHandles(d$2(() => this.activeLayerInfos, (e2) => {
  ...
  _watchForSectionChanges(e2) {
    if (this._generateSectionNames(), e2) {
      e2.forEach((e3) => {
        ...
        this.removeHandles(s3), this._watchForSectionChanges(e3.children), this.addHandles(d$2(() => e3.version, () => this._generateSectionNames()), s3);
      });
  ...
  _renderLegendForElement(e2, t2, s2, i2 = false, a2 = false) {
    ...
    const d2 = this._getSectionName(l2, e2, s2), m2 = this._hasIndicators && !a2 ? n$2("div", null, n$2(e$7, { class: r$2.carouselTitle, level: this.headingLevel }, t2.title), n$2(e$7, { class: r$2.layerCaption, level: n$4(this.headingLevel) }, p2)) : p2 ? n$2(e$7, { class: r$2.layerCaption, level: this.headingLevel }, p2) : null, h2 = t2.effectList;
    let y2 = null;
    switch (e2.type) {
      case "symbol-table": {
      ...
      case "relationship-ramp":
        y2 = h$3(e2, this.id, { opacity: l2.opacity, effectList: h2, ariaLabel: this.messages.previewRelationshipRampAriaLabel });
        break;
  ...
  _renderUnivariateAboveAndBelowRamp(e2, t2, s2) {
    ...
    if (!i$12)
      return null;
    const r2 = v2(i$12, "full", true, "horizontal"), o2 = y(i$12, "above", true, "horizontal"), l2 = y(i$12, "below", true, "horizontal"), c2 = 12, g2 = this.messages?.previewColorRampAriaLabel, v$12 = h(a2, { width: o2, height: c2, rampAlignment: "horizontal", opacity: t2, type: "above", effectList: s2, ariaLabel: g2 }), u2 = h(a2, { width: l2, height: c2, rampAlignment: "horizontal", opacity: t2, type: "below", effectList: s2, ariaLabel: g2 }), b2 = u$2(i$12, "card"), _2 = i$12.infos.map((e3) => e3.label), w2 = _2.length - 1, L2 = _2.map((e3, t3) => 0 === t3 || t3 === w2 ? n$2("div", { key: t3 }, e3) : null), S2 = { display: "flex", flexDirection: "column" }, R2 = { display: "flex", flexDirection: "row" }, $2 = { marginTop: "3px", display: "flex" };
  ...
  _renderUnivariateColorSizeRamp(e2, t2, s2) {
    ...
    if (!i$12)
      return null;
    const r2 = v2(i$12, "full", false, "horizontal"), o2 = y(i$12, "full", false, "horizontal"), l2 = h(a2, { width: o2, height: 12, rampAlignment: "horizontal", opacity: t2, type: "full", effectList: s2, ariaLabel: this.messages?.previewColorRampAriaLabel }), c2 = u$2(i$12, "card"), p2 = i$12.infos.length - 1, v$12 = i$12.infos.map((e3, t3) => 0 === t3 || t3 === p2 ? n$2("div", { key: t3 }, e3.label) : null), u2 = { display: "flex", flexDirection: "column" }, b$12 = { display: "flex", flexDirection: "row" }, _2 = { marginTop: "3px", display: "flex" };
    v$3(this.container) ? _2.marginRight = `${c2}px` : _2.marginLeft = `${c2}px`;
    const w2 = { width: `${r2}px`, display: "flex", flexDirection: "row", justifyContent: "space-between" };
    return n$2("div", { class: r$2.layerRow, key: "size-ramp-preview", styles: u2 }, n$2("div", { class: this.classes(r$2.symbolContainer, r$2.sizeRampHorizontal), styles: b$12 }, i$12.infos.map((e3, t3) => n$2("div", { afterCreate: i, bind: e3.preview, class: r$2.symbol, key: t3 }))), n$2("div", { class: r$2.univariateAboveAndBelowColorRamp, key: "color-ramp-preview", styles: _2 }, n$2("div", { afterCreate: i, bind: l2 })), n$2("div", { class: r$2.layerInfo }, n$2("div", { class: r$2.rampLabelsContainer, styles: w2 }, v$12)));
  }
  _renderLegendForElementInfo(e2, t2, s2, i$12) {
    ...
    if (e2.preview) {
      ...
      const g2 = e2.symbol.color?.a, v3 = e2.symbol.outline?.color?.a;
      g2 && (s3 = e2.symbol.color.r, r3 = e2.symbol.color.g, c2 = e2.symbol.color.b, p2 = e2.symbol.color.a * a2.opacity), v3 && (d2 = e2.symbol.outline.color.r, m2 = e2.symbol.outline.color.g, h2 = e2.symbol.outline.color.b, y2 = e2.symbol.outline.color.a * a2.opacity);
      const u2 = e2.symbol.color?.isBright ?? true, b2 = u2 ? "rgba(255, 255, 255, .6)" : "rgba(0, 0, 0, .6)", _2 = { background: g2 ? `rgba(${s3}, ${r3}, ${c2}, ${p2})` : "none", color: u2 ? "black" : "white", textShadow: `-1px -1px 0 ${b2},
                                              1px -1px 0 ${b2},
                                              -1px 1px 0 ${b2},
                                              1px 1px 0 ${b2}`, border: v3 ? `1px solid rgba(${d2}, ${m2}, ${h2}, ${y2})` : "none", filter: I$3(t2.effectList) ?? void 0 };
  ...
  _renderSizeRampLines(e2) {
    const t2 = e2.infos, i$12 = t2[0], a2 = t2[t2.length - 1], r2 = i$12.symbol, o2 = this._hasIndicators, l2 = u$a(i$12.size + i$12.outlineSize) * j$1, n2 = u$a(a2.size + a2.outlineSize) * j$1, c2 = o2 ? l2 : l2 + 50 * j$1, p2 = o2 ? l2 / 2 + 50 * j$1 : l2, d2 = F(r2), m2 = E(r2), h2 = document.createElement("canvas");
  ...
  _renderLegendForRamp(e2, t2, s2) {
    const i2 = e2.infos, a2 = e2.type, l2 = "heatmap-ramp" === a2, c2 = i2.length - 1, p2 = k, d2 = c2 > 2 && !l2 ? $$1 * c2 : I, m2 = d2 + 20, h2 = 10, y2 = i2.slice(0).reverse(), g2 = y2.length - 1, v3 = y2.length % 2 != 0 ? y2[y2.length / 2 | 0] : null, f2 = v3 && n$2("div", { class: r$2.intervalSeparatorsContainer }, n$2("div", { class: r$2.intervalSeparator }, "|"), n$2("div", { class: r$2.rampLabel }, this._getRampStopLabel(v3, a2))), u2 = [[{ shape: { type: "path", path: `M0 ${p2 / 2} L${h2} 0 L${h2} ${p2} Z` }, fill: y2[0].color, stroke: { width: 0 } }, { shape: { type: "rect", x: h2, y: 0, width: d2, height: p2 }, fill: { type: "linear", x1: h2, y1: 0, x2: d2 + h2, y2: 0, colors: y2.map((e3, t3) => ({ color: e3.color, offset: l2 && "ratio" in e3 ? e3.ratio : t3 / c2 })) }, stroke: { width: 0 } }, { shape: { type: "path", path: `M${d2 + h2} 0 L${m2} ${p2 / 2} L${d2 + h2} ${p2} Z` }, fill: y2[g2].color, stroke: { width: 0 } }]], b2 = D$1(u2, m2, p2), _2 = { filter: I$3(s2) ?? void 0, opacity: null == t2 ? void 0 : `${t2}` }, w2 = { justifyContent: "center" };
    return n$2("div", { class: r$2.layerRow, styles: w2 }, n$2("div", { class: r$2.rampLabel }, this._getRampStopLabel(y2[0], a2)), n$2("div", { class: r$2.symbolContainer }, n$2("div", { styles: _2 }, b2), f2), n$2("div", { class: r$2.rampLabel }, this._getRampStopLabel(y2[g2], a2)));
  }
};
...
const w = `${e}__`, C = 24, R = { display: "flex", alignItems: "flex-start" }, A = { marginLeft: "3px" }, _ = { display: "table-cell", verticalAlign: "middle" };
let j = class extends O$1 {
  constructor(e2, s2) {
  ...
  _renderLegendForLayer(e2) {
    if (!e2.ready)
      return null;
    const s2 = !!e2.children.length, t2 = `${w}${e2.layer.uid}-version-${e2.version}`, a$12 = e2.title ? e$7({ level: this.headingLevel, class: this.classes(e$8.heading, a.label) }, e2.title) : null;
    if (s2) {
  ...
  _renderLegendForElement(e2, s2, t2, a$12) {
    ...
    if ("string" == typeof d2)
      ...
      c2 = l(d2, i2 || o$12) && d2.title ? `${d2.title} (${e3})` : e3;
    }
    const v3 = a$12 ? a.layerChildTable : a.layerTable, h2 = c2 ? n$2("div", { class: a.layerCaption }, c2) : null, g2 = { [a.layerTableSizeRamp]: n2 || !a$12 };
    return n$2("div", { class: this.classes(v3, g2) }, h2, p2);
  }
  _renderPieChartRamp(e2) {
  ...
  _renderUnivariateAboveAndBelowRamp(e2, s2, t2) {
    ...
    if (!a$12)
      return null;
    const l2 = this.messages?.previewColorRampAriaLabel, c2 = y(a$12, "above", true), m2 = y(a$12, "below", true), y$12 = 12, h$12 = h(i$12, { width: y$12, height: c2, rampAlignment: "vertical", opacity: s2, type: "above", effectList: t2, ariaLabel: l2 }), g2 = h(i$12, { width: y$12, height: m2, rampAlignment: "vertical", opacity: s2, type: "below", effectList: t2, ariaLabel: l2 }), u2 = u$2(a$12), b2 = a$12.infos.map((e3) => e3.label), f2 = b2.map((e3, s3) => {
      const t3 = 2 === s3;
      return 0 === s3 ? n$2("div", { class: e3 ? h$12 ? a.univariateAboveAndBelowLabel : a.rampLabel : void 0, key: s3 }, e3) : t3 ? n$2("div", null) : null;
    }), w2 = b2.length - 1, C2 = Math.floor(b2.length / 2), j2 = b2.map((e3, s3) => s3 === C2 || s3 === w2 ? n$2("div", { class: e3 ? h$12 ? a.univariateAboveAndBelowLabel : a.rampLabel : void 0, key: s3 }, e3) : null), $2 = { display: "table-cell", verticalAlign: "middle" }, I2 = { marginTop: `${u2}px` }, x2 = { height: `${c2}px` }, S2 = { height: `${m2}px` };
  ...
  _renderUnivariateColorSizeRamp(e2, s2, t2) {
    ...
    if (!a$12)
      return null;
    const l2 = u$2(a$12), o2 = 12, m2 = y(a$12, "full", false), y$12 = h(i$12, { width: o2, height: m2, rampAlignment: "vertical", opacity: s2, type: "full", effectList: t2, ariaLabel: this.messages?.previewColorRampAriaLabel }), h$12 = a$12.infos.length - 1, g2 = a$12.infos.map((e3, s3) => 0 === s3 || s3 === h$12 ? n$2("div", { class: e3.label ? i$12 ? a.univariateAboveAndBelowLabel : a.rampLabel : void 0, key: s3 }, e3.label) : null), u2 = { display: "table-cell", verticalAlign: "middle" }, b$12 = { marginTop: `${l2}px` }, f2 = { height: `${m2}px` };
  ...
  _renderLegendForRamp(e2, s2) {
    ...
    const p2 = t2.map((e3) => n$2("div", { class: e3.label ? a.rampLabel : void 0 }, i$12 ? this.messages[e3.label] || e3.label : l2 ? a$1(e3, this.messages) : e3.label)), d2 = { width: `${C}px` }, c2 = { height: o2.style.height };
    return n$2("div", { class: a.layerRow }, n$2("div", { class: a.symbolContainer, styles: d2 }, n$2("div", { afterCreate: i, bind: o2, class: a.rampContainer })), n$2("div", { class: a.layerInfo }, n$2("div", { class: a.rampLabelsContainer, styles: c2 }, p2)));
  }
...
const $ = j;
const g = { base: "esri-legend", widgetIcon: i$7.layerList };
let u = class extends O$1 {
  ...
  initialize() {
    this.addHandles([v$5(() => this.view, "resize", () => this.scheduleRender()), v$5(() => this.activeLayerInfos, "change", () => this._refreshActiveLayerInfos(this.activeLayerInfos)), d$2(() => this.headingLevel, (e2) => {
      const { style: t2 } = this;
      t2 && (t2.headingLevel = e2);
    }), d$2(() => this.style, (e2, t2) => {
  ...
  castStyle(e2) {
    if (e2 instanceof U || e2 instanceof $)
      return e2;
    if ("string" == typeof e2)
      return "card" === e2 ? new U() : new $();
    if (e2 && "string" == typeof e2.type) {
      const t2 = { ...e2 };
      delete t2.type;
      return new ("card" === e2.type ? U : $)(t2);
    }
    return new $();
  }
  get view() {
  ...
  _renderOnActiveLayerInfoChange(e2) {
    const r2 = d$2(() => e2.version, () => this.scheduleRender());

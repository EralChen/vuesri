import { bo as e, bp as y, br as c, bs as g$1, aw as u$1, el as d$1, pg as b$2, hO as o, k6 as E$1, rk as t$1, rl as f, rm as e$1, bm as h$1, b0 as h, bK as C$1, eg as p, lv as w$3, bQ as b$3, rn as x$1, ap as M$1, cq as a, bb as s$1, bS as e$2, ro as f$1, rp as a$1, rq as ft, nN as c$1, ql as it, rr as u$2, da as c$2, jY as E$2, rs as o$2, d3 as yt, rt as S$1, du as j$3, ru as t$2, rv as c$3, rw as l$1, ir as t$3, d1 as o$3, b7 as C$2, b1 as s$2, cZ as f$2, jn as h$2, bJ as d$2, dS as w$4, cw as p$1 } from "./chunk-KFNcxJaF.js";
import { m } from "./chunk-UzDyJefO.js";
import { W } from "./chunk-mk4KSkT-.js";
import { i, r as r$2, n } from "./chunk-HH1t1DW9.js";
import { o as o$1 } from "./chunk-vP0bHkve.js";
...
let j$2 = class j extends g$1 {
  ...
  initialize() {
    this._initializeFetchExtent(), this._updatingHandles.add(() => this._configuration, () => this.refresh()), this._updatingHandles.add(() => this.tilesOfInterest, (e2, t2) => {
      h(e2, t2, ({ id: e3 }, { id: t3 }) => e3 === t3) || this._process();
    }, C$1), this.addHandles(p(() => !this.suspended, () => this._process()));
  }
  destroy() {
  ...
  _initializeFetchExtent() {
    ...
    const e2 = d$1(async (e3) => {
      try {
        ...
        this.store.extent = M$1.fromJSON(t2.data?.extent);
      } catch (t2) {
        a(t2), s$1.getLogger(this).warn("Failed to fetch data extent", t2);
      }
    });
  ...
  async _fetchFeatures(e2, t2, i2) {
    ...
    let o2 = 0, n2 = t2;
    for (; ; ) {
      const a2 = this._createFeaturesQuery(e2), l = this._setPagingParameters(a2, s, n2), { features: u2, exceededTransferLimit: d } = await this._queryFeatures(a2, i2);
      l && (s += a2.num), o2 += u2.length;
      for (const e3 of u2)
        r3.push(e3);
      if (n2 = t2 - o2, !l || !d || n2 <= 0)
        return r3;
    }
  }
  ...
  async _queryFeaturesPBF(e2, t2) {
    const { sourceSpatialReference: i2 } = this, { data: s } = await f$1(this.url, e2, new a$1({ sourceSpatialReference: i2 }), { query: this._configuration.customParameters, timeout: w$2, signal: t2 });
    return ft(s);
  }
  async _queryFeaturesJSON(e2, t2) {
    ...
    return it(s, this.objectIdField);
  }
  ...
  _setPagingParameters(e2, t2, i2) {
    if (!this.capabilities.query.supportsPagination)
      return false;
    const { supportsMaxRecordCountFactor: s, supportsCacheHint: r3, tileMaxRecordCount: o2, maxRecordCount: n2, supportsResultType: a2 } = this.capabilities.query, l = s ? b$3.MAX_MAX_RECORD_COUNT_FACTOR : 1, u2 = l * ((a2 || r3) && o2 ? o2 : n2 || x);
    return e2.start = t2, s ? (e2.maxRecordCountFactor = Math.min(l, Math.ceil(i2 / u2)), e2.num = Math.min(i2, e2.maxRecordCountFactor * u2)) : e2.num = Math.min(i2, u2), true;
  }
};
e([y({ constructOnly: true })], j$2.prototype, "url", void 0), e([y({ constructOnly: true })], j$2.prototype, "objectIdField", void 0), e([y({ constructOnly: true })], j$2.prototype, "globalIdField", void 0), e([y({ constructOnly: true })], j$2.prototype, "capabilities", void 0), e([y({ constructOnly: true })], j$2.prototype, "sourceSpatialReference", void 0), e([y({ constructOnly: true })], j$2.prototype, "spatialReference", void 0), e([y({ constructOnly: true })], j$2.prototype, "store", void 0), e([y({ readOnly: true })], j$2.prototype, "_minimumVerticesPerFeature", null), e([y()], j$2.prototype, "_mandatoryOutFields", null), e([y()], j$2.prototype, "outFields", null), e([y()], j$2.prototype, "suspended", void 0), e([y()], j$2.prototype, "filter", null), e([y()], j$2.prototype, "customParameters", null), e([y({ readOnly: true })], j$2.prototype, "_configuration", null), e([y()], j$2.prototype, "tileInfo", null), e([y()], j$2.prototype, "tileSize", null), e([y()], j$2.prototype, "tilesOfInterest", void 0), e([y({ readOnly: true })], j$2.prototype, "updating", null), e([y({ readOnly: true })], j$2.prototype, "updatingExcludingEdits", null), e([y({ readOnly: true })], j$2.prototype, "availability", void 0), e([y()], j$2.prototype, "hasZ", null), j$2 = e([c("esri.views.interactive.snapping.featureSources.featureServiceSource.FeatureServiceTiledFetcher")], j$2);
const x = 2e3, w$2 = 6e5, q = 1e6, A$1 = 25, H = 1;
class t {
  constructor() {
...
let v = class extends g$1 {
  ...
  _addTileStorage(e2, t2, s, i2) {
    const r3 = e2.id;
    this._tiles.set(r3, new E(e2, t2, s, i2)), this._tileBounds.set(r3, e2.extent), this._tileFeatureCounts.set(r3, t2.size);
  }
  _remove({ id: e2 }) {
  ...
  async _processEditsRefetch(e2, t2, s) {
    ...
    for (const n2 of i2) {
      const e3 = yt(this._tmpBoundingRect, n2.geometry, r3, o2);
...
function S(e2) {
  return 32 + T(e2.geometry) + t$2(e2.attributes);
}
function T(e2) {
  if (null == e2)
    return 0;
...
let w2 = class extends o$3.EventedAccessor {
  constructor() {
    super(...arguments), this._isInitializing = true, this.remoteClient = null, this._whenSetup = C$2(), this._elevationAligner = i(), this._elevationFilter = r$2(), this._symbologyCandidatesFetcher = n(), this._updatingHandles = new h$1(), this._editsUpdatingHandles = new h$1(), this._pendingApplyEdits = /* @__PURE__ */ new Map(), this._alignPointsInFeatures = async (e2, t2) => {
  ...
  async setup(e2) {
    ...
    this._spatialReference = l, this._featureStore = new m({ ...e2.serviceInfo, hasZ: o2, hasM: false }), this._queryEngine = new W({ spatialReference: e2.spatialReference, featureStore: this._featureStore, geometryType: t2, fieldsIndex: n2, hasZ: o2, hasM: false, objectIdField: i$1, timeInfo: s }), this._featureFetcher = new j$2({ store: new v({ featureStore: this._featureStore }), url: e2.serviceInfo.url, objectIdField: e2.serviceInfo.objectIdField, globalIdField: e2.serviceInfo.globalIdField, capabilities: e2.serviceInfo.capabilities, spatialReference: l, sourceSpatialReference: f$2.fromJSON(e2.serviceInfo.spatialReference) });
    const d = "3d" === e2.configuration.viewType;
    return this._elevationAligner = i(d, { elevationInfo: null != e2.elevationInfo ? h$2.fromJSON(e2.elevationInfo) : null, alignPointsInFeatures: this._alignPointsInFeatures }), this._elevationFilter = r$2(d), this.addHandles([d$2(() => this._featureFetcher.availability, (e3) => this.emit("notify-availability", { availability: e3 }), C$1), d$2(() => this.updating, () => this._notifyUpdating())]), this._whenSetup.resolve(), this._isInitializing = false, this.configure(e2.configuration);
  }
  async configure(e2) {
    return await this._updatingHandles.addPromise(this._whenSetup.promise), this._updateFeatureFetcherConfiguration(e2), j3;
  }
  async setSuspended(e2, t2) {
    return await this._updatingHandles.addPromise(this._whenSetup.promise), s$2(t2), this._featureFetcher.suspended = e2, j3;
  }
  async updateOutFields(e2, t2) {
    return await this._updatingHandles.addPromise(this._whenSetup.promise), s$2(t2), this._featureFetcher.outFields = new Set(e2 ?? []), j3;
  }
  ...
  async updateTiles(e2, t2) {
    return await this._updatingHandles.addPromise(this._whenSetup.promise), s$2(t2), this._featureFetcher.tileSize = e2.tileSize, this._featureFetcher.tilesOfInterest = e2.tiles, this._featureFetcher.tileInfo = null != e2.tileInfo ? j$3.fromJSON(e2.tileInfo) : null, j3;
  }
  async refresh(e2, t2) {
    return await this._updatingHandles.addPromise(this._whenSetup.promise), s$2(t2), this._featureFetcher.refresh(), j3;
  }
  async whenNotUpdating(e2, t2) {
    return await this._updatingHandles.addPromise(this._whenSetup.promise), s$2(t2), await w$4(() => !this.updatingExcludingEdits, t2), s$2(t2), j3;
  }
  ...
  async beginApplyEdits(e2, t2) {
    ...
    const r3 = C$2();
    return this._pendingApplyEdits.set(e2.id, r3), this._featureFetcher.applyEdits(r3.promise), this._editsUpdatingHandles.addPromise(r3.promise), j3;
  }
  async endApplyEdits(e2, t2) {
    const i2 = this._pendingApplyEdits.get(e2.id);
    return i2 && i2.resolve(e2.edits), s$2(t2), j3;
  }
  ...
  async setSymbologySnappingSupported(e2) {
    return this._symbologyCandidatesFetcher = n(e2, this._getSymbologyCandidates), j3;
  }
...
function b(e2) {
  ...
  const { distance: t2, units: i2, spatialRel: s, where: r3, timeExtent: n2, objectIds: a2 } = e2.filter, o2 = { geometry: e2.filter.geometry ? p$1(e2.filter.geometry) : void 0, distance: t2, units: i2, spatialRel: s, timeExtent: n2, objectIds: a2, where: r3 ?? "1=1" };
  return { ...e2, query: o2 };
}
const j3 = { result: {} };
export {
